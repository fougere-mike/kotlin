 ...
 */
@SinceKotlin("1.5")
public actual fun Char.lowercase(): String = brsIntrinsicLCase(this.toString())
 ...
 */
@SinceKotlin("1.5")
public actual fun Char.uppercase(): String = brsIntrinsicUCase(this.toString())

/**
 * Converts this character to title case using Unicode mapping rules of the invariant locale.
 */
@SinceKotlin("1.5")
public actual fun Char.titlecaseChar(): Char = uppercaseChar()
 ...
 */
@SinceKotlin("1.5")
public actual fun Char.isDefined(): Boolean = true

/**
 * Returns `true` if this character is a letter.
 */
@SinceKotlin("1.5")
public actual fun Char.isLetter(): Boolean = this in 'a'..'z' || this in 'A'..'Z'
 ...
 */
@SinceKotlin("1.5")
public actual fun Char.isDigit(): Boolean = this in '0'..'9'

/**
 * Returns `true` if this character is upper case.
 */
@SinceKotlin("1.5")
public actual fun Char.isUpperCase(): Boolean = this in 'A'..'Z'

/**
 * Returns `true` if this character is lower case.
 */
@SinceKotlin("1.5")
public actual fun Char.isLowerCase(): Boolean = this in 'a'..'z'

/**
 * Returns `true` if this character is a title case letter.
 */
@SinceKotlin("1.5")
public actual fun Char.isTitleCase(): Boolean = false

/**
 * Returns `true` if this character is an ISO control character.
 */
@SinceKotlin("1.5")
public actual fun Char.isISOControl(): Boolean = this <= '\u001F' || this in '\u007F'..'\u009F'

/**
 * Determines whether a character is whitespace.
 */
public actual fun Char.isWhitespace(): Boolean = this == ' ' || this == '\t' || this == '\n' || this == '\r'
