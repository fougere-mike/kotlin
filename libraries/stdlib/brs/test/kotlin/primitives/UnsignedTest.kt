...
/**
 * Tests for unsigned integer types.
 */
fun TestRunner.unsignedTests() {
    suite("Unsigned Basics") {
        test("UInt basics") {
            val a = UInt(1)
            val b = UInt(2)
