...
sub HorizAlign_initEntries()
    if m.HorizAlign_entriesInitialized = true then
        return
    end if
...
sub VertAlign_initEntries()
    if m.VertAlign_entriesInitialized = true then
        return
    end if
...
sub Truncation_initEntries()
    if m.Truncation_entriesInitialized = true then
        return
    end if
...
sub WordWrap_initEntries()
    if m.WordWrap_entriesInitialized = true then
        return
    end if
...
sub LoadingBitmapStyle_initEntries()
    if m.LoadingBitmapStyle_entriesInitialized = true then
        return
    end if
...
sub BlendingMode_initEntries()
    if m.BlendingMode_entriesInitialized = true then
        return
    end if
