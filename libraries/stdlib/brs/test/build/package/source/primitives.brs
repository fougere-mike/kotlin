...
function iterator_rStr_k_(m as String) as Object
    return Anon_31fa9f32_create_Str_k_(m)
end function

function iterator_rCharArray_k_(m as Object) as Object
    return Anon_ef5a84_create_CharArray_k_(m)
end function

function Anon_31fa9f32_create_Str_k_(_this_iterator as String) as Object
    this = CharIterator_create_k_()
    this._super = {}
    this._super.hasNext_k_ = this.hasNext_k_
    this._super.nextChar_k_ = this.nextChar_k_
    this.__proto = ["Anon_31fa9f32", this.__proto]
    this.__type = "Anon_31fa9f32"
    this.hasNext_k_ = Anon_31fa9f32_hasNext_k_
    this.nextChar_k_ = Anon_31fa9f32_nextChar_k_
    this.get_index = Anon_31fa9f32_get_index_k_
    this.set_index = Anon_31fa9f32_set_index_I_k_
    this.index = 0
    this._this_iterator = _this_iterator
    return this
end function

function Anon_31fa9f32_hasNext_k_() as Boolean
    return m.get_index() < Len(m._this_iterator)
end function

function Anon_31fa9f32_nextChar_k_() as Object
...
function Anon_31fa9f32_get_index_k_() as Integer
    return m.index
end function

sub Anon_31fa9f32_set_index_I_k_(value as Integer)
    m.index = value
end sub

function Anon_ef5a84_create_CharArray_k_(_this_iterator as Object) as Object
    this = CharIterator_create_k_()
    this._super = {}
    this._super.hasNext_k_ = this.hasNext_k_
    this._super.nextChar_k_ = this.nextChar_k_
    this.__proto = ["Anon_ef5a84", this.__proto]
    this.__type = "Anon_ef5a84"
    this.hasNext_k_ = Anon_ef5a84_hasNext_k_
    this.nextChar_k_ = Anon_ef5a84_nextChar_k_
    this.get_index = Anon_ef5a84_get_index_k_
    this.set_index = Anon_ef5a84_set_index_I_k_
    this.index = 0
    this._this_iterator = _this_iterator
    return this
end function

function Anon_ef5a84_hasNext_k_() as Boolean
    return m.get_index() < m._this_iterator.get_size()
end function

function Anon_ef5a84_nextChar_k_() as Object
...
function Anon_ef5a84_get_index_k_() as Integer
    return m.index
end function

sub Anon_ef5a84_set_index_I_k_(value as Integer)
    m.index = value
end sub
