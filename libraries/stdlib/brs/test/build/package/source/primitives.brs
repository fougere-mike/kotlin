...
function until_rI_I_IntRange_k_(m as Integer, to_ as Integer) as Object
    ...
    return rangeTo_rI_I_IntRange_k_(m, to_ - 1)
end function
...
function until_rJ_J_LongRange_k_(m as LongInteger, to_ as LongInteger) as Object
    ...
    return rangeTo_rJ_J_LongRange_k_(m, to_ - 1)
end function
...
sub require_Z_Function0Any_k_(value as Boolean, lazyMessage as Object)
    if not value then
        throw IllegalArgumentException_create_StrN_IllegalArgumentException_k_(toString_AnyN_Str_k_(lazyMessage.invoke()))
    end if
end sub
...
sub check_Z_Function0Any_k_(value as Boolean, lazyMessage as Object)
    if not value then
        throw IllegalStateException_create_StrN_IllegalStateException_k_(toString_AnyN_Str_k_(lazyMessage.invoke()))
    end if
end sub

sub error_Any_k_(message as Object)
    throw IllegalStateException_create_StrN_IllegalStateException_k_(toString_AnyN_Str_k_(message))
end sub
...
function iterator_rStr_CharIterator_k_(m as String) as Object
    return Anon_2186e29d_create_Anon_k_()
end function

function iterator_rCharArray_CharIterator_k_(m as Object) as Object
    return Anon_7bcb9b2b_create_Anon_k_()
end function
