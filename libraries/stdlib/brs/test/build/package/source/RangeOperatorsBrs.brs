...
function step_rIntProgression_I_IntProgression_k_(m as Object, step_ as Integer) as Object
    ...
    return IntProgression_Companion_fromClosedRange_I_I_I_IntProgression_k_(m.first, m.last, __when_tmp0)
...
function step_rLongProgression_J_LongProgression_k_(m as Object, step_ as LongInteger) as Object
    ...
    return LongProgression_Companion_fromClosedRange_J_J_J_LongProgression_k_(m.first, m.last, __when_tmp1)
...
function step_rCharProgression_I_CharProgression_k_(m as Object, step_ as Integer) as Object
    ...
    return CharProgression_Companion_fromClosedRange_C_C_I_CharProgression_k_(m.first, m.last, __when_tmp2)
