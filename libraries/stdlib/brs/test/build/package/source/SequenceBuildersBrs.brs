...
function sequenceOf_AnyN_k_(element as Dynamic) as Object
    return Anon_220dce84_create_AnyN_k_(element)
end function
...
function sequenceOf_Iterator_k_(iterator as Object) as Object
    return Anon_750b2877_create_Iterator_k_(iterator)
end function
...
function Sequence_Function0Iterator_k_(iterator as Object) as Object
    return Anon_43d5fdd8_create_Function0Iterator_k_(iterator)
end function
...
function GeneratorSequence_iterator_k_() as Object
    return Anon_38442545_create_GeneratorSequence_k_(m)
end function
...
function Anon_462a6cc1_create_AnyN_k_(_element as Dynamic) as Object
    this = {}
    this.__type = "Anon_462a6cc1"
    this.__proto = ["Anon_462a6cc1", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.hasNext_k_ = Anon_462a6cc1_hasNext_k_
    this.next_k_ = Anon_462a6cc1_next_k_
    this.get_hasNext = Anon_462a6cc1_get_hasNext_k_
    this.set_hasNext = Anon_462a6cc1_set_hasNext_Z_k_
    this.hasNext = true
    this._element = _element
    return this
end function

function Anon_462a6cc1_hasNext_k_() as Boolean
    return m.get_hasNext()
end function

function Anon_462a6cc1_next_k_() as Dynamic
...
function Anon_462a6cc1_get_hasNext_k_() as Boolean
    return m.hasNext
end function

sub Anon_462a6cc1_set_hasNext_Z_k_(value as Boolean)
    m.hasNext = value
end sub

function Anon_220dce84_create_AnyN_k_(_element as Dynamic) as Object
    this = {}
    this.__type = "Anon_220dce84"
    this.__proto = ["Anon_220dce84", "Sequence"]
    this.__id = __kotlin_nextObjectId()
    this.iterator_k_ = Anon_220dce84_iterator_k_
    this._element = _element
    return this
end function

function Anon_220dce84_iterator_k_() as Object
    return Anon_462a6cc1_create_AnyN_k_(m._element)
end function

function Anon_750b2877_create_Iterator_k_(_iterator as Object) as Object
    this = {}
    this.__type = "Anon_750b2877"
    this.__proto = ["Anon_750b2877", "Sequence"]
    this.__id = __kotlin_nextObjectId()
    this.iterator_k_ = Anon_750b2877_iterator_k_
    this._iterator = _iterator
    return this
end function

function Anon_750b2877_iterator_k_() as Object
    return m._iterator
end function

function Anon_43d5fdd8_create_Function0Iterator_k_(_iterator as Object) as Object
    this = {}
    this.__type = "Anon_43d5fdd8"
    this.__proto = ["Anon_43d5fdd8", "Sequence"]
    this.__id = __kotlin_nextObjectId()
    this.iterator_k_ = Anon_43d5fdd8_iterator_k_
    this._iterator = _iterator
    return this
end function

function Anon_43d5fdd8_iterator_k_() as Object
    return m._iterator.invoke()
end function

function Anon_38442545_create_GeneratorSequence_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_38442545"
    this.__proto = ["Anon_38442545", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.calcNext_k_ = Anon_38442545_calcNext_k_
    this.hasNext_k_ = Anon_38442545_hasNext_k_
    this.next_k_ = Anon_38442545_next_k_
    this.get_nextItem = Anon_38442545_get_nextItem_k_
    this.set_nextItem = Anon_38442545_set_nextItem_AnyN_k_
    this.get_nextState = Anon_38442545_get_nextState_k_
    this.set_nextState = Anon_38442545_set_nextState_I_k_
...
function Anon_38442545_hasNext_k_() as Boolean
...
function Anon_38442545_next_k_() as Object
    if m.get_nextState() < 0 then
        m.calcNext_k_()
    end if
    if m.get_nextState() = 0 then
...
function Anon_38442545_get_nextItem_k_() as Dynamic
    return m.nextItem
end function

sub Anon_38442545_set_nextItem_AnyN_k_(value as Dynamic)
    m.nextItem = value
end sub

function Anon_38442545_get_nextState_k_() as Integer
    return m.nextState
end function

sub Anon_38442545_set_nextState_I_k_(value as Integer)
    m.nextState = value
end sub
