...
function sequenceOf_AnyN_k_(element as Dynamic) as Object
    return Anon_7d91d558_create_AnyN_k_(element)
end function
...
function sequenceOf_Iterator_k_(iterator as Object) as Object
    return Anon_6acb728c_create_Iterator_k_(iterator)
end function
...
function Sequence_Function0Iterator_k_(iterator as Object) as Object
    return Anon_3d932cfc_create_Function0Iterator_k_(iterator)
end function
...
function GeneratorSequence_iterator_k_() as Object
    return Anon_1c505d76_create_GeneratorSequence_k_(m)
end function
...
function Anon_7d3983e_create_AnyN_k_(_element as Dynamic) as Object
    this = {}
    this.__type = "Anon_7d3983e"
    this.__proto = ["Anon_7d3983e", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.hasNext_k_ = Anon_7d3983e_hasNext_k_
    this.next_k_ = Anon_7d3983e_next_k_
    this.get_hasNext = Anon_7d3983e_get_hasNext_k_
    this.set_hasNext = Anon_7d3983e_set_hasNext_Z_k_
    this.hasNext = true
    this._element = _element
    return this
end function

function Anon_7d3983e_hasNext_k_() as Boolean
    return m.get_hasNext()
end function

function Anon_7d3983e_next_k_() as Dynamic
...
function Anon_7d3983e_get_hasNext_k_() as Boolean
    return m.hasNext
end function

sub Anon_7d3983e_set_hasNext_Z_k_(value as Boolean)
    m.hasNext = value
end sub

function Anon_7d91d558_create_AnyN_k_(_element as Dynamic) as Object
    this = {}
    this.__type = "Anon_7d91d558"
    this.__proto = ["Anon_7d91d558", "Sequence"]
    this.__id = __kotlin_nextObjectId()
    this.iterator_k_ = Anon_7d91d558_iterator_k_
    this._element = _element
    return this
end function

function Anon_7d91d558_iterator_k_() as Object
    return Anon_7d3983e_create_AnyN_k_(m._element)
end function

function Anon_6acb728c_create_Iterator_k_(_iterator as Object) as Object
    this = {}
    this.__type = "Anon_6acb728c"
    this.__proto = ["Anon_6acb728c", "Sequence"]
    this.__id = __kotlin_nextObjectId()
    this.iterator_k_ = Anon_6acb728c_iterator_k_
    this._iterator = _iterator
    return this
end function

function Anon_6acb728c_iterator_k_() as Object
    return m._iterator
end function

function Anon_3d932cfc_create_Function0Iterator_k_(_iterator as Object) as Object
    this = {}
    this.__type = "Anon_3d932cfc"
    this.__proto = ["Anon_3d932cfc", "Sequence"]
    this.__id = __kotlin_nextObjectId()
    this.iterator_k_ = Anon_3d932cfc_iterator_k_
    this._iterator = _iterator
    return this
end function

function Anon_3d932cfc_iterator_k_() as Object
    return m._iterator.invoke()
end function

function Anon_1c505d76_create_GeneratorSequence_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_1c505d76"
    this.__proto = ["Anon_1c505d76", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.calcNext_k_ = Anon_1c505d76_calcNext_k_
    this.hasNext_k_ = Anon_1c505d76_hasNext_k_
    this.next_k_ = Anon_1c505d76_next_k_
    this.get_nextItem = Anon_1c505d76_get_nextItem_k_
    this.set_nextItem = Anon_1c505d76_set_nextItem_AnyN_k_
    this.get_nextState = Anon_1c505d76_get_nextState_k_
    this.set_nextState = Anon_1c505d76_set_nextState_I_k_
...
function Anon_1c505d76_hasNext_k_() as Boolean
...
function Anon_1c505d76_next_k_() as Object
    if m.get_nextState() < 0 then
        m.calcNext_k_()
    end if
    if m.get_nextState() = 0 then
...
function Anon_1c505d76_get_nextItem_k_() as Dynamic
    return m.nextItem
end function

sub Anon_1c505d76_set_nextItem_AnyN_k_(value as Dynamic)
    m.nextItem = value
end sub

function Anon_1c505d76_get_nextState_k_() as Integer
    return m.nextState
end function

sub Anon_1c505d76_set_nextState_I_k_(value as Integer)
    m.nextState = value
end sub
