...
function sequenceOf_AnyN_k_(element as Dynamic) as Object
    return Anon_13917e51_create_AnyN_k_(element)
end function
...
function sequenceOf_Iterator_k_(iterator as Object) as Object
    return Anon_23353f43_create_Iterator_k_(iterator)
end function
...
function Sequence_Function0Iterator_k_(iterator as Object) as Object
    return Anon_43902ccf_create_Function0Iterator_k_(iterator)
end function
...
function GeneratorSequence_iterator_k_() as Object
    return Anon_2b37b35d_create_GeneratorSequence_k_(m)
end function
...
function Anon_f6c9514_create_AnyN_k_(_element as Dynamic) as Object
    this = {}
    this.__type = "Anon_f6c9514"
    this.__proto = ["Anon_f6c9514", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.hasNext_k_ = Anon_f6c9514_hasNext_k_
    this.next_k_ = Anon_f6c9514_next_k_
    this.get_hasNext = Anon_f6c9514_get_hasNext_k_
    this.set_hasNext = Anon_f6c9514_set_hasNext_Z_k_
    this.hasNext = true
    this._element = _element
    return this
end function

function Anon_f6c9514_hasNext_k_() as Boolean
    return m.get_hasNext()
end function

function Anon_f6c9514_next_k_() as Dynamic
...
function Anon_f6c9514_get_hasNext_k_() as Boolean
    return m.hasNext
end function

sub Anon_f6c9514_set_hasNext_Z_k_(value as Boolean)
    m.hasNext = value
end sub

function Anon_13917e51_create_AnyN_k_(_element as Dynamic) as Object
    this = {}
    this.__type = "Anon_13917e51"
    this.__proto = ["Anon_13917e51", "Sequence"]
    this.__id = __kotlin_nextObjectId()
    this.iterator_k_ = Anon_13917e51_iterator_k_
    this._element = _element
    return this
end function

function Anon_13917e51_iterator_k_() as Object
    return Anon_f6c9514_create_AnyN_k_(m._element)
end function

function Anon_23353f43_create_Iterator_k_(_iterator as Object) as Object
    this = {}
    this.__type = "Anon_23353f43"
    this.__proto = ["Anon_23353f43", "Sequence"]
    this.__id = __kotlin_nextObjectId()
    this.iterator_k_ = Anon_23353f43_iterator_k_
    this._iterator = _iterator
    return this
end function

function Anon_23353f43_iterator_k_() as Object
    return m._iterator
end function

function Anon_43902ccf_create_Function0Iterator_k_(_iterator as Object) as Object
    this = {}
    this.__type = "Anon_43902ccf"
    this.__proto = ["Anon_43902ccf", "Sequence"]
    this.__id = __kotlin_nextObjectId()
    this.iterator_k_ = Anon_43902ccf_iterator_k_
    this._iterator = _iterator
    return this
end function

function Anon_43902ccf_iterator_k_() as Object
    return m._iterator.invoke()
end function

function Anon_2b37b35d_create_GeneratorSequence_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_2b37b35d"
    this.__proto = ["Anon_2b37b35d", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.calcNext_k_ = Anon_2b37b35d_calcNext_k_
    this.hasNext_k_ = Anon_2b37b35d_hasNext_k_
    this.next_k_ = Anon_2b37b35d_next_k_
    this.get_nextItem = Anon_2b37b35d_get_nextItem_k_
    this.set_nextItem = Anon_2b37b35d_set_nextItem_AnyN_k_
    this.get_nextState = Anon_2b37b35d_get_nextState_k_
    this.set_nextState = Anon_2b37b35d_set_nextState_I_k_
...
function Anon_2b37b35d_hasNext_k_() as Boolean
...
function Anon_2b37b35d_next_k_() as Object
    if m.get_nextState() < 0 then
        m.calcNext_k_()
    end if
    if m.get_nextState() = 0 then
...
function Anon_2b37b35d_get_nextItem_k_() as Dynamic
    return m.nextItem
end function

sub Anon_2b37b35d_set_nextItem_AnyN_k_(value as Dynamic)
    m.nextItem = value
end sub

function Anon_2b37b35d_get_nextState_k_() as Integer
    return m.nextState
end function

sub Anon_2b37b35d_set_nextState_I_k_(value as Integer)
    m.nextState = value
end sub
