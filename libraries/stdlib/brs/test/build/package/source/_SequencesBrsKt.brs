...
function scan_rSequence_AnyN_Function2_k_(m as Object, initial as Dynamic, operation as Object) as Object
    return Anon_64357679_create_Sequence_AnyN_Function2_k_(m, initial, operation)
end function

function scanIndexed_rSequence_AnyN_Function3I_k_(m as Object, initial as Dynamic, operation as Object) as Object
    return Anon_2326236d_create_Sequence_AnyN_Function3I_k_(m, initial, operation)
end function
...
function sumOf_rSequence_Function1UInt_k_(m as Object, selector as Object) as Object
    ...
    while __iter_64.hasNext_k_()
        ...
        sum = sum.plus_UInt_k_(selector.invoke(element))
...
function sumOf_rSequence_Function1ULong_k_(m as Object, selector as Object) as Object
    ...
    while __iter_65.hasNext_k_()
        ...
        sum = sum.plus_ULong_k_(selector.invoke(element))
...
function Anon_32bba3e4_create_Sequence_AnyN_Function2_k_(_this_scan as Object, _initial as Dynamic, _operation as Object) as Object
    this = {}
    this.__type = "Anon_32bba3e4"
    this.__proto = ["Anon_32bba3e4", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.hasNext_k_ = Anon_32bba3e4_hasNext_k_
    this.next_k_ = Anon_32bba3e4_next_k_
    this.get_iterator = Anon_32bba3e4_get_iterator_k_
    this.get_accumulator = Anon_32bba3e4_get_accumulator_k_
    this.set_accumulator = Anon_32bba3e4_set_accumulator_AnyN_k_
    this.get_firstEmitted = Anon_32bba3e4_get_firstEmitted_k_
    this.set_firstEmitted = Anon_32bba3e4_set_firstEmitted_Z_k_
...
function Anon_32bba3e4_hasNext_k_() as Boolean
    return not m.get_firstEmitted() or m.get_iterator().hasNext_k_()
end function

function Anon_32bba3e4_next_k_() as Dynamic
...
function Anon_32bba3e4_get_iterator_k_() as Object
    return m.iterator
end function

function Anon_32bba3e4_get_accumulator_k_() as Dynamic
    return m.accumulator
end function

sub Anon_32bba3e4_set_accumulator_AnyN_k_(value as Dynamic)
    m.accumulator = value
end sub

function Anon_32bba3e4_get_firstEmitted_k_() as Boolean
    return m.firstEmitted
end function

sub Anon_32bba3e4_set_firstEmitted_Z_k_(value as Boolean)
    m.firstEmitted = value
end sub

function Anon_64357679_create_Sequence_AnyN_Function2_k_(_this_scan as Object, _initial as Dynamic, _operation as Object) as Object
    this = {}
    this.__type = "Anon_64357679"
    this.__proto = ["Anon_64357679", "Sequence"]
    this.__id = __kotlin_nextObjectId()
    this.iterator_k_ = Anon_64357679_iterator_k_
...
function Anon_64357679_iterator_k_() as Object
    return Anon_32bba3e4_create_Sequence_AnyN_Function2_k_(m._this_scan, m._initial, m._operation)
end function

function Anon_6c9ad5ce_create_Sequence_AnyN_Function3I_k_(_this_scanIndexed as Object, _initial as Dynamic, _operation as Object) as Object
    this = {}
    this.__type = "Anon_6c9ad5ce"
    this.__proto = ["Anon_6c9ad5ce", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.hasNext_k_ = Anon_6c9ad5ce_hasNext_k_
    this.next_k_ = Anon_6c9ad5ce_next_k_
    this.get_iterator = Anon_6c9ad5ce_get_iterator_k_
    this.get_accumulator = Anon_6c9ad5ce_get_accumulator_k_
    this.set_accumulator = Anon_6c9ad5ce_set_accumulator_AnyN_k_
    this.get_index = Anon_6c9ad5ce_get_index_k_
    this.set_index = Anon_6c9ad5ce_set_index_I_k_
    this.get_firstEmitted = Anon_6c9ad5ce_get_firstEmitted_k_
    this.set_firstEmitted = Anon_6c9ad5ce_set_firstEmitted_Z_k_
...
function Anon_6c9ad5ce_hasNext_k_() as Boolean
    return not m.get_firstEmitted() or m.get_iterator().hasNext_k_()
end function

function Anon_6c9ad5ce_next_k_() as Dynamic
    if not m.get_firstEmitted() then
        m.set_firstEmitted(true)
        return m._initial
    end if
...
function Anon_6c9ad5ce_get_iterator_k_() as Object
    return m.iterator
end function

function Anon_6c9ad5ce_get_accumulator_k_() as Dynamic
    return m.accumulator
end function

sub Anon_6c9ad5ce_set_accumulator_AnyN_k_(value as Dynamic)
    m.accumulator = value
end sub

function Anon_6c9ad5ce_get_index_k_() as Integer
    return m.index
end function

sub Anon_6c9ad5ce_set_index_I_k_(value as Integer)
    m.index = value
end sub

function Anon_6c9ad5ce_get_firstEmitted_k_() as Boolean
    return m.firstEmitted
end function

sub Anon_6c9ad5ce_set_firstEmitted_Z_k_(value as Boolean)
    m.firstEmitted = value
end sub

function Anon_2326236d_create_Sequence_AnyN_Function3I_k_(_this_scanIndexed as Object, _initial as Dynamic, _operation as Object) as Object
    this = {}
    this.__type = "Anon_2326236d"
    this.__proto = ["Anon_2326236d", "Sequence"]
    this.__id = __kotlin_nextObjectId()
    this.iterator_k_ = Anon_2326236d_iterator_k_
...
function Anon_2326236d_iterator_k_() as Object
    return Anon_6c9ad5ce_create_Sequence_AnyN_Function3I_k_(m._this_scanIndexed, m._initial, m._operation)
end function
