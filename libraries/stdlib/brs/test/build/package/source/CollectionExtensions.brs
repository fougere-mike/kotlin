...
sub forEachIndexed_rIterable_Function2IV_k_(m as Object, action as Object)
    ...
    while __iter_108.hasNext_k_()
        item = __iter_108.next_k_()
        __incr_tmp_107 = index
        index = (__incr_tmp_107 + 1)

        action.invoke(__incr_tmp_107, item)
...
function mapIndexed_rIterable_Function2I_k_(m as Object, transform as Object) as Object
    ...
    while __iter_111.hasNext_k_()
        item = __iter_111.next_k_()
        __incr_tmp_110 = index
        index = (__incr_tmp_110 + 1)

        result.add_AnyN_k_(transform.invoke(__incr_tmp_110, item))
...
function filter_rIterable_Function1Z_k_(m as Object, predicate as Object) as Object
    result = ArrayList_create_k_()
    __iter_113 = m.iterator_k_()
    while __iter_113.hasNext_k_()
        item = __iter_113.next_k_()
...
function filterIndexed_rIterable_Function2IZ_k_(m as Object, predicate as Object) as Object
    result = ArrayList_create_k_()
    index = 0
    __iter_114 = m.iterator_k_()
    while __iter_114.hasNext_k_()
        item = __iter_114.next_k_()
        unary = index
        index = (unary + 1)
...
function filterNotNull_rIterable_k_(m as Object) as Object
    result = ArrayList_create_k_()
    __iter_115 = m.iterator_k_()
    while __iter_115.hasNext_k_()
        item = __iter_115.next_k_()
...
function foldIndexed_rIterable_AnyN_Function3I_k_(m as Object, initial as Dynamic, operation as Object) as Dynamic
    ...
    while __iter_130.hasNext_k_()
        ...
        __incr_tmp_129 = index
        index = (__incr_tmp_129 + 1)

        accumulator = operation.invoke(__incr_tmp_129, accumulator, element)
...
function reduceIndexed_rIterable_Function3I_k_(m as Object, operation as Object) as Dynamic
    ...
    accumulator = iterator.next_k_()
    while iterator.hasNext_k_()
        __incr_tmp_131 = index
        index = (__incr_tmp_131 + 1)

        accumulator = operation.invoke(__incr_tmp_131, accumulator, iterator.next_k_())
    end while
    return accumulator
end function
...
function dropWhile_rIterable_Function1Z_k_(m as Object, predicate as Object) as Object
    yielding = false
    list = ArrayList_create_k_()
    __iter_141 = m.iterator_k_()
    while __iter_141.hasNext_k_()
        item = __iter_141.next_k_()
        if yielding then
            list.add_AnyN_k_(item)
