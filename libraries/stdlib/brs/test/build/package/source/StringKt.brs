function String_create_k_() as Object
    ...
    this.compareTo_Str_k_ = String_compareTo_Str_k_
    ...
    this.get_length = String_get_length_k_
    return this
end function
...
function String_compareTo_Str_k_(other as String) as Integer
end function
...
function String_get_length_k_() as Integer
    return m.length
end function
