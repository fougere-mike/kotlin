function DefaultBrsAsserter_create_k_() as Object
    ...
    this.fail_StrN_ThrowableN_k_ = DefaultBrsAsserter_fail_StrN_ThrowableN_k_
    return this
end function
...
function DefaultBrsAsserter_fail_StrN_k_(message as Dynamic) as Dynamic
    throw AssertionError_create_AnyN_k_(message)
end function

function DefaultBrsAsserter_fail_StrN_ThrowableN_k_(message as Dynamic, cause as Dynamic) as Dynamic
