...
function RoDeviceInfo_Companion_getInstance() as Object
    if GetGlobalAA().RoDeviceInfo_Companion_instance = invalid then
        GetGlobalAA().RoDeviceInfo_Companion_instance = RoDeviceInfo_Companion_create_k_()
    end if
    return GetGlobalAA().RoDeviceInfo_Companion_instance
end function
...
function RoAppInfo_Companion_getInstance() as Object
    if GetGlobalAA().RoAppInfo_Companion_instance = invalid then
        GetGlobalAA().RoAppInfo_Companion_instance = RoAppInfo_Companion_create_k_()
    end if
    return GetGlobalAA().RoAppInfo_Companion_instance
end function
