...
function Regex_matches_CharSequence_k_(input as Object) as Boolean
    ...
    match = m.get_nativePattern().Match(inputStr)
...
function Regex_containsMatchIn_CharSequence_k_(input as Object) as Boolean
    return m.get_nativePattern().IsMatch(toString_AnyN_k_(input))
end function
...
function Regex_matchAt_CharSequence_I_k_(input as Object, index as Integer) as Dynamic
    ...
    match = m.get_nativePattern().Match(substring)
    if isEmpty_rArr_k_(match) then
        return invalid
    end if
...
function Regex_replace_CharSequence_Str_k_(input as Object, replacement as String) as String
    if not contains_rStr_Str_Z_k_(replacement, "\", invalid) and not contains_rStr_Str_Z_k_(replacement, "$", invalid) then
        return m.get_nativePattern().ReplaceAll(toString_AnyN_k_(input), replacement)
    end if
...
function Regex_replaceFirst_CharSequence_Str_k_(input as Object, replacement as String) as String
    ...
    if not contains_rStr_Str_Z_k_(replacement, "\", invalid) and not contains_rStr_Str_Z_k_(replacement, "$", invalid) then
        return m.get_nativePattern().Replace(toString_AnyN_k_(input), replacement)
    end if
    inputStr = toString_AnyN_k_(input)
...
function Regex_split_CharSequence_I_k_(input as Object, limit = 0) as Object
    ...
    lastStart = 0
    __iter_71 = matches.iterator_k_()
    while __iter_71.hasNext_k_()
        match = __iter_71.next_k_()
...
function Regex_splitToSequence_CharSequence_I_k_(input as Object, limit = 0) as Object
    ...
    return Sequence_Function0Iterator_k_({__this: m, input: input, limit: limit, invoke: function() as Object
        return Anon_314927b7_create_Regex_CharSequence_I_k_(m, m.input, m.limit)
    end function})
end function
...
function Regex_createMatchResult_Str_Arr_I_k_(input as String, matchArray as Object, matchIndex as Integer) as Object
    return Anon_6e848fd1_create_I_Arr_Str_Regex_k_(matchIndex, matchArray, input, m)
end function
...
function substituteGroupRefs_MatchResult_Str_k_(match as Object, replacement as String) as String
    ...
    while index < Len(replacement)
        ...
        char = Mid(replacement, __incr_tmp_72 + 1, 1)
        if char = "\" then
            if index = Len(replacement) then
                throw IllegalArgumentException_create_StrN_k_("The Char to be escaped is missing")
            end if
            __incr_tmp_73 = index
            index = (__incr_tmp_73 + 1)

            result.append_C_k_(Mid(replacement, __incr_tmp_73 + 1, 1))
        else if char = "$" then
            if index = Len(replacement) then
            ...
            if Mid(replacement, index + 1, 1) = "{" then
                ...
                if not rangeTo_rC_C_k_("0", "9").contains_C_k_(Mid(replacement, index + 1, 1)) then
...
function readGroupIndex_rStr_I_I_k_(m as String, startIndex as Integer, groupCount as Integer) as Integer
    ...
    while (index < Len(m)) and rangeTo_rC_C_k_("0", "9").contains_C_k_(Mid(m, index + 1, 1))
...
function Anon_314927b7_create_Regex_CharSequence_I_k_(this_0 as Object, _input as Object, _limit as Integer) as Object
    this = {}
    this.__type = "Anon_314927b7"
    this.__proto = ["Anon_314927b7", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.hasNext_k_ = Anon_314927b7_hasNext_k_
    this.next_k_ = Anon_314927b7_next_k_
    this.get_match = Anon_314927b7_get_match_k_
    this.set_match = Anon_314927b7_set_match_MatchResultN_k_
    this.get_firstMatch = Anon_314927b7_get_firstMatch_k_
    this.get_nextStart = Anon_314927b7_get_nextStart_k_
    this.set_nextStart = Anon_314927b7_set_nextStart_I_k_
    this.get_splitCount = Anon_314927b7_get_splitCount_k_
    this.set_splitCount = Anon_314927b7_set_splitCount_I_k_
    this.get_emitted = Anon_314927b7_get_emitted_k_
    this.set_emitted = Anon_314927b7_set_emitted_Z_k_
...
function Anon_314927b7_hasNext_k_() as Boolean
    if not m.get_emitted() and ((m.get_firstMatch() = invalid) or (m._limit = 1)) then
        return true
    end if
    if (m._limit > 0) and (m.get_splitCount() >= (m._limit - 1)) then
        return not m.get_emitted() or (m.get_nextStart() < __kotlin_charSequenceLength_CharSequenceN_k_(m._input))
    end if
    return (m.get_nextStart() < __kotlin_charSequenceLength_CharSequenceN_k_(m._input)) or ((m.get_match() <> invalid) and not m.get_emitted())
end function

function Anon_314927b7_next_k_() as String
    ...
    if (m.get_match() <> invalid) and ((m._limit = 0) or (m.get_splitCount() < (m._limit - 1))) then
        ...
        result = toString_AnyN_k_(m._input.subSequence_I_I_k_(m.get_nextStart(), __kotlin_charSequenceLength_CharSequenceN_k_(m._input)))
        m.set_nextStart(__kotlin_charSequenceLength_CharSequenceN_k_(m._input))
        m.set_emitted(true)
        return result
    end if
end function

function Anon_314927b7_get_match_k_() as Dynamic
    return m.match
end function

sub Anon_314927b7_set_match_MatchResultN_k_(value as Dynamic)
    m.match = value
end sub

function Anon_314927b7_get_firstMatch_k_() as Dynamic
    return m.firstMatch
end function

function Anon_314927b7_get_nextStart_k_() as Integer
    return m.nextStart
end function

sub Anon_314927b7_set_nextStart_I_k_(value as Integer)
    m.nextStart = value
end sub

function Anon_314927b7_get_splitCount_k_() as Integer
    return m.splitCount
end function

sub Anon_314927b7_set_splitCount_I_k_(value as Integer)
    m.splitCount = value
end sub

function Anon_314927b7_get_emitted_k_() as Boolean
    return m.emitted
end function

sub Anon_314927b7_set_emitted_Z_k_(value as Boolean)
    m.emitted = value
end sub

function Anon_20a65860_create_Anon_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_20a65860"
    this.__proto = ["Anon_20a65860", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.hasNext_k_ = Anon_20a65860_hasNext_k_
    this.next_k_ = Anon_20a65860_next_k_
    this.get_index = Anon_20a65860_get_index_k_
    this.set_index = Anon_20a65860_set_index_I_k_
    this.index = 0
    this.this_0 = this_0
    return this
end function

function Anon_20a65860_hasNext_k_() as Boolean
    return m.get_index() < m.this_0.get_size()
end function

function Anon_20a65860_next_k_() as Dynamic
    if not m.hasNext_k_() then
        throw NoSuchElementException_create_k_()
    end if
    __incr_tmp_74 = m.get_index()
    m.set_index(__incr_tmp_74 + 1)
    return m.this_0.get_I_k_(__incr_tmp_74)

end function

function Anon_20a65860_get_index_k_() as Integer
    return m.index
end function

sub Anon_20a65860_set_index_I_k_(value as Integer)
    m.index = value
end sub

function Anon_6f05b4ea_create_Arr_k_(_matchArray as Object) as Object
    this = {}
    this.__type = "Anon_6f05b4ea"
    this.__proto = ["Anon_6f05b4ea", "MatchGroupCollection", "Collection", "Iterable"]
    this.__id = __kotlin_nextObjectId()
    this.iterator_k_ = Anon_6f05b4ea_iterator_k_
    this.get_I_k_ = Anon_6f05b4ea_get_I_k_
    this.contains_MatchGroupN_k_ = Anon_6f05b4ea_contains_MatchGroupN_k_
    this.containsAll_CollectionMatchGroupN_k_ = Anon_6f05b4ea_containsAll_CollectionMatchGroupN_k_
    this.isEmpty_k_ = Anon_6f05b4ea_isEmpty_k_
    this.get_size = Anon_6f05b4ea_get_size_k_
    this._matchArray = _matchArray
    return this
end function

function Anon_6f05b4ea_iterator_k_() as Object
    return Anon_20a65860_create_Anon_k_(m)
end function

function Anon_6f05b4ea_get_I_k_(index as Integer) as Dynamic
...
function Anon_6f05b4ea_contains_MatchGroupN_k_(element as Dynamic) as Boolean
...
function Anon_6f05b4ea_containsAll_CollectionMatchGroupN_k_(elements as Object) as Boolean
...
function Anon_6f05b4ea_isEmpty_k_() as Boolean
    return m.get_size() = 0
end function

function Anon_6f05b4ea_get_size_k_() as Integer
    return m._matchArray.count()
end function

function Anon_5e467904_create_Anon_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_5e467904"
    this.__proto = ["Anon_5e467904", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.hasNext_k_ = Anon_5e467904_hasNext_k_
    this.next_k_ = Anon_5e467904_next_k_
    this.get_index = Anon_5e467904_get_index_k_
    this.set_index = Anon_5e467904_set_index_I_k_
    this.index = 0
    this.this_0 = this_0
    return this
end function

function Anon_5e467904_hasNext_k_() as Boolean
    return m.get_index() < m.this_0.get_size()
end function

function Anon_5e467904_next_k_() as String
    if not m.hasNext_k_() then
        throw NoSuchElementException_create_k_()
    end if
    __incr_tmp_76 = m.get_index()
    m.set_index(__incr_tmp_76 + 1)
    return m.this_0.get_I_k_(__incr_tmp_76)

end function

function Anon_5e467904_get_index_k_() as Integer
    return m.index
end function

sub Anon_5e467904_set_index_I_k_(value as Integer)
    m.index = value
end sub

function Anon_26938022_create_I_Anon_k_(_index as Integer, this_0 as Object) as Object
    this = {}
    this.__type = "Anon_26938022"
    this.__proto = ["Anon_26938022", "ListIterator", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.hasNext_k_ = Anon_26938022_hasNext_k_
    this.hasPrevious_k_ = Anon_26938022_hasPrevious_k_
    this.next_k_ = Anon_26938022_next_k_
    this.nextIndex_k_ = Anon_26938022_nextIndex_k_
    this.previous_k_ = Anon_26938022_previous_k_
    this.previousIndex_k_ = Anon_26938022_previousIndex_k_
    this.get_currentIndex = Anon_26938022_get_currentIndex_k_
    this.set_currentIndex = Anon_26938022_set_currentIndex_I_k_
    this.currentIndex = _index
    this.this_0 = this_0
    return this
end function

function Anon_26938022_hasNext_k_() as Boolean
    return m.get_currentIndex() < m.this_0.get_size()
end function

function Anon_26938022_hasPrevious_k_() as Boolean
    return m.get_currentIndex() > 0
end function

function Anon_26938022_next_k_() as String
    if not m.hasNext_k_() then
        throw NoSuchElementException_create_k_()
    end if
    __incr_tmp_77 = m.get_currentIndex()
    m.set_currentIndex(__incr_tmp_77 + 1)
    return m.this_0.get_I_k_(__incr_tmp_77)

end function

function Anon_26938022_nextIndex_k_() as Integer
    return m.get_currentIndex()
end function

function Anon_26938022_previous_k_() as String
...
function Anon_26938022_previousIndex_k_() as Integer
    return m.get_currentIndex() - 1
end function

function Anon_26938022_get_currentIndex_k_() as Integer
    return m.currentIndex
end function

sub Anon_26938022_set_currentIndex_I_k_(value as Integer)
    m.currentIndex = value
end sub

function Anon_676fe49a_create_Anon_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_676fe49a"
    this.__proto = ["Anon_676fe49a", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.hasNext_k_ = Anon_676fe49a_hasNext_k_
    this.next_k_ = Anon_676fe49a_next_k_
    this.get_index = Anon_676fe49a_get_index_k_
    this.set_index = Anon_676fe49a_set_index_I_k_
    this.index = 0
    this.this_0 = this_0
    return this
end function

function Anon_676fe49a_hasNext_k_() as Boolean
    return m.get_index() < m.this_0.get_size()
end function

function Anon_676fe49a_next_k_() as String
    if not m.hasNext_k_() then
        throw NoSuchElementException_create_k_()
    end if
    __incr_tmp_78 = m.get_index()
    m.set_index(__incr_tmp_78 + 1)
    return m.this_0.get_I_k_(__incr_tmp_78)

end function

function Anon_676fe49a_get_index_k_() as Integer
    return m.index
end function

sub Anon_676fe49a_set_index_I_k_(value as Integer)
    m.index = value
end sub

function Anon_7248fa10_create_I_Anon_k_(_index as Integer, this_0 as Object) as Object
    this = {}
    this.__type = "Anon_7248fa10"
    this.__proto = ["Anon_7248fa10", "ListIterator", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.hasNext_k_ = Anon_7248fa10_hasNext_k_
    this.hasPrevious_k_ = Anon_7248fa10_hasPrevious_k_
    this.next_k_ = Anon_7248fa10_next_k_
    this.nextIndex_k_ = Anon_7248fa10_nextIndex_k_
    this.previous_k_ = Anon_7248fa10_previous_k_
    this.previousIndex_k_ = Anon_7248fa10_previousIndex_k_
    this.get_currentIndex = Anon_7248fa10_get_currentIndex_k_
    this.set_currentIndex = Anon_7248fa10_set_currentIndex_I_k_
    this.currentIndex = _index
    this.this_0 = this_0
    return this
end function

function Anon_7248fa10_hasNext_k_() as Boolean
    return m.get_currentIndex() < m.this_0.get_size()
end function

function Anon_7248fa10_hasPrevious_k_() as Boolean
    return m.get_currentIndex() > 0
end function

function Anon_7248fa10_next_k_() as String
    if not m.hasNext_k_() then
        throw NoSuchElementException_create_k_()
    end if
    __incr_tmp_79 = m.get_currentIndex()
    m.set_currentIndex(__incr_tmp_79 + 1)
    return m.this_0.get_I_k_(__incr_tmp_79)

end function

function Anon_7248fa10_nextIndex_k_() as Integer
    return m.get_currentIndex()
end function

function Anon_7248fa10_previous_k_() as String
    if not m.hasPrevious_k_() then
        throw NoSuchElementException_create_k_()
    end if
    return m.this_0.get_I_k_(m.get_currentIndex())
...
function Anon_7248fa10_previousIndex_k_() as Integer
    return m.get_currentIndex() - 1
end function

function Anon_7248fa10_get_currentIndex_k_() as Integer
    return m.currentIndex
end function

sub Anon_7248fa10_set_currentIndex_I_k_(value as Integer)
    m.currentIndex = value
end sub

function Anon_14bdd8a6_create_Anon_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_14bdd8a6"
    this.__proto = ["Anon_14bdd8a6", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.hasNext_k_ = Anon_14bdd8a6_hasNext_k_
    this.next_k_ = Anon_14bdd8a6_next_k_
    this.get_index = Anon_14bdd8a6_get_index_k_
    this.set_index = Anon_14bdd8a6_set_index_I_k_
    this.index = 0
    this.this_0 = this_0
    return this
end function

function Anon_14bdd8a6_hasNext_k_() as Boolean
    return m.get_index() < m.this_0.get_size()
end function

function Anon_14bdd8a6_next_k_() as String
    if not m.hasNext_k_() then
        throw NoSuchElementException_create_k_()
    end if
    __incr_tmp_80 = m.get_index()
    m.set_index(__incr_tmp_80 + 1)
    return m.this_0.get_I_k_(__incr_tmp_80)

end function

function Anon_14bdd8a6_get_index_k_() as Integer
    return m.index
end function

sub Anon_14bdd8a6_set_index_I_k_(value as Integer)
    m.index = value
end sub

function Anon_1c553585_create_I_Anon_k_(_index as Integer, this_0 as Object) as Object
    this = {}
    this.__type = "Anon_1c553585"
    this.__proto = ["Anon_1c553585", "ListIterator", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.hasNext_k_ = Anon_1c553585_hasNext_k_
    this.hasPrevious_k_ = Anon_1c553585_hasPrevious_k_
    this.next_k_ = Anon_1c553585_next_k_
    this.nextIndex_k_ = Anon_1c553585_nextIndex_k_
    this.previous_k_ = Anon_1c553585_previous_k_
    this.previousIndex_k_ = Anon_1c553585_previousIndex_k_
    this.get_currentIndex = Anon_1c553585_get_currentIndex_k_
    this.set_currentIndex = Anon_1c553585_set_currentIndex_I_k_
    this.currentIndex = _index
    this.this_0 = this_0
    return this
end function

function Anon_1c553585_hasNext_k_() as Boolean
    return m.get_currentIndex() < m.this_0.get_size()
end function

function Anon_1c553585_hasPrevious_k_() as Boolean
    return m.get_currentIndex() > 0
end function

function Anon_1c553585_next_k_() as String
    if not m.hasNext_k_() then
        throw NoSuchElementException_create_k_()
    end if
    __incr_tmp_81 = m.get_currentIndex()
    m.set_currentIndex(__incr_tmp_81 + 1)
    return m.this_0.get_I_k_(__incr_tmp_81)

end function

function Anon_1c553585_nextIndex_k_() as Integer
    return m.get_currentIndex()
end function

function Anon_1c553585_previous_k_() as String
    if not m.hasPrevious_k_() then
        throw NoSuchElementException_create_k_()
    end if
    return m.this_0.get_I_k_(m.get_currentIndex())
...
function Anon_1c553585_previousIndex_k_() as Integer
    return m.get_currentIndex() - 1
end function

function Anon_1c553585_get_currentIndex_k_() as Integer
    return m.currentIndex
end function

sub Anon_1c553585_set_currentIndex_I_k_(value as Integer)
    m.currentIndex = value
end sub

function Anon_67b95f82_create_I_Arr_I_k_(_nestedSubSize as Integer, _matchArray as Object, _actualFromIndex as Integer) as Object
    this = {}
    this.__type = "Anon_67b95f82"
    this.__proto = ["Anon_67b95f82", "List", "Collection", "Iterable"]
    this.__id = __kotlin_nextObjectId()
    this.get_I_k_ = Anon_67b95f82_get_I_k_
    this.indexOf_Str_k_ = Anon_67b95f82_indexOf_Str_k_
    this.lastIndexOf_Str_k_ = Anon_67b95f82_lastIndexOf_Str_k_
    this.isEmpty_k_ = Anon_67b95f82_isEmpty_k_
    this.contains_Str_k_ = Anon_67b95f82_contains_Str_k_
    this.containsAll_CollectionStr_k_ = Anon_67b95f82_containsAll_CollectionStr_k_
    this.iterator_k_ = Anon_67b95f82_iterator_k_
    this.listIterator_k_ = Anon_67b95f82_listIterator_k_
    this.listIterator_I_k_ = Anon_67b95f82_listIterator_I_k_
    this.subList_I_I_k_ = Anon_67b95f82_subList_I_I_k_
    this.get_size = Anon_67b95f82_get_size_k_
...
function Anon_67b95f82_get_I_k_(index as Integer) as String
...
function Anon_67b95f82_indexOf_Str_k_(element as String) as Integer
    progression = until_rI_I_k_(0, m.get_size())
    inductionVariable = progression.get_first()
    last = progression.get_last()
    if inductionVariable <= last then
...
function Anon_67b95f82_lastIndexOf_Str_k_(element as String) as Integer
...
function Anon_67b95f82_isEmpty_k_() as Boolean
    return m.get_size() = 0
end function

function Anon_67b95f82_contains_Str_k_(element as String) as Boolean
    return m.indexOf_Str_k_(element) >= 0
end function

function Anon_67b95f82_containsAll_CollectionStr_k_(elements as Object) as Boolean
...
function Anon_67b95f82_iterator_k_() as Object
    return Anon_14bdd8a6_create_Anon_k_(m)
end function

function Anon_67b95f82_listIterator_k_() as Object
    return m.listIterator_I_k_(0)
end function

function Anon_67b95f82_listIterator_I_k_(index as Integer) as Object
    if (index < 0) or (index > m.get_size()) then
        throw IndexOutOfBoundsException_create_k_()
    end if
    return Anon_1c553585_create_I_Anon_k_(index, m)
end function

function Anon_67b95f82_subList_I_I_k_(fromIndex as Integer, toIndex as Integer) as Object
...
function Anon_67b95f82_get_size_k_() as Integer
    return m.size
end function

function Anon_56bb8198_create_I_Arr_I_k_(_subSize as Integer, _matchArray as Object, _outerFromIndex as Integer) as Object
    this = {}
    this.__type = "Anon_56bb8198"
    this.__proto = ["Anon_56bb8198", "List", "Collection", "Iterable"]
    this.__id = __kotlin_nextObjectId()
    this.get_I_k_ = Anon_56bb8198_get_I_k_
    this.indexOf_Str_k_ = Anon_56bb8198_indexOf_Str_k_
    this.lastIndexOf_Str_k_ = Anon_56bb8198_lastIndexOf_Str_k_
    this.isEmpty_k_ = Anon_56bb8198_isEmpty_k_
    this.contains_Str_k_ = Anon_56bb8198_contains_Str_k_
    this.containsAll_CollectionStr_k_ = Anon_56bb8198_containsAll_CollectionStr_k_
    this.iterator_k_ = Anon_56bb8198_iterator_k_
    this.listIterator_k_ = Anon_56bb8198_listIterator_k_
    this.listIterator_I_k_ = Anon_56bb8198_listIterator_I_k_
    this.subList_I_I_k_ = Anon_56bb8198_subList_I_I_k_
    this.get_size = Anon_56bb8198_get_size_k_
    this.size = _subSize
    this._matchArray = _matchArray
...
function Anon_56bb8198_get_I_k_(index as Integer) as String
    if (index < 0) or (index >= m.get_size()) then
        throw IndexOutOfBoundsException_create_k_()
    end if
...
function Anon_56bb8198_indexOf_Str_k_(element as String) as Integer
    progression = until_rI_I_k_(0, m.get_size())
    inductionVariable = progression.get_first()
    last = progression.get_last()
    if inductionVariable <= last then
...
function Anon_56bb8198_lastIndexOf_Str_k_(element as String) as Integer
    inductionVariable = m.get_size() - 1
    if 0 <= inductionVariable then
                i = inductionVariable
        inductionVariable = (inductionVariable + -1)
...
function Anon_56bb8198_isEmpty_k_() as Boolean
    return m.get_size() = 0
end function

function Anon_56bb8198_contains_Str_k_(element as String) as Boolean
    return m.indexOf_Str_k_(element) >= 0
end function

function Anon_56bb8198_containsAll_CollectionStr_k_(elements as Object) as Boolean
...
function Anon_56bb8198_iterator_k_() as Object
    return Anon_676fe49a_create_Anon_k_(m)
end function

function Anon_56bb8198_listIterator_k_() as Object
    return m.listIterator_I_k_(0)
end function

function Anon_56bb8198_listIterator_I_k_(index as Integer) as Object
    if (index < 0) or (index > m.get_size()) then
        throw IndexOutOfBoundsException_create_k_()
    end if
    return Anon_7248fa10_create_I_Anon_k_(index, m)
end function

function Anon_56bb8198_subList_I_I_k_(fromIndex as Integer, toIndex as Integer) as Object
    if ((fromIndex < 0) or (toIndex > m.get_size())) or (fromIndex > toIndex) then
        throw IndexOutOfBoundsException_create_k_()
    end if
    ...
    return Anon_67b95f82_create_I_Arr_I_k_(nestedSubSize, m._matchArray, actualFromIndex)
end function

function Anon_56bb8198_get_size_k_() as Integer
    return m.size
end function

function Anon_34a8facf_create_Arr_k_(_matchArray as Object) as Object
    this = {}
    this.__type = "Anon_34a8facf"
    this.__proto = ["Anon_34a8facf", "List", "Collection", "Iterable"]
    this.__id = __kotlin_nextObjectId()
    this.get_I_k_ = Anon_34a8facf_get_I_k_
    this.indexOf_Str_k_ = Anon_34a8facf_indexOf_Str_k_
    this.lastIndexOf_Str_k_ = Anon_34a8facf_lastIndexOf_Str_k_
    this.isEmpty_k_ = Anon_34a8facf_isEmpty_k_
    this.contains_Str_k_ = Anon_34a8facf_contains_Str_k_
    this.containsAll_CollectionStr_k_ = Anon_34a8facf_containsAll_CollectionStr_k_
    this.iterator_k_ = Anon_34a8facf_iterator_k_
    this.listIterator_k_ = Anon_34a8facf_listIterator_k_
    this.listIterator_I_k_ = Anon_34a8facf_listIterator_I_k_
    this.subList_I_I_k_ = Anon_34a8facf_subList_I_I_k_
    this.get_size = Anon_34a8facf_get_size_k_
    this._matchArray = _matchArray
    return this
end function

function Anon_34a8facf_get_I_k_(index as Integer) as String
...
function Anon_34a8facf_indexOf_Str_k_(element as String) as Integer
    progression = until_rI_I_k_(0, m.get_size())
    inductionVariable = progression.get_first()
    last = progression.get_last()
    if inductionVariable <= last then
...
function Anon_34a8facf_lastIndexOf_Str_k_(element as String) as Integer
    inductionVariable = m.get_size() - 1
    if 0 <= inductionVariable then
                i = inductionVariable
        inductionVariable = (inductionVariable + -1)
...
function Anon_34a8facf_isEmpty_k_() as Boolean
    return m.get_size() = 0
end function

function Anon_34a8facf_contains_Str_k_(element as String) as Boolean
    return m.indexOf_Str_k_(element) >= 0
end function

function Anon_34a8facf_containsAll_CollectionStr_k_(elements as Object) as Boolean
...
function Anon_34a8facf_iterator_k_() as Object
    return Anon_5e467904_create_Anon_k_(m)
end function

function Anon_34a8facf_listIterator_k_() as Object
    return m.listIterator_I_k_(0)
end function

function Anon_34a8facf_listIterator_I_k_(index as Integer) as Object
    if (index < 0) or (index > m.get_size()) then
        throw IndexOutOfBoundsException_create_k_()
    end if
    return Anon_26938022_create_I_Anon_k_(index, m)
end function

function Anon_34a8facf_subList_I_I_k_(fromIndex as Integer, toIndex as Integer) as Object
    if ((fromIndex < 0) or (toIndex > m.get_size())) or (fromIndex > toIndex) then
        throw IndexOutOfBoundsException_create_k_()
    end if
    outerFromIndex = fromIndex
    subSize = toIndex - fromIndex
    return Anon_56bb8198_create_I_Arr_I_k_(subSize, m._matchArray, outerFromIndex)
end function

function Anon_34a8facf_get_size_k_() as Integer
    return m._matchArray.count()
end function

function Anon_6e848fd1_create_I_Arr_Str_Regex_k_(_matchIndex as Integer, _matchArray as Object, _input as String, this_0 as Object) as Object
    this = {}
    this.__type = "Anon_6e848fd1"
    this.__proto = ["Anon_6e848fd1", "MatchResult"]
    this.__id = __kotlin_nextObjectId()
    this.next_k_ = Anon_6e848fd1_next_k_
    this.get_range = Anon_6e848fd1_get_range_k_
    this.get_value = Anon_6e848fd1_get_value_k_
    this.get_groups = Anon_6e848fd1_get_groups_k_
    this.get_groupValues_ = Anon_6e848fd1_get_groupValues__k_
    this.set_groupValues_ = Anon_6e848fd1_set_groupValues__ListStrN_k_
    this.get_groupValues = Anon_6e848fd1_get_groupValues_k_
    this.range = until_rI_I_k_(_matchIndex, _matchIndex + Len(_matchArray[0]))
    this.value = _matchArray[0]
    this.groups = Anon_6f05b4ea_create_Arr_k_(_matchArray)
...
function Anon_6e848fd1_next_k_() as Dynamic
    __when_tmp3 = invalid
...
function Anon_6e848fd1_get_range_k_() as Object
    return m.range
end function

function Anon_6e848fd1_get_value_k_() as String
    return m.value
end function

function Anon_6e848fd1_get_groups_k_() as Object
    return m.groups
end function

function Anon_6e848fd1_get_groupValues__k_() as Dynamic
    return m.groupValues_
end function

sub Anon_6e848fd1_set_groupValues__ListStrN_k_(value as Dynamic)
    m.groupValues_ = value
end sub

function Anon_6e848fd1_get_groupValues_k_() as Object
    if m.get_groupValues_() = invalid then
        m.set_groupValues_(Anon_34a8facf_create_Arr_k_(m._matchArray))
    end if
