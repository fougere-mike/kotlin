...
function Regex_splitToSequence_CharSequence_I_k_(input as Object, limit = 0) as Object
    ...
    return Sequence_Function0Iterator_k_({this: m, _input: _input, _limit: _limit, this_0: this_0, this: m, this: m, value: value, this: m, this: m, this: m, value: value, this: m, this: m, value: value, this: m, this: m, value: value, this: m, this: m, this: m, input: input, limit: limit, invoke: function() as Object
        return Anon_283f20ea_create_Regex_CharSequence_I_k_(m.this, m.input, m.limit)
    end function})
end function
...
function Regex_createMatchResult_Str_Arr_I_k_(input as String, matchArray as Object, matchIndex as Integer) as Object
    return Anon_6a68159e_create_I_Arr_Str_Regex_k_(matchIndex, matchArray, input, m)
end function
...
function substituteGroupRefs_MatchResult_Str_k_(match as Object, replacement as String) as String
    ...
    while index < Len(replacement)
        ...
        char = replacement.get_I_k_(__incr_tmp_72)
        if char = "\" then
            ...
            result.append_C_k_(replacement.get_I_k_(__incr_tmp_73))
        else if char = "$" then
            if index = Len(replacement) then
...
function Anon_283f20ea_create_Regex_CharSequence_I_k_(this_0 as Object, _input as Object, _limit as Integer) as Object
    this = {}
    this.__type = "Anon_283f20ea"
    this.__proto = ["Anon_283f20ea", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.hasNext_k_ = Anon_283f20ea_hasNext_k_
    this.next_k_ = Anon_283f20ea_next_k_
    this.get_match = Anon_283f20ea_get_match_k_
    this.set_match = Anon_283f20ea_set_match_MatchResultN_k_
    this.get_firstMatch = Anon_283f20ea_get_firstMatch_k_
    this.get_nextStart = Anon_283f20ea_get_nextStart_k_
    this.set_nextStart = Anon_283f20ea_set_nextStart_I_k_
    this.get_splitCount = Anon_283f20ea_get_splitCount_k_
    this.set_splitCount = Anon_283f20ea_set_splitCount_I_k_
    this.get_emitted = Anon_283f20ea_get_emitted_k_
    this.set_emitted = Anon_283f20ea_set_emitted_Z_k_
...
function Anon_283f20ea_hasNext_k_() as Boolean
...
function Anon_283f20ea_next_k_() as String
...
function Anon_283f20ea_get_match_k_() as Dynamic
    return m.match
end function

sub Anon_283f20ea_set_match_MatchResultN_k_(value as Dynamic)
    m.match = value
end sub

function Anon_283f20ea_get_firstMatch_k_() as Dynamic
    return m.firstMatch
end function

function Anon_283f20ea_get_nextStart_k_() as Integer
    return m.nextStart
end function

sub Anon_283f20ea_set_nextStart_I_k_(value as Integer)
    m.nextStart = value
end sub

function Anon_283f20ea_get_splitCount_k_() as Integer
    return m.splitCount
end function

sub Anon_283f20ea_set_splitCount_I_k_(value as Integer)
    m.splitCount = value
end sub

function Anon_283f20ea_get_emitted_k_() as Boolean
    return m.emitted
end function

sub Anon_283f20ea_set_emitted_Z_k_(value as Boolean)
    m.emitted = value
end sub

function Anon_7ee1077f_create_Anon_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_7ee1077f"
    this.__proto = ["Anon_7ee1077f", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.hasNext_k_ = Anon_7ee1077f_hasNext_k_
    this.next_k_ = Anon_7ee1077f_next_k_
    this.get_index = Anon_7ee1077f_get_index_k_
    this.set_index = Anon_7ee1077f_set_index_I_k_
    this.index = 0
    this.this_0 = this_0
    return this
end function

function Anon_7ee1077f_hasNext_k_() as Boolean
    return m.get_index() < m.this_0.get_size()
end function

function Anon_7ee1077f_next_k_() as Dynamic
    if not m.hasNext_k_() then
        throw NoSuchElementException_create_k_()
    end if
...
function Anon_7ee1077f_get_index_k_() as Integer
    return m.index
end function

sub Anon_7ee1077f_set_index_I_k_(value as Integer)
    m.index = value
end sub

function Anon_36689eca_create_Arr_k_(_matchArray as Object) as Object
    this = {}
    this.__type = "Anon_36689eca"
    this.__proto = ["Anon_36689eca", "MatchGroupCollection", "Collection", "Iterable"]
    this.__id = __kotlin_nextObjectId()
    this.iterator_k_ = Anon_36689eca_iterator_k_
    this.get_I_k_ = Anon_36689eca_get_I_k_
    this.contains_MatchGroupN_k_ = Anon_36689eca_contains_MatchGroupN_k_
    this.containsAll_CollectionMatchGroupN_k_ = Anon_36689eca_containsAll_CollectionMatchGroupN_k_
    this.isEmpty_k_ = Anon_36689eca_isEmpty_k_
    this.get_size = Anon_36689eca_get_size_k_
    this._matchArray = _matchArray
    return this
end function

function Anon_36689eca_iterator_k_() as Object
    return Anon_7ee1077f_create_Anon_k_(m)
end function

function Anon_36689eca_get_I_k_(index as Integer) as Dynamic
...
function Anon_36689eca_contains_MatchGroupN_k_(element as Dynamic) as Boolean
...
function Anon_36689eca_containsAll_CollectionMatchGroupN_k_(elements as Object) as Boolean
...
function Anon_36689eca_isEmpty_k_() as Boolean
    return m.get_size() = 0
end function

function Anon_36689eca_get_size_k_() as Integer
    return m._matchArray.count()
end function

function Anon_5c0f5789_create_Anon_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_5c0f5789"
    this.__proto = ["Anon_5c0f5789", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.hasNext_k_ = Anon_5c0f5789_hasNext_k_
    this.next_k_ = Anon_5c0f5789_next_k_
    this.get_index = Anon_5c0f5789_get_index_k_
    this.set_index = Anon_5c0f5789_set_index_I_k_
    this.index = 0
    this.this_0 = this_0
    return this
end function

function Anon_5c0f5789_hasNext_k_() as Boolean
    return m.get_index() < m.this_0.get_size()
end function

function Anon_5c0f5789_next_k_() as String
    if not m.hasNext_k_() then
        throw NoSuchElementException_create_k_()
    end if
...
function Anon_5c0f5789_get_index_k_() as Integer
    return m.index
end function

sub Anon_5c0f5789_set_index_I_k_(value as Integer)
    m.index = value
end sub

function Anon_2bc0ea42_create_I_Anon_k_(_index as Integer, this_0 as Object) as Object
    this = {}
    this.__type = "Anon_2bc0ea42"
    this.__proto = ["Anon_2bc0ea42", "ListIterator", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.hasNext_k_ = Anon_2bc0ea42_hasNext_k_
    this.hasPrevious_k_ = Anon_2bc0ea42_hasPrevious_k_
    this.next_k_ = Anon_2bc0ea42_next_k_
    this.nextIndex_k_ = Anon_2bc0ea42_nextIndex_k_
    this.previous_k_ = Anon_2bc0ea42_previous_k_
    this.previousIndex_k_ = Anon_2bc0ea42_previousIndex_k_
    this.get_currentIndex = Anon_2bc0ea42_get_currentIndex_k_
    this.set_currentIndex = Anon_2bc0ea42_set_currentIndex_I_k_
    this.currentIndex = _index
    this.this_0 = this_0
    return this
end function

function Anon_2bc0ea42_hasNext_k_() as Boolean
    return m.get_currentIndex() < m.this_0.get_size()
end function

function Anon_2bc0ea42_hasPrevious_k_() as Boolean
    return m.get_currentIndex() > 0
end function

function Anon_2bc0ea42_next_k_() as String
    if not m.hasNext_k_() then
        throw NoSuchElementException_create_k_()
    end if
...
function Anon_2bc0ea42_nextIndex_k_() as Integer
    return m.get_currentIndex()
end function

function Anon_2bc0ea42_previous_k_() as String
...
function Anon_2bc0ea42_previousIndex_k_() as Integer
    return m.get_currentIndex() - 1
end function

function Anon_2bc0ea42_get_currentIndex_k_() as Integer
    return m.currentIndex
end function

sub Anon_2bc0ea42_set_currentIndex_I_k_(value as Integer)
    m.currentIndex = value
end sub

function Anon_386251be_create_Anon_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_386251be"
    this.__proto = ["Anon_386251be", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.hasNext_k_ = Anon_386251be_hasNext_k_
    this.next_k_ = Anon_386251be_next_k_
    this.get_index = Anon_386251be_get_index_k_
    this.set_index = Anon_386251be_set_index_I_k_
    this.index = 0
    this.this_0 = this_0
    return this
end function

function Anon_386251be_hasNext_k_() as Boolean
    return m.get_index() < m.this_0.get_size()
end function

function Anon_386251be_next_k_() as String
    if not m.hasNext_k_() then
        throw NoSuchElementException_create_k_()
    end if
...
function Anon_386251be_get_index_k_() as Integer
    return m.index
end function

sub Anon_386251be_set_index_I_k_(value as Integer)
    m.index = value
end sub

function Anon_34de5821_create_I_Anon_k_(_index as Integer, this_0 as Object) as Object
    this = {}
    this.__type = "Anon_34de5821"
    this.__proto = ["Anon_34de5821", "ListIterator", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.hasNext_k_ = Anon_34de5821_hasNext_k_
    this.hasPrevious_k_ = Anon_34de5821_hasPrevious_k_
    this.next_k_ = Anon_34de5821_next_k_
    this.nextIndex_k_ = Anon_34de5821_nextIndex_k_
    this.previous_k_ = Anon_34de5821_previous_k_
    this.previousIndex_k_ = Anon_34de5821_previousIndex_k_
    this.get_currentIndex = Anon_34de5821_get_currentIndex_k_
    this.set_currentIndex = Anon_34de5821_set_currentIndex_I_k_
    this.currentIndex = _index
    this.this_0 = this_0
    return this
end function

function Anon_34de5821_hasNext_k_() as Boolean
    return m.get_currentIndex() < m.this_0.get_size()
end function

function Anon_34de5821_hasPrevious_k_() as Boolean
    return m.get_currentIndex() > 0
end function

function Anon_34de5821_next_k_() as String
    if not m.hasNext_k_() then
        throw NoSuchElementException_create_k_()
    end if
...
function Anon_34de5821_nextIndex_k_() as Integer
    return m.get_currentIndex()
end function

function Anon_34de5821_previous_k_() as String
    if not m.hasPrevious_k_() then
        throw NoSuchElementException_create_k_()
    end if
    return m.this_0.get_I_k_(m.get_currentIndex())
...
function Anon_34de5821_previousIndex_k_() as Integer
    return m.get_currentIndex() - 1
end function

function Anon_34de5821_get_currentIndex_k_() as Integer
    return m.currentIndex
end function

sub Anon_34de5821_set_currentIndex_I_k_(value as Integer)
    m.currentIndex = value
end sub

function Anon_5237ee14_create_Anon_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_5237ee14"
    this.__proto = ["Anon_5237ee14", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.hasNext_k_ = Anon_5237ee14_hasNext_k_
    this.next_k_ = Anon_5237ee14_next_k_
    this.get_index = Anon_5237ee14_get_index_k_
    this.set_index = Anon_5237ee14_set_index_I_k_
    this.index = 0
    this.this_0 = this_0
    return this
end function

function Anon_5237ee14_hasNext_k_() as Boolean
    return m.get_index() < m.this_0.get_size()
end function

function Anon_5237ee14_next_k_() as String
    if not m.hasNext_k_() then
        throw NoSuchElementException_create_k_()
    end if
...
function Anon_5237ee14_get_index_k_() as Integer
    return m.index
end function

sub Anon_5237ee14_set_index_I_k_(value as Integer)
    m.index = value
end sub

function Anon_75498945_create_I_Anon_k_(_index as Integer, this_0 as Object) as Object
    this = {}
    this.__type = "Anon_75498945"
    this.__proto = ["Anon_75498945", "ListIterator", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.hasNext_k_ = Anon_75498945_hasNext_k_
    this.hasPrevious_k_ = Anon_75498945_hasPrevious_k_
    this.next_k_ = Anon_75498945_next_k_
    this.nextIndex_k_ = Anon_75498945_nextIndex_k_
    this.previous_k_ = Anon_75498945_previous_k_
    this.previousIndex_k_ = Anon_75498945_previousIndex_k_
    this.get_currentIndex = Anon_75498945_get_currentIndex_k_
    this.set_currentIndex = Anon_75498945_set_currentIndex_I_k_
    this.currentIndex = _index
    this.this_0 = this_0
    return this
end function

function Anon_75498945_hasNext_k_() as Boolean
    return m.get_currentIndex() < m.this_0.get_size()
end function

function Anon_75498945_hasPrevious_k_() as Boolean
    return m.get_currentIndex() > 0
end function

function Anon_75498945_next_k_() as String
    if not m.hasNext_k_() then
        throw NoSuchElementException_create_k_()
    end if
...
function Anon_75498945_nextIndex_k_() as Integer
    return m.get_currentIndex()
end function

function Anon_75498945_previous_k_() as String
    if not m.hasPrevious_k_() then
        throw NoSuchElementException_create_k_()
    end if
    return m.this_0.get_I_k_(m.get_currentIndex())
...
function Anon_75498945_previousIndex_k_() as Integer
    return m.get_currentIndex() - 1
end function

function Anon_75498945_get_currentIndex_k_() as Integer
    return m.currentIndex
end function

sub Anon_75498945_set_currentIndex_I_k_(value as Integer)
    m.currentIndex = value
end sub

function Anon_64fe398f_create_I_Arr_I_k_(_nestedSubSize as Integer, _matchArray as Object, _actualFromIndex as Integer) as Object
    this = {}
    this.__type = "Anon_64fe398f"
    this.__proto = ["Anon_64fe398f", "List", "Collection", "Iterable"]
    this.__id = __kotlin_nextObjectId()
    this.get_I_k_ = Anon_64fe398f_get_I_k_
    this.indexOf_Str_k_ = Anon_64fe398f_indexOf_Str_k_
    this.lastIndexOf_Str_k_ = Anon_64fe398f_lastIndexOf_Str_k_
    this.isEmpty_k_ = Anon_64fe398f_isEmpty_k_
    this.contains_Str_k_ = Anon_64fe398f_contains_Str_k_
    this.containsAll_CollectionStr_k_ = Anon_64fe398f_containsAll_CollectionStr_k_
    this.iterator_k_ = Anon_64fe398f_iterator_k_
    this.listIterator_k_ = Anon_64fe398f_listIterator_k_
    this.listIterator_I_k_ = Anon_64fe398f_listIterator_I_k_
    this.subList_I_I_k_ = Anon_64fe398f_subList_I_I_k_
    this.get_size = Anon_64fe398f_get_size_k_
...
function Anon_64fe398f_get_I_k_(index as Integer) as String
...
function Anon_64fe398f_indexOf_Str_k_(element as String) as Integer
    progression = until_rI_I_k_(0, m.get_size())
    inductionVariable = progression.get_first()
    last = progression.get_last()
    if inductionVariable <= last then
...
function Anon_64fe398f_lastIndexOf_Str_k_(element as String) as Integer
...
function Anon_64fe398f_isEmpty_k_() as Boolean
    return m.get_size() = 0
end function

function Anon_64fe398f_contains_Str_k_(element as String) as Boolean
    return m.indexOf_Str_k_(element) >= 0
end function

function Anon_64fe398f_containsAll_CollectionStr_k_(elements as Object) as Boolean
...
function Anon_64fe398f_iterator_k_() as Object
    return Anon_5237ee14_create_Anon_k_(m)
end function

function Anon_64fe398f_listIterator_k_() as Object
    return m.listIterator_I_k_(0)
end function

function Anon_64fe398f_listIterator_I_k_(index as Integer) as Object
    if (index < 0) or (index > m.get_size()) then
        throw IndexOutOfBoundsException_create_k_()
    end if
    return Anon_75498945_create_I_Anon_k_(index, m)
end function

function Anon_64fe398f_subList_I_I_k_(fromIndex as Integer, toIndex as Integer) as Object
...
function Anon_64fe398f_get_size_k_() as Integer
    return m.size
end function

function Anon_34431fe1_create_I_Arr_I_k_(_subSize as Integer, _matchArray as Object, _outerFromIndex as Integer) as Object
    this = {}
    this.__type = "Anon_34431fe1"
    this.__proto = ["Anon_34431fe1", "List", "Collection", "Iterable"]
    this.__id = __kotlin_nextObjectId()
    this.get_I_k_ = Anon_34431fe1_get_I_k_
    this.indexOf_Str_k_ = Anon_34431fe1_indexOf_Str_k_
    this.lastIndexOf_Str_k_ = Anon_34431fe1_lastIndexOf_Str_k_
    this.isEmpty_k_ = Anon_34431fe1_isEmpty_k_
    this.contains_Str_k_ = Anon_34431fe1_contains_Str_k_
    this.containsAll_CollectionStr_k_ = Anon_34431fe1_containsAll_CollectionStr_k_
    this.iterator_k_ = Anon_34431fe1_iterator_k_
    this.listIterator_k_ = Anon_34431fe1_listIterator_k_
    this.listIterator_I_k_ = Anon_34431fe1_listIterator_I_k_
    this.subList_I_I_k_ = Anon_34431fe1_subList_I_I_k_
    this.get_size = Anon_34431fe1_get_size_k_
    this.size = _subSize
    this._matchArray = _matchArray
...
function Anon_34431fe1_get_I_k_(index as Integer) as String
    if (index < 0) or (index >= m.get_size()) then
        throw IndexOutOfBoundsException_create_k_()
    end if
...
function Anon_34431fe1_indexOf_Str_k_(element as String) as Integer
    progression = until_rI_I_k_(0, m.get_size())
    inductionVariable = progression.get_first()
    last = progression.get_last()
    if inductionVariable <= last then
...
function Anon_34431fe1_lastIndexOf_Str_k_(element as String) as Integer
    inductionVariable = m.get_size() - 1
    if 0 <= inductionVariable then
                i = inductionVariable
        inductionVariable = (inductionVariable + -1)
...
function Anon_34431fe1_isEmpty_k_() as Boolean
    return m.get_size() = 0
end function

function Anon_34431fe1_contains_Str_k_(element as String) as Boolean
    return m.indexOf_Str_k_(element) >= 0
end function

function Anon_34431fe1_containsAll_CollectionStr_k_(elements as Object) as Boolean
...
function Anon_34431fe1_iterator_k_() as Object
    return Anon_386251be_create_Anon_k_(m)
end function

function Anon_34431fe1_listIterator_k_() as Object
    return m.listIterator_I_k_(0)
end function

function Anon_34431fe1_listIterator_I_k_(index as Integer) as Object
    if (index < 0) or (index > m.get_size()) then
        throw IndexOutOfBoundsException_create_k_()
    end if
    return Anon_34de5821_create_I_Anon_k_(index, m)
end function

function Anon_34431fe1_subList_I_I_k_(fromIndex as Integer, toIndex as Integer) as Object
    if ((fromIndex < 0) or (toIndex > m.get_size())) or (fromIndex > toIndex) then
        throw IndexOutOfBoundsException_create_k_()
    end if
    ...
    return Anon_64fe398f_create_I_Arr_I_k_(nestedSubSize, m._matchArray, actualFromIndex)
end function

function Anon_34431fe1_get_size_k_() as Integer
    return m.size
end function

function Anon_7558c84d_create_Arr_k_(_matchArray as Object) as Object
    this = {}
    this.__type = "Anon_7558c84d"
    this.__proto = ["Anon_7558c84d", "List", "Collection", "Iterable"]
    this.__id = __kotlin_nextObjectId()
    this.get_I_k_ = Anon_7558c84d_get_I_k_
    this.indexOf_Str_k_ = Anon_7558c84d_indexOf_Str_k_
    this.lastIndexOf_Str_k_ = Anon_7558c84d_lastIndexOf_Str_k_
    this.isEmpty_k_ = Anon_7558c84d_isEmpty_k_
    this.contains_Str_k_ = Anon_7558c84d_contains_Str_k_
    this.containsAll_CollectionStr_k_ = Anon_7558c84d_containsAll_CollectionStr_k_
    this.iterator_k_ = Anon_7558c84d_iterator_k_
    this.listIterator_k_ = Anon_7558c84d_listIterator_k_
    this.listIterator_I_k_ = Anon_7558c84d_listIterator_I_k_
    this.subList_I_I_k_ = Anon_7558c84d_subList_I_I_k_
    this.get_size = Anon_7558c84d_get_size_k_
    this._matchArray = _matchArray
    return this
end function

function Anon_7558c84d_get_I_k_(index as Integer) as String
...
function Anon_7558c84d_indexOf_Str_k_(element as String) as Integer
    progression = until_rI_I_k_(0, m.get_size())
    inductionVariable = progression.get_first()
    last = progression.get_last()
    if inductionVariable <= last then
...
function Anon_7558c84d_lastIndexOf_Str_k_(element as String) as Integer
    inductionVariable = m.get_size() - 1
    if 0 <= inductionVariable then
                i = inductionVariable
        inductionVariable = (inductionVariable + -1)
...
function Anon_7558c84d_isEmpty_k_() as Boolean
    return m.get_size() = 0
end function

function Anon_7558c84d_contains_Str_k_(element as String) as Boolean
    return m.indexOf_Str_k_(element) >= 0
end function

function Anon_7558c84d_containsAll_CollectionStr_k_(elements as Object) as Boolean
...
function Anon_7558c84d_iterator_k_() as Object
    return Anon_5c0f5789_create_Anon_k_(m)
end function

function Anon_7558c84d_listIterator_k_() as Object
    return m.listIterator_I_k_(0)
end function

function Anon_7558c84d_listIterator_I_k_(index as Integer) as Object
    if (index < 0) or (index > m.get_size()) then
        throw IndexOutOfBoundsException_create_k_()
    end if
    return Anon_2bc0ea42_create_I_Anon_k_(index, m)
end function

function Anon_7558c84d_subList_I_I_k_(fromIndex as Integer, toIndex as Integer) as Object
    if ((fromIndex < 0) or (toIndex > m.get_size())) or (fromIndex > toIndex) then
        throw IndexOutOfBoundsException_create_k_()
    end if
    outerFromIndex = fromIndex
    subSize = toIndex - fromIndex
    return Anon_34431fe1_create_I_Arr_I_k_(subSize, m._matchArray, outerFromIndex)
end function

function Anon_7558c84d_get_size_k_() as Integer
    return m._matchArray.count()
end function

function Anon_6a68159e_create_I_Arr_Str_Regex_k_(_matchIndex as Integer, _matchArray as Object, _input as String, this_0 as Object) as Object
    this = {}
    this.__type = "Anon_6a68159e"
    this.__proto = ["Anon_6a68159e", "MatchResult"]
    this.__id = __kotlin_nextObjectId()
    this.next_k_ = Anon_6a68159e_next_k_
    this.get_range = Anon_6a68159e_get_range_k_
    this.get_value = Anon_6a68159e_get_value_k_
    this.get_groups = Anon_6a68159e_get_groups_k_
    this.get_groupValues_ = Anon_6a68159e_get_groupValues__k_
    this.set_groupValues_ = Anon_6a68159e_set_groupValues__ListStrN_k_
    this.get_groupValues = Anon_6a68159e_get_groupValues_k_
    this.range = until_rI_I_k_(_matchIndex, _matchIndex + Len(_matchArray[0]))
    this.value = _matchArray[0]
    this.groups = Anon_36689eca_create_Arr_k_(_matchArray)
...
function Anon_6a68159e_next_k_() as Dynamic
    __when_tmp3 = invalid
...
function Anon_6a68159e_get_range_k_() as Object
    return m.range
end function

function Anon_6a68159e_get_value_k_() as String
    return m.value
end function

function Anon_6a68159e_get_groups_k_() as Object
    return m.groups
end function

function Anon_6a68159e_get_groupValues__k_() as Dynamic
    return m.groupValues_
end function

sub Anon_6a68159e_set_groupValues__ListStrN_k_(value as Dynamic)
    m.groupValues_ = value
end sub

function Anon_6a68159e_get_groupValues_k_() as Object
    if m.get_groupValues_() = invalid then
        m.set_groupValues_(Anon_7558c84d_create_Arr_k_(m._matchArray))
    end if
