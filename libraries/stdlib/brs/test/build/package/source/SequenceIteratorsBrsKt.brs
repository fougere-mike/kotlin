...
function TransformingSequence_iterator_k_() as Object
    return Anon_21d00c80_create_TransformingSequence_k_(m)
end function
...
function TransformingIndexedSequence_iterator_k_() as Object
    return Anon_e0b55ef_create_TransformingIndexedSequence_k_(m)
end function
...
function FilteringSequence_iterator_k_() as Object
    return Anon_34389c01_create_FilteringSequence_k_(m)
end function
...
function FilteringIndexedSequence_iterator_k_() as Object
    return Anon_9ea0ce9_create_FilteringIndexedSequence_k_(m)
end function
...
function FlatteningSequence_iterator_k_() as Object
    return Anon_7c9a60a7_create_FlatteningSequence_k_(m)
end function
...
function TakingSequence_iterator_k_() as Object
    return Anon_13aa55c8_create_TakingSequence_k_(m)
end function
...
function TakingWhileSequence_iterator_k_() as Object
    return Anon_3a432c9c_create_TakingWhileSequence_k_(m)
end function
...
function DroppingSequence_iterator_k_() as Object
    return Anon_21bef933_create_DroppingSequence_k_(m)
end function
...
function DroppingWhileSequence_iterator_k_() as Object
    return Anon_57fe4f23_create_DroppingWhileSequence_k_(m)
end function
...
function SubSequence_iterator_k_() as Object
    return Anon_5c6215f1_create_SubSequence_k_(m)
end function
...
function DistinctSequence_iterator_k_() as Object
    return Anon_52cbf342_create_DistinctSequence_k_(m)
end function
...
function MergingSequence_iterator_k_() as Object
    return Anon_6ee36431_create_MergingSequence_k_(m)
end function
...
function Anon_21d00c80_create_TransformingSequence_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_21d00c80"
    this.__proto = ["Anon_21d00c80", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.next_k_ = Anon_21d00c80_next_k_
    this.hasNext_k_ = Anon_21d00c80_hasNext_k_
    this.get_iterator = Anon_21d00c80_get_iterator_k_
    this.iterator = this_0.get_sequence().iterator_k_()
    this.this_0 = this_0
    return this
end function

function Anon_21d00c80_next_k_() as Dynamic
    return m.this_0.get_transformer().invoke(m.get_iterator().next_k_())
end function

function Anon_21d00c80_hasNext_k_() as Boolean
    return m.get_iterator().hasNext_k_()
end function

function Anon_21d00c80_get_iterator_k_() as Object
    return m.iterator
end function

function Anon_e0b55ef_create_TransformingIndexedSequence_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_e0b55ef"
    this.__proto = ["Anon_e0b55ef", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.next_k_ = Anon_e0b55ef_next_k_
    this.hasNext_k_ = Anon_e0b55ef_hasNext_k_
    this.get_iterator = Anon_e0b55ef_get_iterator_k_
    this.get_index = Anon_e0b55ef_get_index_k_
    this.set_index = Anon_e0b55ef_set_index_I_k_
    this.iterator = this_0.get_sequence().iterator_k_()
    this.index = 0
    this.this_0 = this_0
    return this
...
function Anon_e0b55ef_next_k_() as Dynamic
...
function Anon_e0b55ef_hasNext_k_() as Boolean
    return m.get_iterator().hasNext_k_()
end function

function Anon_e0b55ef_get_iterator_k_() as Object
    return m.iterator
end function

function Anon_e0b55ef_get_index_k_() as Integer
    return m.index
end function

sub Anon_e0b55ef_set_index_I_k_(value as Integer)
    m.index = value
end sub

function Anon_34389c01_create_FilteringSequence_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_34389c01"
    this.__proto = ["Anon_34389c01", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.calcNext_k_ = Anon_34389c01_calcNext_k_
    this.next_k_ = Anon_34389c01_next_k_
    this.hasNext_k_ = Anon_34389c01_hasNext_k_
    this.get_iterator = Anon_34389c01_get_iterator_k_
    this.get_nextState = Anon_34389c01_get_nextState_k_
    this.set_nextState = Anon_34389c01_set_nextState_I_k_
    this.get_nextItem = Anon_34389c01_get_nextItem_k_
    this.set_nextItem = Anon_34389c01_set_nextItem_AnyN_k_
    this.iterator = this_0.get_sequence().iterator_k_()
    this.nextState = -1
...
function Anon_34389c01_next_k_() as Dynamic
...
function Anon_34389c01_hasNext_k_() as Boolean
    if m.get_nextState() = -1 then
        m.calcNext_k_()
    end if
...
function Anon_34389c01_get_iterator_k_() as Object
    return m.iterator
end function

function Anon_34389c01_get_nextState_k_() as Integer
    return m.nextState
end function

sub Anon_34389c01_set_nextState_I_k_(value as Integer)
    m.nextState = value
end sub

function Anon_34389c01_get_nextItem_k_() as Dynamic
    return m.nextItem
end function

sub Anon_34389c01_set_nextItem_AnyN_k_(value as Dynamic)
    m.nextItem = value
end sub

function Anon_9ea0ce9_create_FilteringIndexedSequence_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_9ea0ce9"
    this.__proto = ["Anon_9ea0ce9", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.calcNext_k_ = Anon_9ea0ce9_calcNext_k_
    this.next_k_ = Anon_9ea0ce9_next_k_
    this.hasNext_k_ = Anon_9ea0ce9_hasNext_k_
    this.get_iterator = Anon_9ea0ce9_get_iterator_k_
    this.get_index = Anon_9ea0ce9_get_index_k_
    this.set_index = Anon_9ea0ce9_set_index_I_k_
    this.get_nextState = Anon_9ea0ce9_get_nextState_k_
    this.set_nextState = Anon_9ea0ce9_set_nextState_I_k_
    this.get_nextItem = Anon_9ea0ce9_get_nextItem_k_
    this.set_nextItem = Anon_9ea0ce9_set_nextItem_AnyN_k_
    this.iterator = this_0.get_sequence().iterator_k_()
    this.index = 0
    this.nextState = -1
    this.nextItem = invalid
...
function Anon_9ea0ce9_next_k_() as Dynamic
    if m.get_nextState() = -1 then
        m.calcNext_k_()
    end if
    if m.get_nextState() = 0 then
...
function Anon_9ea0ce9_hasNext_k_() as Boolean
    if m.get_nextState() = -1 then
        m.calcNext_k_()
    end if
    return m.get_nextState() = 1
...
function Anon_9ea0ce9_get_iterator_k_() as Object
    return m.iterator
end function

function Anon_9ea0ce9_get_index_k_() as Integer
    return m.index
end function

sub Anon_9ea0ce9_set_index_I_k_(value as Integer)
    m.index = value
end sub

function Anon_9ea0ce9_get_nextState_k_() as Integer
    return m.nextState
end function

sub Anon_9ea0ce9_set_nextState_I_k_(value as Integer)
    m.nextState = value
end sub

function Anon_9ea0ce9_get_nextItem_k_() as Dynamic
    return m.nextItem
end function

sub Anon_9ea0ce9_set_nextItem_AnyN_k_(value as Dynamic)
    m.nextItem = value
end sub

function Anon_7c9a60a7_create_FlatteningSequence_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_7c9a60a7"
    this.__proto = ["Anon_7c9a60a7", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.next_k_ = Anon_7c9a60a7_next_k_
    this.hasNext_k_ = Anon_7c9a60a7_hasNext_k_
    this.ensureItemIterator_k_ = Anon_7c9a60a7_ensureItemIterator_k_
    this.get_iterator = Anon_7c9a60a7_get_iterator_k_
    this.get_itemIterator = Anon_7c9a60a7_get_itemIterator_k_
    this.set_itemIterator = Anon_7c9a60a7_set_itemIterator_IteratorN_k_
    this.iterator = this_0.get_sequence().iterator_k_()
...
function Anon_7c9a60a7_next_k_() as Dynamic
...
function Anon_7c9a60a7_hasNext_k_() as Boolean
    return m.ensureItemIterator_k_()
end function

function Anon_7c9a60a7_ensureItemIterator_k_() as Boolean
...
function Anon_7c9a60a7_get_iterator_k_() as Object
    return m.iterator
end function

function Anon_7c9a60a7_get_itemIterator_k_() as Dynamic
    return m.itemIterator
end function

sub Anon_7c9a60a7_set_itemIterator_IteratorN_k_(value as Dynamic)
    m.itemIterator = value
end sub

function Anon_13aa55c8_create_TakingSequence_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_13aa55c8"
    this.__proto = ["Anon_13aa55c8", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.next_k_ = Anon_13aa55c8_next_k_
    this.hasNext_k_ = Anon_13aa55c8_hasNext_k_
    this.get_left = Anon_13aa55c8_get_left_k_
    this.set_left = Anon_13aa55c8_set_left_I_k_
    this.get_iterator = Anon_13aa55c8_get_iterator_k_
    this.left = this_0.get_count()
    this.iterator = this_0.get_sequence().iterator_k_()
    return this
end function

function Anon_13aa55c8_next_k_() as Dynamic
...
function Anon_13aa55c8_hasNext_k_() as Boolean
    return (m.get_left() > 0) and m.get_iterator().hasNext_k_()
end function

function Anon_13aa55c8_get_left_k_() as Integer
    return m.left
end function

sub Anon_13aa55c8_set_left_I_k_(value as Integer)
    m.left = value
end sub

function Anon_13aa55c8_get_iterator_k_() as Object
    return m.iterator
end function

function Anon_3a432c9c_create_TakingWhileSequence_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_3a432c9c"
    this.__proto = ["Anon_3a432c9c", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.calcNext_k_ = Anon_3a432c9c_calcNext_k_
    this.next_k_ = Anon_3a432c9c_next_k_
    this.hasNext_k_ = Anon_3a432c9c_hasNext_k_
    this.get_iterator = Anon_3a432c9c_get_iterator_k_
    this.get_nextState = Anon_3a432c9c_get_nextState_k_
    this.set_nextState = Anon_3a432c9c_set_nextState_I_k_
    this.get_nextItem = Anon_3a432c9c_get_nextItem_k_
    this.set_nextItem = Anon_3a432c9c_set_nextItem_AnyN_k_
    this.iterator = this_0.get_sequence().iterator_k_()
    this.nextState = -1
    this.nextItem = invalid
    this.this_0 = this_0
...
function Anon_3a432c9c_next_k_() as Dynamic
    if m.get_nextState() = -1 then
        m.calcNext_k_()
    end if
    if m.get_nextState() = 0 then
...
function Anon_3a432c9c_hasNext_k_() as Boolean
    if m.get_nextState() = -1 then
        m.calcNext_k_()
    end if
    return m.get_nextState() = 1
...
function Anon_3a432c9c_get_iterator_k_() as Object
    return m.iterator
end function

function Anon_3a432c9c_get_nextState_k_() as Integer
    return m.nextState
end function

sub Anon_3a432c9c_set_nextState_I_k_(value as Integer)
    m.nextState = value
end sub

function Anon_3a432c9c_get_nextItem_k_() as Dynamic
    return m.nextItem
end function

sub Anon_3a432c9c_set_nextItem_AnyN_k_(value as Dynamic)
    m.nextItem = value
end sub

function Anon_21bef933_create_DroppingSequence_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_21bef933"
    this.__proto = ["Anon_21bef933", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.drop_k_ = Anon_21bef933_drop_k_
    this.next_k_ = Anon_21bef933_next_k_
    this.hasNext_k_ = Anon_21bef933_hasNext_k_
    this.get_iterator = Anon_21bef933_get_iterator_k_
    this.get_left = Anon_21bef933_get_left_k_
    this.set_left = Anon_21bef933_set_left_I_k_
    this.iterator = this_0.get_sequence().iterator_k_()
    this.left = this_0.get_count()
    return this
end function

sub Anon_21bef933_drop_k_()
...
function Anon_21bef933_next_k_() as Dynamic
    m.drop_k_()
    return m.get_iterator().next_k_()
end function

function Anon_21bef933_hasNext_k_() as Boolean
    m.drop_k_()
    return m.get_iterator().hasNext_k_()
end function

function Anon_21bef933_get_iterator_k_() as Object
    return m.iterator
end function

function Anon_21bef933_get_left_k_() as Integer
    return m.left
end function

sub Anon_21bef933_set_left_I_k_(value as Integer)
    m.left = value
end sub

function Anon_57fe4f23_create_DroppingWhileSequence_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_57fe4f23"
    this.__proto = ["Anon_57fe4f23", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.drop_k_ = Anon_57fe4f23_drop_k_
    this.next_k_ = Anon_57fe4f23_next_k_
    this.hasNext_k_ = Anon_57fe4f23_hasNext_k_
    this.get_iterator = Anon_57fe4f23_get_iterator_k_
    this.get_dropState = Anon_57fe4f23_get_dropState_k_
    this.set_dropState = Anon_57fe4f23_set_dropState_I_k_
    this.get_nextItem = Anon_57fe4f23_get_nextItem_k_
    this.set_nextItem = Anon_57fe4f23_set_nextItem_AnyN_k_
    this.iterator = this_0.get_sequence().iterator_k_()
    this.dropState = -1
    this.nextItem = invalid
    this.this_0 = this_0
...
function Anon_57fe4f23_next_k_() as Dynamic
...
function Anon_57fe4f23_hasNext_k_() as Boolean
    if m.get_dropState() = -1 then
        m.drop_k_()
    end if
...
function Anon_57fe4f23_get_iterator_k_() as Object
    return m.iterator
end function

function Anon_57fe4f23_get_dropState_k_() as Integer
    return m.dropState
end function

sub Anon_57fe4f23_set_dropState_I_k_(value as Integer)
    m.dropState = value
end sub

function Anon_57fe4f23_get_nextItem_k_() as Dynamic
    return m.nextItem
end function

sub Anon_57fe4f23_set_nextItem_AnyN_k_(value as Dynamic)
    m.nextItem = value
end sub

function Anon_5c6215f1_create_SubSequence_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_5c6215f1"
    this.__proto = ["Anon_5c6215f1", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.drop_k_ = Anon_5c6215f1_drop_k_
    this.hasNext_k_ = Anon_5c6215f1_hasNext_k_
    this.next_k_ = Anon_5c6215f1_next_k_
    this.get_iterator = Anon_5c6215f1_get_iterator_k_
    this.get_position = Anon_5c6215f1_get_position_k_
    this.set_position = Anon_5c6215f1_set_position_I_k_
    this.iterator = this_0.get_sequence().iterator_k_()
    this.position = 0
    this.this_0 = this_0
    return this
...
function Anon_5c6215f1_hasNext_k_() as Boolean
    m.drop_k_()
    return (m.get_position() < m.this_0.get_endIndex()) and m.get_iterator().hasNext_k_()
end function

function Anon_5c6215f1_next_k_() as Dynamic
    m.drop_k_()
...
function Anon_5c6215f1_get_iterator_k_() as Object
    return m.iterator
end function

function Anon_5c6215f1_get_position_k_() as Integer
    return m.position
end function

sub Anon_5c6215f1_set_position_I_k_(value as Integer)
    m.position = value
end sub

function Anon_52cbf342_create_DistinctSequence_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_52cbf342"
    this.__proto = ["Anon_52cbf342", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.calcNext_k_ = Anon_52cbf342_calcNext_k_
    this.hasNext_k_ = Anon_52cbf342_hasNext_k_
    this.next_k_ = Anon_52cbf342_next_k_
    this.get_sourceIterator = Anon_52cbf342_get_sourceIterator_k_
    this.get_observed = Anon_52cbf342_get_observed_k_
    this.get_nextValue = Anon_52cbf342_get_nextValue_k_
    this.set_nextValue = Anon_52cbf342_set_nextValue_AnyN_k_
    this.get_nextState = Anon_52cbf342_get_nextState_k_
    this.set_nextState = Anon_52cbf342_set_nextState_I_k_
...
function Anon_52cbf342_hasNext_k_() as Boolean
    if m.get_nextState() = -1 then
        m.calcNext_k_()
    end if
    return m.get_nextState() = 1
...
function Anon_52cbf342_next_k_() as Dynamic
    if m.get_nextState() = -1 then
        m.calcNext_k_()
    end if
    if m.get_nextState() = 0 then
...
function Anon_52cbf342_get_sourceIterator_k_() as Object
    return m.sourceIterator
end function

function Anon_52cbf342_get_observed_k_() as Object
    return m.observed
end function

function Anon_52cbf342_get_nextValue_k_() as Dynamic
    return m.nextValue
end function

sub Anon_52cbf342_set_nextValue_AnyN_k_(value as Dynamic)
    m.nextValue = value
end sub

function Anon_52cbf342_get_nextState_k_() as Integer
    return m.nextState
end function

sub Anon_52cbf342_set_nextState_I_k_(value as Integer)
    m.nextState = value
end sub

function Anon_6ee36431_create_MergingSequence_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_6ee36431"
    this.__proto = ["Anon_6ee36431", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.hasNext_k_ = Anon_6ee36431_hasNext_k_
    this.next_k_ = Anon_6ee36431_next_k_
    this.get_iterator1 = Anon_6ee36431_get_iterator1_k_
    this.get_iterator2 = Anon_6ee36431_get_iterator2_k_
...
function Anon_6ee36431_hasNext_k_() as Boolean
    return m.get_iterator1().hasNext_k_() and m.get_iterator2().hasNext_k_()
end function

function Anon_6ee36431_next_k_() as Dynamic
    return m.this_0.get_transform().invoke(m.get_iterator1().next_k_(), m.get_iterator2().next_k_())
end function

function Anon_6ee36431_get_iterator1_k_() as Object
    return m.iterator1
end function

function Anon_6ee36431_get_iterator2_k_() as Object
    return m.iterator2
end function
