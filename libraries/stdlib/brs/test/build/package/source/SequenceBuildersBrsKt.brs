...
function sequenceOf_AnyN_k_(element as Dynamic) as Object
    return Anon_e991ee5_create_AnyN_k_(element)
end function
...
function sequenceOf_Iterator_k_(iterator as Object) as Object
    return Anon_510c1120_create_Iterator_k_(iterator)
end function
...
function Sequence_Function0Iterator_k_(iterator as Object) as Object
    return Anon_7478e3d2_create_Function0Iterator_k_(iterator)
end function
...
function GeneratorSequence_iterator_k_() as Object
    return Anon_5c9b954c_create_GeneratorSequence_k_(m)
end function
...
function Anon_21504dc_create_AnyN_k_(_element as Dynamic) as Object
    this = {}
    this.__type = "Anon_21504dc"
    this.__proto = ["Anon_21504dc", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.hasNext_k_ = Anon_21504dc_hasNext_k_
    this.next_k_ = Anon_21504dc_next_k_
    this.get_hasNext = Anon_21504dc_get_hasNext_k_
    this.set_hasNext = Anon_21504dc_set_hasNext_Z_k_
    this.hasNext = true
    this._element = _element
    return this
end function

function Anon_21504dc_hasNext_k_() as Boolean
    return m.get_hasNext()
end function

function Anon_21504dc_next_k_() as Dynamic
...
function Anon_21504dc_get_hasNext_k_() as Boolean
    return m.hasNext
end function

sub Anon_21504dc_set_hasNext_Z_k_(value as Boolean)
    m.hasNext = value
end sub

function Anon_e991ee5_create_AnyN_k_(_element as Dynamic) as Object
    this = {}
    this.__type = "Anon_e991ee5"
    this.__proto = ["Anon_e991ee5", "Sequence"]
    this.__id = __kotlin_nextObjectId()
    this.iterator_k_ = Anon_e991ee5_iterator_k_
    this._element = _element
    return this
end function

function Anon_e991ee5_iterator_k_() as Object
    return Anon_21504dc_create_AnyN_k_(m._element)
end function

function Anon_510c1120_create_Iterator_k_(_iterator as Object) as Object
    this = {}
    this.__type = "Anon_510c1120"
    this.__proto = ["Anon_510c1120", "Sequence"]
    this.__id = __kotlin_nextObjectId()
    this.iterator_k_ = Anon_510c1120_iterator_k_
    this._iterator = _iterator
    return this
end function

function Anon_510c1120_iterator_k_() as Object
    return m._iterator
end function

function Anon_7478e3d2_create_Function0Iterator_k_(_iterator as Object) as Object
    this = {}
    this.__type = "Anon_7478e3d2"
    this.__proto = ["Anon_7478e3d2", "Sequence"]
    this.__id = __kotlin_nextObjectId()
    this.iterator_k_ = Anon_7478e3d2_iterator_k_
    this._iterator = _iterator
    return this
end function

function Anon_7478e3d2_iterator_k_() as Object
    return m._iterator.invoke()
end function

function Anon_5c9b954c_create_GeneratorSequence_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_5c9b954c"
    this.__proto = ["Anon_5c9b954c", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.calcNext_k_ = Anon_5c9b954c_calcNext_k_
    this.hasNext_k_ = Anon_5c9b954c_hasNext_k_
    this.next_k_ = Anon_5c9b954c_next_k_
    this.get_nextItem = Anon_5c9b954c_get_nextItem_k_
    this.set_nextItem = Anon_5c9b954c_set_nextItem_AnyN_k_
    this.get_nextState = Anon_5c9b954c_get_nextState_k_
    this.set_nextState = Anon_5c9b954c_set_nextState_I_k_
...
function Anon_5c9b954c_hasNext_k_() as Boolean
...
function Anon_5c9b954c_next_k_() as Object
    if m.get_nextState() < 0 then
        m.calcNext_k_()
    end if
    if m.get_nextState() = 0 then
...
function Anon_5c9b954c_get_nextItem_k_() as Dynamic
    return m.nextItem
end function

sub Anon_5c9b954c_set_nextItem_AnyN_k_(value as Dynamic)
    m.nextItem = value
end sub

function Anon_5c9b954c_get_nextState_k_() as Integer
    return m.nextState
end function

sub Anon_5c9b954c_set_nextState_I_k_(value as Integer)
    m.nextState = value
end sub
