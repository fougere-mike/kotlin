...
function compareBy_Function1AnyNComparableStarN_ComparatorAnyN_k_(selector as Function) as Object
...
function compareByDescending_Function1AnyNComparableStarN_ComparatorAnyN_k_(selector as Function) as Object
    return {selector: selector, invoke: function(a as Dynamic, b as Dynamic) as Integer
        return compareValuesBy_AnyN_AnyN_Function1AnyNComparableStarN_I_k_(b, a, m.selector)
    end function}
end function

function compareValuesBy_AnyN_AnyN_Function1AnyNComparableStarN_I_k_(a as Dynamic, b as Dynamic, selector as Function) as Integer
...
function reversed_rComparatorAnyN_ComparatorAnyN_k_(m as Object) as Object
    return {this: this, invoke: function(a as Dynamic, b as Dynamic) as Integer
        return m.this.compare(b, a)
    end function}
end function
...
function NaturalOrderComparator_getInstance() as Object
    if m.NaturalOrderComparator_instance = invalid then
        m.NaturalOrderComparator_instance = NaturalOrderComparator_create()
    end if
...
function ReverseOrderComparator_getInstance() as Object
    if m.ReverseOrderComparator_instance = invalid then
        m.ReverseOrderComparator_instance = ReverseOrderComparator_create()
    end if
