...
function sorted_rSequence_k_(m as Object) as Object
    return Anon_7f25741f_create_Sequence_k_(m)
end function

function sortedWith_rSequence_Comparator_k_(m as Object, comparator as Object) as Object
    return Anon_2769cd84_create_Sequence_Comparator_k_(m, comparator)
end function
...
function ifEmpty_rSequence_Function0Sequence_k_(m as Object, defaultValue as Object) as Object
    return Anon_56fbefae_create_Sequence_Function0Sequence_k_(m, defaultValue)
end function

function Anon_7f25741f_create_Sequence_k_(_this_sorted as Object) as Object
    this = {}
    this.__type = "Anon_7f25741f"
    this.__proto = ["Anon_7f25741f", "Sequence"]
    this.__id = __kotlin_nextObjectId()
    this.iterator_k_ = Anon_7f25741f_iterator_k_
    this._this_sorted = _this_sorted
    return this
end function

function Anon_7f25741f_iterator_k_() as Object
    sortedList = toMutableList_rSequence_k_(m._this_sorted)
    sort_rMutableList_k_(sortedList)
    return sortedList.iterator_k_()
end function

function Anon_2769cd84_create_Sequence_Comparator_k_(_this_sortedWith as Object, _comparator as Object) as Object
    this = {}
    this.__type = "Anon_2769cd84"
    this.__proto = ["Anon_2769cd84", "Sequence"]
    this.__id = __kotlin_nextObjectId()
    this.iterator_k_ = Anon_2769cd84_iterator_k_
    this._this_sortedWith = _this_sortedWith
    this._comparator = _comparator
    return this
end function

function Anon_2769cd84_iterator_k_() as Object
    sortedList = toMutableList_rSequence_k_(m._this_sortedWith)
    sortWith_rMutableList_Comparator_k_(sortedList, m._comparator)
    return sortedList.iterator_k_()
end function

function Anon_56fbefae_create_Sequence_Function0Sequence_k_(_this_ifEmpty as Object, _defaultValue as Object) as Object
    this = {}
    this.__type = "Anon_56fbefae"
    this.__proto = ["Anon_56fbefae", "Sequence"]
    this.__id = __kotlin_nextObjectId()
    this.iterator_k_ = Anon_56fbefae_iterator_k_
    this._this_ifEmpty = _this_ifEmpty
    this._defaultValue = _defaultValue
    return this
end function

function Anon_56fbefae_iterator_k_() as Object
