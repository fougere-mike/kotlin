...
function sorted_rSequence_k_(m as Object) as Object
    return Anon_4545b652_create_Sequence_k_(m)
end function

function sortedWith_rSequence_Comparator_k_(m as Object, comparator as Object) as Object
    return Anon_7e6699cc_create_Sequence_Comparator_k_(m, comparator)
end function
...
function ifEmpty_rSequence_Function0Sequence_k_(m as Object, defaultValue as Object) as Object
    return Anon_44d06edc_create_Sequence_Function0Sequence_k_(m, defaultValue)
end function

function Anon_4545b652_create_Sequence_k_(_this_sorted as Object) as Object
    this = {}
    this.__type = "Anon_4545b652"
    this.__proto = ["Anon_4545b652", "Sequence"]
    this.__id = __kotlin_nextObjectId()
    this.iterator_k_ = Anon_4545b652_iterator_k_
    this._this_sorted = _this_sorted
    return this
end function

function Anon_4545b652_iterator_k_() as Object
    sortedList = toMutableList_rSequence_k_(m._this_sorted)
    sort_rMutableList_k_(sortedList)
    return sortedList.iterator_k_()
end function

function Anon_7e6699cc_create_Sequence_Comparator_k_(_this_sortedWith as Object, _comparator as Object) as Object
    this = {}
    this.__type = "Anon_7e6699cc"
    this.__proto = ["Anon_7e6699cc", "Sequence"]
    this.__id = __kotlin_nextObjectId()
    this.iterator_k_ = Anon_7e6699cc_iterator_k_
    this._this_sortedWith = _this_sortedWith
    this._comparator = _comparator
    return this
end function

function Anon_7e6699cc_iterator_k_() as Object
    sortedList = toMutableList_rSequence_k_(m._this_sortedWith)
    sortWith_rMutableList_Comparator_k_(sortedList, m._comparator)
    return sortedList.iterator_k_()
end function

function Anon_44d06edc_create_Sequence_Function0Sequence_k_(_this_ifEmpty as Object, _defaultValue as Object) as Object
    this = {}
    this.__type = "Anon_44d06edc"
    this.__proto = ["Anon_44d06edc", "Sequence"]
    this.__id = __kotlin_nextObjectId()
    this.iterator_k_ = Anon_44d06edc_iterator_k_
    this._this_ifEmpty = _this_ifEmpty
    this._defaultValue = _defaultValue
    return this
end function

function Anon_44d06edc_iterator_k_() as Object
