...
function KeyboardType_create_k_(__name as String, __ordinal as Integer) as Object
    ...
    this.__id = __kotlin_nextObjectId()
    this.values_k_ = KeyboardType_values_k_
    this.valueOf_Str_k_ = KeyboardType_valueOf_Str_k_
    this.get_entries = KeyboardType_get_entries_k_
    return this
end function

sub KeyboardType_initEntries()
    if m.KeyboardType_entriesInitialized then
        return
    end if
