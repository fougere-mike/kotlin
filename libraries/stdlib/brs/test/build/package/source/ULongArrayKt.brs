function ULongArray_create_LongArray_k_(storage as Object) as Object
    ...
    this.contains_AnyN_k_ = ULongArray_contains_AnyN_k_
    this.containsAll_Collection_k_ = ULongArray_containsAll_Collection_k_
    ...
    this.__get_storage = ULongArray___get_storage_k_
    this.__get_size = ULongArray___get_size_k_
...
function ULongArray_get_I_k_(index as Integer) as Object
    return toULong_rJ_k_(m.__get_storage().get_I_k_(index))
end function
...
sub ULongArray_set_I_ULong_k_(index as Integer, value as Object)
    ...
    m.__get_storage().set_I_J_k_(index, tmp_ret_0)

end sub

function ULongArray_iterator_k_() as Object
    return ULongArray_Iterator_create_LongArray_k_(m.__get_storage())
end function

function ULongArray_contains_AnyN_k_(element as Object) as Boolean
    tmp0 = element
    target = tmp_ret_0
...
function ULongArray_containsAll_Collection_k_(elements as Object) as Boolean
...
function ULongArray_hashCode_k_() as Integer
    ...
    if inductionVariable <= last then
        ...
        element = m.__get_storage().get_I_k_(i)
        result = ((31 * result) + ((element or __kotlin_ushr(element, 32)) and not (element and __kotlin_ushr(element, 32))))
...
function ULongArray_toString_k_() as String
    ...
    if inductionVariable <= last then
        ...
        sb.append_StrN_k_(toULong_rJ_k_(m.__get_storage().get_I_k_(i)).toString())
...
function ULongArray___get_storage_k_() as Object
    return m.storage
end function

function ULongArray___get_size_k_() as Integer
...
function ULongArray_Iterator_create_LongArray_k_(array as Object) as Object
    ...
    this.__get_array = ULongArray_Iterator___get_array_k_
    this.__get_index = ULongArray_Iterator___get_index_k_
    this.__set_index = ULongArray_Iterator___set_index_I_k_
    this.array = array
    this.index = 0
    return this
end function
...
function ULongArray_Iterator_next_k_() as Object
    ...
    if m.__get_index() < m.__get_array().__get_size() then
        __incr_tmp_103 = m.__get_index()
        m.__set_index(__incr_tmp_103 + 1)
        __when_tmp0 = toULong_rJ_k_(m.__get_array().get_I_k_(__incr_tmp_103))
    else if true then
...
function ULongArray_Iterator___get_array_k_() as Object
    return m.array
end function

function ULongArray_Iterator___get_index_k_() as Integer
    return m.index
end function

sub ULongArray_Iterator___set_index_I_k_(value as Integer)
    m.index = value
end sub

function ULongArray_I_Function1IULong_k_(size as Integer, init as Object) as Object
    return ULongArray_create_LongArray_k_(LongArray_create_I_Function1IJ_k_(size, ULongArray_lambda_create_Function1IULong_k_(init)))
end function

function ulongArrayOf_ULongArray_k_(elements as Object) as Object
    return ULongArray_create_LongArray_k_(LongArray_create_I_Function1IJ_k_(elements.__get_size(), ulongArrayOf_lambda_create_ULongArray_k_(elements)))
end function

function ULongArray_lambda_create_Function1IULong_k_(_init as Object) as Object
    this = {}
    this.__type = "ULongArray_lambda"
    this.__proto = ["ULongArray_lambda", "Function1", "Function"]
    this.__id = __kotlin_nextObjectId()
    this.equals = Any_equals_AnyN_k_
    this.hashCode = Any_hashCode_k_
    this.toString = Any_toString_k_
    this.invoke_AnyN_k_ = ULongArray_lambda_invoke_AnyN_k_
    this._init = _init
    return this
end function

function ULongArray_lambda_invoke_AnyN_k_(index as Integer) as LongInteger
...
function ulongArrayOf_lambda_create_ULongArray_k_(_elements as Object) as Object
    this = {}
    this.__type = "ulongArrayOf_lambda"
    this.__proto = ["ulongArrayOf_lambda", "Function1", "Function"]
    this.__id = __kotlin_nextObjectId()
    this.equals = Any_equals_AnyN_k_
    this.hashCode = Any_hashCode_k_
    this.toString = Any_toString_k_
    this.invoke_AnyN_k_ = ulongArrayOf_lambda_invoke_AnyN_k_
    this._elements = _elements
    return this
end function

function ulongArrayOf_lambda_invoke_AnyN_k_(it as Integer) as LongInteger
