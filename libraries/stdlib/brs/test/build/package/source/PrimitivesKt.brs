...
function iterator_rStr_k_(m as String) as Object
    return Anon_1fe8f973_create_Str_k_(m)
end function

function iterator_rCharArray_k_(m as Object) as Object
    return Anon_43f8ac6d_create_CharArray_k_(m)
end function

function Anon_1fe8f973_create_Str_k_(_this_iterator as String) as Object
    this = CharIterator_create_k_()
    this._super = {}
    this._super.hasNext_k_ = this.hasNext_k_
    this._super.nextChar_k_ = this.nextChar_k_
    this.__proto = ["Anon_1fe8f973", this.__proto]
    this.__type = "Anon_1fe8f973"
    this.hasNext_k_ = Anon_1fe8f973_hasNext_k_
    this.nextChar_k_ = Anon_1fe8f973_nextChar_k_
    this.get_index = Anon_1fe8f973_get_index_k_
    this.set_index = Anon_1fe8f973_set_index_I_k_
    this.index = 0
    this._this_iterator = _this_iterator
    return this
end function

function Anon_1fe8f973_hasNext_k_() as Boolean
    return m.get_index() < Len(m._this_iterator)
end function

function Anon_1fe8f973_nextChar_k_() as Object
...
function Anon_1fe8f973_get_index_k_() as Integer
    return m.index
end function

sub Anon_1fe8f973_set_index_I_k_(value as Integer)
    m.index = value
end sub

function Anon_43f8ac6d_create_CharArray_k_(_this_iterator as Object) as Object
    this = CharIterator_create_k_()
    this._super = {}
    this._super.hasNext_k_ = this.hasNext_k_
    this._super.nextChar_k_ = this.nextChar_k_
    this.__proto = ["Anon_43f8ac6d", this.__proto]
    this.__type = "Anon_43f8ac6d"
    this.hasNext_k_ = Anon_43f8ac6d_hasNext_k_
    this.nextChar_k_ = Anon_43f8ac6d_nextChar_k_
    this.get_index = Anon_43f8ac6d_get_index_k_
    this.set_index = Anon_43f8ac6d_set_index_I_k_
    this.index = 0
    this._this_iterator = _this_iterator
    return this
end function

function Anon_43f8ac6d_hasNext_k_() as Boolean
    return m.get_index() < m._this_iterator.get_size()
end function

function Anon_43f8ac6d_nextChar_k_() as Object
...
function Anon_43f8ac6d_get_index_k_() as Integer
    return m.index
end function

sub Anon_43f8ac6d_set_index_I_k_(value as Integer)
    m.index = value
end sub
