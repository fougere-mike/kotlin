function CharCategory_create_I_Str_k_(__name as String, __ordinal as Integer, value as Integer, code as String) as Object
    ...
    this.__get_value = CharCategory___get_value_k_
    this.__get_code = CharCategory___get_code_k_
    return this
end function

sub CharCategory_initEntries()
    if m.CharCategory_entriesInitialized = true then
        return
    end if
...
function CharCategory_contains_C_k_(char as Object) as Boolean
    return brsStructuralEquals_AnyN_AnyN_k_(__get_category_rC_k_(char), m)
end function
