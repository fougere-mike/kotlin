...
function HashSet_containsAll_Collection_k_(elements as Object) as Boolean
    __iter_166 = elements.iterator_k_()
    while __iter_166.hasNext_k_()
        element = __iter_166.next_k_()
...
function HashSet_addAll_Collection_k_(elements as Object) as Boolean
    modified = false
    __iter_167 = elements.iterator_k_()
    while __iter_167.hasNext_k_()
        element = __iter_167.next_k_()
...
function HashSet_removeAll_Collection_k_(elements as Object) as Boolean
    modified = false
    __iter_168 = elements.iterator_k_()
    while __iter_168.hasNext_k_()
        element = __iter_168.next_k_()
...
function HashSet_equals_AnyN_k_(other as Dynamic) as Boolean
    ...
    __iter_169 = m.iterator_k_()
    while __iter_169.hasNext_k_()
        element = __iter_169.next_k_()
...
function HashSet_hashCode_k_() as Integer
    h = 0
    __iter_170 = m.iterator_k_()
    while __iter_170.hasNext_k_()
        element = __iter_170.next_k_()
