...
function UInt_shl_I_k_(bitCount as Integer) as Object
    return UInt_create_I_k_(m.get_data() * (2 ^ bitCount))
end function

function UInt_shr_I_k_(bitCount as Integer) as Object
    return UInt_create_I_k_(__kotlin_ushr(m.get_data(), bitCount))
end function

function UInt_and_UInt_k_(other as Object) as Object
    return UInt_create_I_k_(m.get_data() and other.get_data())
end function

function UInt_or_UInt_k_(other as Object) as Object
    return UInt_create_I_k_(m.get_data() or other.get_data())
end function

function UInt_xor_UInt_k_(other as Object) as Object
    return UInt_create_I_k_((m.get_data() or other.get_data()) and not (m.get_data() and other.get_data()))
end function

function UInt_inv_k_() as Object
    return UInt_create_I_k_(not m.get_data())
end function
