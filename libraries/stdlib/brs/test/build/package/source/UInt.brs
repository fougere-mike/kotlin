function UInt_create_I_k_(data as Integer) as Object
    ...
    this.compareTo_UInt_k_ = UInt_compareTo_UInt_k_
    ...
    this.get_data = UInt_get_data_k_
    this.data = data
    return this
end function

function UInt_compareTo_UByte_k_(other as Object) as Integer
    return m.compareTo_UInt_k_(other.toUInt_k_())
end function
...
function UInt_compareTo_UInt_k_(other as Object) as Integer
    return uintCompare_I_I_k_(m.get_data(), other.get_data())
end function
...
function UInt_plus_ULong_k_(other as Object) as Object
    return m.toULong_k_() + other
end function

function UInt_minus_UByte_k_(other as Object) as Object
    return m.minus_UInt_k_(other.toUInt_k_())
end function
...
function UInt_times_UByte_k_(other as Object) as Object
    return m.times_UInt_k_(other.toUInt_k_())
end function
...
function UInt_div_UByte_k_(other as Object) as Object
    return m.div_UInt_k_(other.toUInt_k_())
end function
...
function UInt_div_UInt_k_(other as Object) as Object
    return uintDivide_I_I_k_(m.get_data(), other.get_data())
end function
...
function UInt_rem_UByte_k_(other as Object) as Object
    return m.rem_UInt_k_(other.toUInt_k_())
end function
...
function UInt_rem_UInt_k_(other as Object) as Object
    return uintRemainder_I_I_k_(m.get_data(), other.get_data())
end function
...
function UInt_floorDiv_UByte_k_(other as Object) as Object
    return m.floorDiv_UInt_k_(other.toUInt_k_())
end function
...
function UInt_mod_UByte_k_(other as Object) as Object
    return m.mod_UInt_k_(other.toUInt_k_()).toUByte_k_()
end function

function UInt_mod_UShort_k_(other as Object) as Object
    return m.mod_UInt_k_(other.toUInt_k_()).toUShort_k_()
end function
...
function UInt_inc_k_() as Object
    return UInt_create_I_k_(m.get_data() + 1)
end function
...
function UInt_shl_I_k_(bitCount as Integer) as Object
    return UInt_create_I_k_(shl_rI_I_k_(m.get_data(), bitCount))
end function

function UInt_shr_I_k_(bitCount as Integer) as Object
    return UInt_create_I_k_(ushr_rI_I_k_(m.get_data(), bitCount))
end function

function UInt_and_UInt_k_(other as Object) as Object
    return UInt_create_I_k_(and_rI_I_k_(m.get_data(), other.get_data()))
end function

function UInt_or_UInt_k_(other as Object) as Object
    return UInt_create_I_k_(or_rI_I_k_(m.get_data(), other.get_data()))
end function

function UInt_xor_UInt_k_(other as Object) as Object
    return UInt_create_I_k_(xor_rI_I_k_(m.get_data(), other.get_data()))
end function

function UInt_inv_k_() as Object
    return UInt_create_I_k_(inv_rI_k_(m.get_data()))
end function
...
function UInt_toLong_k_() as LongInteger
    return uintToLong_I_k_(m.get_data())
end function
...
function UInt_toULong_k_() as Object
    return uintToULong_I_k_(m.get_data())
end function

function UInt_toFloat_k_() as Float
    return uintToFloat_I_k_(m.get_data())
end function

function UInt_toDouble_k_() as Double
    return uintToDouble_I_k_(m.get_data())
end function

function UInt_toString_k_() as String
    return uintToString_I_k_(m.get_data())
end function
...
function UInt_get_data_k_() as Integer
    return m.data
end function
...
function UInt_Companion_create_k_() as Object
    ...
    this.__id = __kotlin_nextObjectId()
    this.get_MIN_VALUE = UInt_Companion_get_MIN_VALUE_k_
    this.get_MAX_VALUE = UInt_Companion_get_MAX_VALUE_k_
    this.get_SIZE_BYTES = UInt_Companion_get_SIZE_BYTES_k_
    this.get_SIZE_BITS = UInt_Companion_get_SIZE_BITS_k_
...
function UInt_Companion_getInstance() as Object
    if m.UInt_Companion_instance = invalid then
        m.UInt_Companion_instance = UInt_Companion_create_k_()
    end if
    return m.UInt_Companion_instance
end function

function UInt_Companion_get_MIN_VALUE_k_() as Object
    return m.MIN_VALUE
end function

function UInt_Companion_get_MAX_VALUE_k_() as Object
    return m.MAX_VALUE
end function

function UInt_Companion_get_SIZE_BYTES_k_() as Integer
    return m.SIZE_BYTES
end function

function UInt_Companion_get_SIZE_BITS_k_() as Integer
    return m.SIZE_BITS
end function
