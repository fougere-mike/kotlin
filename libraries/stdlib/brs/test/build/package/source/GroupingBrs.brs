...
function fold_rGroupingAnyNAnyN_AnyN_Function3AnyNAnyNAnyNAnyN_MapAnyNAnyN_k_(m as Object, initialValue as Dynamic, operation as Function) as Object
    result = HashMap_create_HashMapAnyNAnyN_k_()
    iterator = m.sourceIterator()
    while iterator.hasNext()
        element = iterator.next()
        key = m.keyOf(element)
        tmp0_elvis_lhs = result[key]
        __when_tmp0 = invalid
...
function fold_rGroupingAnyNAnyN_Function2AnyNAnyNAnyN_Function3AnyNAnyNAnyNAnyN_MapAnyNAnyN_k_(m as Object, initialValueSelector as Function, operation as Function) as Object
    result = HashMap_create_HashMapAnyNAnyN_k_()
    iterator = m.sourceIterator()
    while iterator.hasNext()
        element = iterator.next()
        ...
        __when_tmp1 = invalid
        if (accumulator = invalid) and result.containsKey(key).not() then
...
function reduce_rGroupingAnyNAnyN_Function3AnyNAnyNAnyNAnyN_MapAnyNAnyN_k_(m as Object, operation as Function) as Object
    result = HashMap_create_HashMapAnyNAnyN_k_()
    iterator = m.sourceIterator()
    while iterator.hasNext()
        element = iterator.next()
...
function groupBy_rIterableAnyN_Function1AnyNAnyN_MapAnyNListAnyN_k_(m as Object, keySelector as Function) as Object
    return groupByTo_rIterableAnyN_Any_Function1AnyNAnyN_Any_k_(m, HashMap_create_HashMapAnyNAnyN_k_(), keySelector)
end function

function groupBy_rIterableAnyN_Function1AnyNAnyN_Function1AnyNAnyN_MapAnyNListAnyN_k_(m as Object, keySelector as Function, valueTransform as Function) as Object
...
function groupByTo_rIterableAnyN_Any_Function1AnyNAnyN_Any_k_(m as Object, destination as Object, keySelector as Function) as Object
...
function groupByTo_rIterableAnyN_Any_Function1AnyNAnyN_Function1AnyNAnyN_Any_k_(m as Object, destination as Object, keySelector as Function, valueTransform as Function) as Object
    for each element in m
        key = keySelector.invoke(element)
        list = getOrPut_rMutableMapAnyNAnyN_AnyN_Function0AnyN_AnyN_k_(destination, key, {invoke: function() as Object
            return ArrayList_create_ArrayListAnyN_k_()
...
function associateBy_rIterableAnyN_Function1AnyNAnyN_MapAnyNAnyN_k_(m as Object, keySelector as Function) as Object
    result = HashMap_create_HashMapAnyNAnyN_k_()
    for each element in m
...
function associateBy_rIterableAnyN_Function1AnyNAnyN_Function1AnyNAnyN_MapAnyNAnyN_k_(m as Object, keySelector as Function, valueTransform as Function) as Object
    result = HashMap_create_HashMapAnyNAnyN_k_()
    for each element in m
...
function associateByTo_rIterableAnyN_Any_Function1AnyNAnyN_Any_k_(m as Object, destination as Object, keySelector as Function) as Object
    for each element in m
...
function associateByTo_rIterableAnyN_Any_Function1AnyNAnyN_Function1AnyNAnyN_Any_k_(m as Object, destination as Object, keySelector as Function, valueTransform as Function) as Object
    for each element in m
...
function associateWith_rIterableAnyN_Function1AnyNAnyN_MapAnyNAnyN_k_(m as Object, valueSelector as Function) as Object
    result = HashMap_create_HashMapAnyNAnyN_k_()
    for each element in m
...
function associateWithTo_rIterableAnyN_Any_Function1AnyNAnyN_Any_k_(m as Object, destination as Object, valueSelector as Function) as Object
    for each element in m
