...
function groupingBy_rIterable_Function1_k_(m as Object, keySelector as Object) as Object
    return Anon_f5932ab_create_Iterable_Function1_k_(m, keySelector)
end function
...
function Anon_f5932ab_create_Iterable_Function1_k_(_this_groupingBy as Object, _keySelector as Object) as Object
    this = {}
    this.__type = "Anon_f5932ab"
    this.__proto = ["Anon_f5932ab", "Grouping"]
    this.__id = __kotlin_nextObjectId()
    this.sourceIterator_k_ = Anon_f5932ab_sourceIterator_k_
    this.keyOf_AnyN_k_ = Anon_f5932ab_keyOf_AnyN_k_
    this._this_groupingBy = _this_groupingBy
    this._keySelector = _keySelector
    return this
end function

function Anon_f5932ab_sourceIterator_k_() as Object
    return m._this_groupingBy.iterator_k_()
end function

function Anon_f5932ab_keyOf_AnyN_k_(element as Dynamic) as Dynamic
