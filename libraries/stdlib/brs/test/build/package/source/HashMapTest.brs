sub hashMapTests_rTestRunner_k_(m as Object)
    m.suite_Str_Function1TestRunnerV_k_("HashMap", {invoke: function(m as Object) as Void
        ...
        m.test_Str_Function0V_k_("create from map", {invoke: function() as Void
            ...
            assertEquals_AnyN_AnyN_StrN_k_(2, map.get_AnyN_k_("b"))
        end function})
        m.test_Str_Function0V_k_("put and get", {invoke: function() as Void
            map = HashMap_create_k_()
            assertNull_AnyN_StrN_k_(map.put_AnyN_AnyN_k_("one", 1))
            assertEquals_AnyN_AnyN_StrN_k_(1, map.get_AnyN_k_("one"))
            assertEquals_AnyN_AnyN_StrN_k_(1, map.put_AnyN_AnyN_k_("one", 10))
            assertEquals_AnyN_AnyN_StrN_k_(10, map.get_AnyN_k_("one"))
        end function})
        m.test_Str_Function0V_k_("get nonexistent", {invoke: function() as Void
            map = HashMap_create_k_()
            assertNull_AnyN_StrN_k_(map.get_AnyN_k_("missing"))
        end function})
        m.test_Str_Function0V_k_("containsKey", {invoke: function() as Void
            ...
            assertTrue_Z_StrN_k_(map.containsKey_AnyN_k_("a"))
            assertFalse_Z_StrN_k_(map.containsKey_AnyN_k_("c"))
        end function})
        m.test_Str_Function0V_k_("containsValue", {invoke: function() as Void
            map = hashMapOf_Arr_k_([to_rAnyN_AnyN_k_("a", 1), to_rAnyN_AnyN_k_("b", 2)])
            assertTrue_Z_StrN_k_(map.containsValue_AnyN_k_(1))
            assertFalse_Z_StrN_k_(map.containsValue_AnyN_k_(3))
        end function})
        m.test_Str_Function0V_k_("remove", {invoke: function() as Void
            ...
            assertEquals_AnyN_AnyN_StrN_k_(2, map.remove_AnyN_k_("b"))
            assertNull_AnyN_StrN_k_(map.remove_AnyN_k_("missing"))
            assertEquals_AnyN_AnyN_StrN_k_(2, map.get_size())
            assertFalse_Z_StrN_k_(map.containsKey_AnyN_k_("b"))
        end function})
        ...
        m.test_Str_Function0V_k_("keys", {invoke: function() as Void
            ...
            assertTrue_Z_StrN_k_(keys.contains_AnyN_k_("a"))
            assertTrue_Z_StrN_k_(keys.contains_AnyN_k_("b"))
            assertTrue_Z_StrN_k_(keys.contains_AnyN_k_("c"))
        end function})
        m.test_Str_Function0V_k_("values", {invoke: function() as Void
            ...
            assertTrue_Z_StrN_k_(values.contains_AnyN_k_(1))
            assertTrue_Z_StrN_k_(values.contains_AnyN_k_(2))
            assertTrue_Z_StrN_k_(values.contains_AnyN_k_(3))
        end function})
        ...
        m.test_Str_Function0V_k_("putAll", {invoke: function() as Void
            ...
            assertEquals_AnyN_AnyN_StrN_k_(1, map.get_AnyN_k_("a"))
            assertEquals_AnyN_AnyN_StrN_k_(2, map.get_AnyN_k_("b"))
            assertEquals_AnyN_AnyN_StrN_k_(3, map.get_AnyN_k_("c"))
        end function})
        m.test_Str_Function0V_k_("getOrDefault", {invoke: function() as Void
            map = hashMapOf_Arr_k_([to_rAnyN_AnyN_k_("a", 1)])
            assertEquals_AnyN_AnyN_StrN_k_(1, getOrDefault_rMap_AnyN_AnyN_k_(map, "a", 0))
            assertEquals_AnyN_AnyN_StrN_k_(0, getOrDefault_rMap_AnyN_AnyN_k_(map, "b", 0))
        end function})
        m.test_Str_Function0V_k_("getOrPut", {invoke: function() as Void
            ...
            assertEquals_AnyN_AnyN_StrN_k_(10, map.get_AnyN_k_("b"))
        end function})
        ...
        m.test_Str_Function0V_k_("null values", {invoke: function() as Void
            ...
            assertTrue_Z_StrN_k_(map.containsKey_AnyN_k_("a"))
            assertNull_AnyN_StrN_k_(map.get_AnyN_k_("a"))
        end function})
        m.test_Str_Function0V_k_("integer keys", {invoke: function() as Void
            ...
            assertEquals_AnyN_AnyN_StrN_k_("two", map.get_AnyN_k_(2))
        end function})
    end function})
end sub
