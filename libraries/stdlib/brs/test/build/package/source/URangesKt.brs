function differenceModulo_UInt_UInt_UInt_k_(a as Object, b as Object, c as Object) as Object
    ...
    if ac.compareTo_UInt_k_(bc) >= 0 then
        ...
        __when_tmp0 = ac.minus_UInt_k_(bc).plus_UInt_k_(c)
    end if
    return __when_tmp0
...
function differenceModulo_ULong_ULong_ULong_k_(a as Object, b as Object, c as Object) as Object
    ...
    if ac.compareTo_ULong_k_(bc) >= 0 then
        ...
        __when_tmp1 = ac.minus_ULong_k_(bc).plus_ULong_k_(c)
    end if
    return __when_tmp1
...
function getProgressionLastElement_UInt_UInt_I_k_(start as Object, end_ as Object, step_ as Integer) as Object
    ...
    if step_ > 0 then
        ...
        if start.compareTo_UInt_k_(end_) <= 0 then
            ...
            __when_tmp3 = end_.plus_UInt_k_(differenceModulo_UInt_UInt_UInt_k_(start, end_, toUInt_rI_k_(-step_)))
        end if
...
function getProgressionLastElement_ULong_ULong_J_k_(start as Object, end_ as Object, step_ as LongInteger) as Object
    ...
    if step_ > 0 then
        ...
        if start.compareTo_ULong_k_(end_) <= 0 then
            ...
            __when_tmp6 = end_.plus_ULong_k_(differenceModulo_ULong_ULong_ULong_k_(start, end_, toULong_rJ_k_(-step_)))
        end if
...
function UIntRange_contains_UInt_k_(value as Object) as Boolean
    return (m.get_first().compareTo_UInt_k_(value) <= 0) and (value.compareTo_UInt_k_(m.get_last()) <= 0)
end function

function UIntRange_isEmpty_k_() as Boolean
    return m.get_first().compareTo_UInt_k_(m.get_last()) > 0
end function
...
function UIntRange_get_endExclusive_k_() as Object
    if brsStructuralEquals_AnyN_AnyN_k_(m.get_last(), UInt_Companion_getInstance().get_MAX_VALUE()) then
        error_Any_k_("Cannot return the exclusive upper bound of a range that includes MAX_VALUE.")
    end if
    return m.get_last().plus_UInt_k_(UInt_create_I_k_(1))
end function
...
function UIntRange_Companion_create_k_() as Object
    ...
    this.EMPTY = UIntRange_create_UInt_UInt_k_(UInt_Companion_getInstance().get_MAX_VALUE(), UInt_Companion_getInstance().get_MIN_VALUE())
    return this
end function
...
function UIntProgression_isEmpty_k_() as Boolean
    ...
    if m.get_step() > 0 then
        __when_tmp9 = (m.get_first().compareTo_UInt_k_(m.get_last()) > 0)
    else if true then
        __when_tmp9 = (m.get_first().compareTo_UInt_k_(m.get_last()) < 0)
    end if
    return __when_tmp9
...
function UIntProgressionIterator_next_k_() as Object
    ...
    if brsStructuralEquals_AnyN_AnyN_k_(value, m.get_finalElement()) then
        ...
        m.set_next(m.get_next().plus_UInt_k_(m.get_step()))
    end if
    return value
end function
...
function ULongRange_contains_ULong_k_(value as Object) as Boolean
    return (m.get_first().compareTo_ULong_k_(value) <= 0) and (value.compareTo_ULong_k_(m.get_last()) <= 0)
end function

function ULongRange_isEmpty_k_() as Boolean
    return m.get_first().compareTo_ULong_k_(m.get_last()) > 0
end function
...
function ULongRange_get_endExclusive_k_() as Object
    if brsStructuralEquals_AnyN_AnyN_k_(m.get_last(), ULong_Companion_getInstance().get_MAX_VALUE()) then
        error_Any_k_("Cannot return the exclusive upper bound of a range that includes MAX_VALUE.")
    end if
    return m.get_last().plus_UInt_k_(UInt_create_I_k_(1))
end function
...
function ULongRange_Companion_create_k_() as Object
    ...
    this.EMPTY = ULongRange_create_ULong_ULong_k_(ULong_Companion_getInstance().get_MAX_VALUE(), ULong_Companion_getInstance().get_MIN_VALUE())
    return this
end function
...
function ULongProgression_isEmpty_k_() as Boolean
    ...
    if m.get_step() > 0 then
        __when_tmp15 = (m.get_first().compareTo_ULong_k_(m.get_last()) > 0)
    else if true then
        __when_tmp15 = (m.get_first().compareTo_ULong_k_(m.get_last()) < 0)
    end if
    return __when_tmp15
...
function ULongProgression_hashCode_k_() as Integer
    ...
    if m.isEmpty_k_() then
        ...
        __when_tmp16 = ((31 * ((31 * m.get_first().xor_ULong_k_(m.get_first().shr_I_k_(32))) + m.get_last().xor_ULong_k_(m.get_last().shr_I_k_(32)))) + ((m.get_step() or __kotlin_ushr(m.get_step(), 32)) and not (m.get_step() and __kotlin_ushr(m.get_step(), 32))))
    end if
    return __when_tmp16
...
function ULongProgressionIterator_next_k_() as Object
    ...
    if brsStructuralEquals_AnyN_AnyN_k_(value, m.get_finalElement()) then
        ...
        m.set_next(m.get_next().plus_ULong_k_(m.get_step()))
    end if
    return value
end function
...
function until_rUInt_UInt_k_(m as Object, to_ as Object) as Object
    if to_.compareTo_UInt_k_(UInt_Companion_getInstance().get_MIN_VALUE()) <= 0 then
        return UIntRange_Companion_getInstance().get_EMPTY()
    end if
    return m.rangeTo_UInt_k_(to_.minus_UInt_k_(UInt_create_I_k_(1)))
end function

function until_rULong_ULong_k_(m as Object, to_ as Object) as Object
    if to_.compareTo_ULong_k_(ULong_Companion_getInstance().get_MIN_VALUE()) <= 0 then
        return ULongRange_Companion_getInstance().get_EMPTY()
    end if
    return m.rangeTo_ULong_k_(to_.minus_UInt_k_(UInt_create_I_k_(1)))
end function
