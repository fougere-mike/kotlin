...
function RoDateTime_Companion_getInstance() as Object
    if GetGlobalAA().RoDateTime_Companion_instance = invalid then
        GetGlobalAA().RoDateTime_Companion_instance = RoDateTime_Companion_create_k_()
    end if
    return GetGlobalAA().RoDateTime_Companion_instance
end function
...
function RoTimespan_Companion_getInstance() as Object
    if GetGlobalAA().RoTimespan_Companion_instance = invalid then
        GetGlobalAA().RoTimespan_Companion_instance = RoTimespan_Companion_create_k_()
    end if
    return GetGlobalAA().RoTimespan_Companion_instance
end function
