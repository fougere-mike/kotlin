sub collectionExtensionsTests_rTestRunner_k_(m as Object)
    m.suite_Str_Function1TestRunnerV_k_("Collection Extensions", {invoke: function(m as Object) as Void
        m.test_Str_Function0V_k_("map", {invoke: function() as Void
            ...
            assertEquals_AnyN_AnyN_StrN_k_(listOf_Arr_k_([2, 4, 6]), result)
        end function})
        ...
        m.test_Str_Function0V_k_("mapIndexed", {invoke: function() as Void
            ...
            assertEquals_AnyN_AnyN_StrN_k_(listOf_Arr_k_(["0:a", "1:b", "2:c"]), result)
        end function})
        m.test_Str_Function0V_k_("flatMap", {invoke: function() as Void
            ...
            assertEquals_AnyN_AnyN_StrN_k_(listOf_Arr_k_([1, 10, 2, 20, 3, 30]), result)
        end function})
        m.test_Str_Function0V_k_("filter", {invoke: function() as Void
            ...
            assertEquals_AnyN_AnyN_StrN_k_(listOf_Arr_k_([4, 5]), result)
        end function})
        ...
        m.test_Str_Function0V_k_("filterIndexed", {invoke: function() as Void
            ...
            assertEquals_AnyN_AnyN_StrN_k_(listOf_Arr_k_(["a", "c"]), result)
        end function})
        ...
        m.test_Str_Function0V_k_("sum", {invoke: function() as Void
            list = listOf_Arr_k_([1, 2, 3, 4, 5])
            assertEquals_AnyN_AnyN_StrN_k_(15, sum_rIterableI_k_(list))
        end function})
        ...
        m.test_Str_Function0V_k_("count", {invoke: function() as Void
            list = listOf_Arr_k_([1, 2, 3, 4, 5])
            assertEquals_AnyN_AnyN_StrN_k_(5, count_rIterable_k_(list))
        ...
        m.test_Str_Function0V_k_("any", {invoke: function() as Void
            list = listOf_Arr_k_([1, 2, 3])
            assertTrue_Z_StrN_k_(any_rIterable_k_(list))
        ...
        m.test_Str_Function0V_k_("none", {invoke: function() as Void
            list = listOf_Arr_k_([1, 2, 3])
            assertFalse_Z_StrN_k_(none_rIterable_k_(list))
        ...
        m.test_Str_Function0V_k_("first and last", {invoke: function() as Void
            list = listOf_Arr_k_([1, 2, 3])
            assertEquals_AnyN_AnyN_StrN_k_(1, first_rIterable_k_(list))
            assertEquals_AnyN_AnyN_StrN_k_(3, last_rIterable_k_(list))
        ...
        m.test_Str_Function0V_k_("firstOrNull and lastOrNull", {invoke: function() as Void
            list = listOf_Arr_k_([1, 2, 3])
            assertEquals_AnyN_AnyN_StrN_k_(1, firstOrNull_rIterable_k_(list))
            assertNull_AnyN_StrN_k_(firstOrNull_rIterable_Function1Z_k_(list, {invoke: function(it as Integer) as Boolean
                return it > 10
            end function}))
            empty = emptyList_k_()
            assertNull_AnyN_StrN_k_(firstOrNull_rIterable_k_(empty))
        end function})
        ...
        m.test_Str_Function0V_k_("groupBy", {invoke: function() as Void
            ...
            assertEquals_AnyN_AnyN_StrN_k_(listOf_Arr_k_([2, 4, 6]), groups.get_AnyN_k_(0))
            assertEquals_AnyN_AnyN_StrN_k_(listOf_Arr_k_([1, 3, 5]), groups.get_AnyN_k_(1))
        end function})
        m.test_Str_Function0V_k_("partition", {invoke: function() as Void
            ...
            assertEquals_AnyN_AnyN_StrN_k_(listOf_Arr_k_([2, 4]), evens)
        ...
        m.test_Str_Function0V_k_("associate", {invoke: function() as Void
            ...
            assertEquals_AnyN_AnyN_StrN_k_(1, map.get_AnyN_k_("a"))
            assertEquals_AnyN_AnyN_StrN_k_(2, map.get_AnyN_k_("bb"))
            assertEquals_AnyN_AnyN_StrN_k_(3, map.get_AnyN_k_("ccc"))
        end function})
        ...
        m.test_Str_Function0V_k_("associateBy", {invoke: function() as Void
            ...
            assertEquals_AnyN_AnyN_StrN_k_("a", map.get_AnyN_k_(1))
            assertEquals_AnyN_AnyN_StrN_k_("bb", map.get_AnyN_k_(2))
        end function})
        ...
        m.test_Str_Function0V_k_("joinToString", {invoke: function() as Void
            list = listOf_Arr_k_([1, 2, 3])
            assertEquals_AnyN_AnyN_StrN_k_("1, 2, 3", joinToString_rIterable_CharSequence_CharSequence_CharSequence_I_CharSequence_k_(list))
            assertEquals_AnyN_AnyN_StrN_k_("1-2-3", joinToString_rIterable_CharSequence_CharSequence_CharSequence_I_CharSequence_k_(list, "-"))
            assertEquals_AnyN_AnyN_StrN_k_("[1, 2, 3]", joinToString_rIterable_CharSequence_CharSequence_CharSequence_I_CharSequence_k_(list, "[", "]"))
        end function})
        m.test_Str_Function0V_k_("forEach", {invoke: function() as Void
            ...
            assertEquals_AnyN_AnyN_StrN_k_(listOf_Arr_k_([1, 2, 3]), collected)
        end function})
        ...
        m.test_Str_Function0V_k_("indexOf", {invoke: function() as Void
            ...
            assertEquals_AnyN_AnyN_StrN_k_(1, list.indexOf_AnyN_k_(2))
            assertEquals_AnyN_AnyN_StrN_k_(-1, list.indexOf_AnyN_k_(5))
        end function})
        ...
        m.test_Str_Function0V_k_("distinct", {invoke: function() as Void
            list = listOf_Arr_k_([1, 2, 2, 3, 3, 3])
            assertEquals_AnyN_AnyN_StrN_k_(listOf_Arr_k_([1, 2, 3]), distinct_rIterable_k_(list))
        end function})
        ...
        m.test_Str_Function0V_k_("take", {invoke: function() as Void
            list = listOf_Arr_k_([1, 2, 3, 4, 5])
            assertEquals_AnyN_AnyN_StrN_k_(listOf_Arr_k_([1, 2, 3]), take_rIterable_I_k_(list, 3))
        end function})
        m.test_Str_Function0V_k_("drop", {invoke: function() as Void
            list = listOf_Arr_k_([1, 2, 3, 4, 5])
            assertEquals_AnyN_AnyN_StrN_k_(listOf_Arr_k_([3, 4, 5]), drop_rIterable_I_k_(list, 2))
        end function})
        ...
        m.test_Str_Function0V_k_("reversed", {invoke: function() as Void
            list = listOf_Arr_k_([1, 2, 3])
            assertEquals_AnyN_AnyN_StrN_k_(listOf_Arr_k_([3, 2, 1]), reversed_rIterable_k_(list))
        end function})
        m.test_Str_Function0V_k_("zip", {invoke: function() as Void
            ...
            assertEquals_AnyN_AnyN_StrN_k_(listOf_Arr_k_([to_rAnyN_AnyN_k_(1, "a"), to_rAnyN_AnyN_k_(2, "b"), to_rAnyN_AnyN_k_(3, "c")]), zipped)
        end function})
    end function})
end sub
