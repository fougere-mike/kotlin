function HashSet_create_k_() as Object
    ...
    this.__get_array = HashSet___get_array_k_
    this.__get_map = HashSet___get_map_k_
    this.__get_size = HashSet___get_size_k_
...
function HashSet_create_Collection_k_(elements as Object) as Object
    ...
    this.__get_map = HashSet___get_map_k_
    this.__get_size = HashSet___get_size_k_
    this.map = HashMap_create_I_k_(elements.__get_size())
...
function HashSet_containsAll_Collection_k_(elements as Object) as Boolean
    __iter_177 = elements.iterator_k_()
    while __iter_177.hasNext_k_()
        element = __iter_177.next_k_()
...
function HashSet_iterator_k_() as Object
    return HashSet_SetIterator_create_MutableIterator_k_(m.__get_map().__get_keys().iterator_k_())
end function
...
function HashSet_add_AnyN_k_(element as Dynamic) as Boolean
    ...
    m.__get_map().put_AnyN_AnyN_k_(element, true)
    return true
end function
...
function HashSet_addAll_Collection_k_(elements as Object) as Boolean
    modified = false
    __iter_178 = elements.iterator_k_()
    while __iter_178.hasNext_k_()
        element = __iter_178.next_k_()
...
function HashSet_removeAll_Collection_k_(elements as Object) as Boolean
    modified = false
    __iter_179 = elements.iterator_k_()
    while __iter_179.hasNext_k_()
        element = __iter_179.next_k_()
...
function HashSet_equals_AnyN_k_(other as Dynamic) as Boolean
    ...
    __iter_180 = m.iterator_k_()
    while __iter_180.hasNext_k_()
        element = __iter_180.next_k_()
...
function HashSet_hashCode_k_() as Integer
    h = 0
    __iter_181 = m.iterator_k_()
    while __iter_181.hasNext_k_()
        element = __iter_181.next_k_()
...
function HashSet_toString_k_() as String
    ...
    sb.append_StrN_k_("[")
    first = true
    __iter_182 = m.iterator_k_()
    while __iter_182.hasNext_k_()
        element = __iter_182.next_k_()
        if not first then
            sb.append_StrN_k_(", ")
        end if
        first = false
...
function HashSet___get_array_k_() as Object
    result = CreateObject("roArray", 0, true)
    iter = m.__get_map().__get_keys().iterator_k_()
    while iter.hasNext_k_()
...
function HashSet___get_map_k_() as Object
    return m.map
end function

function HashSet___get_size_k_() as Integer
...
function HashSet_SetIterator_create_MutableIterator_k_(keyIterator as Object) as Object
    ...
    this.__get_keyIterator = HashSet_SetIterator___get_keyIterator_k_
    this.keyIterator = keyIterator
    return this
end function

function HashSet_SetIterator_hasNext_k_() as Boolean
    return m.__get_keyIterator().hasNext_k_()
end function

function HashSet_SetIterator_next_k_() as Dynamic
    return m.__get_keyIterator().next_k_()
end function

sub HashSet_SetIterator_remove_k_()
    m.__get_keyIterator().remove_k_()
end sub

function HashSet_SetIterator___get_keyIterator_k_() as Object
...
function EmptyHashSet_create_k_() as Object
    ...
    this.containsAll_Collection_k_ = EmptyHashSet_containsAll_Collection_k_
    ...
    this.__get_array = EmptyHashSet___get_array_k_
    this.__get_size = EmptyHashSet___get_size_k_
    return this
end function

function EmptyHashSet_getInstance() as Object
    if GetGlobalAA().EmptyHashSet_instance = invalid then
        GetGlobalAA().EmptyHashSet_instance = EmptyHashSet_create_k_()
    end if
    return GetGlobalAA().EmptyHashSet_instance
end function
...
function EmptyHashSet_containsAll_Collection_k_(elements as Object) as Boolean
...
function EmptyHashSet___get_array_k_() as Object
    return CreateObject("roArray", 0, true)
end function

function EmptyHashSet___get_size_k_() as Integer
    return 0
end function
...
function EmptySetIterator_getInstance() as Object
    if GetGlobalAA().EmptySetIterator_instance = invalid then
        GetGlobalAA().EmptySetIterator_instance = EmptySetIterator_create_k_()
    end if
    return GetGlobalAA().EmptySetIterator_instance
end function
