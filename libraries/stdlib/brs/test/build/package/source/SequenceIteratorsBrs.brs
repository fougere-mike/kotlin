...
function TransformingSequence_iterator_k_() as Object
    return Anon_6da71f59_create_TransformingSequence_k_(m)
end function
...
function TransformingIndexedSequence_iterator_k_() as Object
    return Anon_731167fc_create_TransformingIndexedSequence_k_(m)
end function
...
function FilteringSequence_iterator_k_() as Object
    return Anon_7a322651_create_FilteringSequence_k_(m)
end function
...
function FilteringIndexedSequence_iterator_k_() as Object
    return Anon_7338d5dd_create_FilteringIndexedSequence_k_(m)
end function
...
function FlatteningSequence_iterator_k_() as Object
    return Anon_7a4d06e0_create_FlatteningSequence_k_(m)
end function
...
function TakingSequence_iterator_k_() as Object
    return Anon_4b9ebaf6_create_TakingSequence_k_(m)
end function
...
function TakingWhileSequence_iterator_k_() as Object
    return Anon_1fd5207b_create_TakingWhileSequence_k_(m)
end function
...
function DroppingSequence_iterator_k_() as Object
    return Anon_7cf7e5b5_create_DroppingSequence_k_(m)
end function
...
function DroppingWhileSequence_iterator_k_() as Object
    return Anon_481b13f_create_DroppingWhileSequence_k_(m)
end function
...
function SubSequence_iterator_k_() as Object
    return Anon_5786d4d1_create_SubSequence_k_(m)
end function
...
function DistinctSequence_iterator_k_() as Object
    return Anon_34ae2cf3_create_DistinctSequence_k_(m)
end function
...
function MergingSequence_iterator_k_() as Object
    return Anon_4fd43fa_create_MergingSequence_k_(m)
end function
...
function Anon_6da71f59_create_TransformingSequence_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_6da71f59"
    this.__proto = ["Anon_6da71f59", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.next_k_ = Anon_6da71f59_next_k_
    this.hasNext_k_ = Anon_6da71f59_hasNext_k_
    this.get_iterator = Anon_6da71f59_get_iterator_k_
    this.iterator = this_0.get_sequence().iterator_k_()
    this.this_0 = this_0
    return this
end function

function Anon_6da71f59_next_k_() as Dynamic
    return m.this_0.get_transformer().invoke(m.get_iterator().next_k_())
end function

function Anon_6da71f59_hasNext_k_() as Boolean
    return m.get_iterator().hasNext_k_()
end function

function Anon_6da71f59_get_iterator_k_() as Object
    return m.iterator
end function

function Anon_731167fc_create_TransformingIndexedSequence_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_731167fc"
    this.__proto = ["Anon_731167fc", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.next_k_ = Anon_731167fc_next_k_
    this.hasNext_k_ = Anon_731167fc_hasNext_k_
    this.get_iterator = Anon_731167fc_get_iterator_k_
    this.get_index = Anon_731167fc_get_index_k_
    this.set_index = Anon_731167fc_set_index_I_k_
    this.iterator = this_0.get_sequence().iterator_k_()
    this.index = 0
    this.this_0 = this_0
    return this
...
function Anon_731167fc_next_k_() as Dynamic
...
function Anon_731167fc_hasNext_k_() as Boolean
    return m.get_iterator().hasNext_k_()
end function

function Anon_731167fc_get_iterator_k_() as Object
    return m.iterator
end function

function Anon_731167fc_get_index_k_() as Integer
    return m.index
end function

sub Anon_731167fc_set_index_I_k_(value as Integer)
    m.index = value
end sub

function Anon_7a322651_create_FilteringSequence_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_7a322651"
    this.__proto = ["Anon_7a322651", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.calcNext_k_ = Anon_7a322651_calcNext_k_
    this.next_k_ = Anon_7a322651_next_k_
    this.hasNext_k_ = Anon_7a322651_hasNext_k_
    this.get_iterator = Anon_7a322651_get_iterator_k_
    this.get_nextState = Anon_7a322651_get_nextState_k_
    this.set_nextState = Anon_7a322651_set_nextState_I_k_
    this.get_nextItem = Anon_7a322651_get_nextItem_k_
    this.set_nextItem = Anon_7a322651_set_nextItem_AnyN_k_
    this.iterator = this_0.get_sequence().iterator_k_()
    this.nextState = -1
...
function Anon_7a322651_next_k_() as Dynamic
...
function Anon_7a322651_hasNext_k_() as Boolean
    if m.get_nextState() = -1 then
        m.calcNext_k_()
    end if
...
function Anon_7a322651_get_iterator_k_() as Object
    return m.iterator
end function

function Anon_7a322651_get_nextState_k_() as Integer
    return m.nextState
end function

sub Anon_7a322651_set_nextState_I_k_(value as Integer)
    m.nextState = value
end sub

function Anon_7a322651_get_nextItem_k_() as Dynamic
    return m.nextItem
end function

sub Anon_7a322651_set_nextItem_AnyN_k_(value as Dynamic)
    m.nextItem = value
end sub

function Anon_7338d5dd_create_FilteringIndexedSequence_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_7338d5dd"
    this.__proto = ["Anon_7338d5dd", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.calcNext_k_ = Anon_7338d5dd_calcNext_k_
    this.next_k_ = Anon_7338d5dd_next_k_
    this.hasNext_k_ = Anon_7338d5dd_hasNext_k_
    this.get_iterator = Anon_7338d5dd_get_iterator_k_
    this.get_index = Anon_7338d5dd_get_index_k_
    this.set_index = Anon_7338d5dd_set_index_I_k_
    this.get_nextState = Anon_7338d5dd_get_nextState_k_
    this.set_nextState = Anon_7338d5dd_set_nextState_I_k_
    this.get_nextItem = Anon_7338d5dd_get_nextItem_k_
    this.set_nextItem = Anon_7338d5dd_set_nextItem_AnyN_k_
    this.iterator = this_0.get_sequence().iterator_k_()
    this.index = 0
    this.nextState = -1
    this.nextItem = invalid
...
function Anon_7338d5dd_next_k_() as Dynamic
    if m.get_nextState() = -1 then
        m.calcNext_k_()
    end if
    if m.get_nextState() = 0 then
...
function Anon_7338d5dd_hasNext_k_() as Boolean
    if m.get_nextState() = -1 then
        m.calcNext_k_()
    end if
    return m.get_nextState() = 1
...
function Anon_7338d5dd_get_iterator_k_() as Object
    return m.iterator
end function

function Anon_7338d5dd_get_index_k_() as Integer
    return m.index
end function

sub Anon_7338d5dd_set_index_I_k_(value as Integer)
    m.index = value
end sub

function Anon_7338d5dd_get_nextState_k_() as Integer
    return m.nextState
end function

sub Anon_7338d5dd_set_nextState_I_k_(value as Integer)
    m.nextState = value
end sub

function Anon_7338d5dd_get_nextItem_k_() as Dynamic
    return m.nextItem
end function

sub Anon_7338d5dd_set_nextItem_AnyN_k_(value as Dynamic)
    m.nextItem = value
end sub

function Anon_7a4d06e0_create_FlatteningSequence_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_7a4d06e0"
    this.__proto = ["Anon_7a4d06e0", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.next_k_ = Anon_7a4d06e0_next_k_
    this.hasNext_k_ = Anon_7a4d06e0_hasNext_k_
    this.ensureItemIterator_k_ = Anon_7a4d06e0_ensureItemIterator_k_
    this.get_iterator = Anon_7a4d06e0_get_iterator_k_
    this.get_itemIterator = Anon_7a4d06e0_get_itemIterator_k_
    this.set_itemIterator = Anon_7a4d06e0_set_itemIterator_IteratorN_k_
    this.iterator = this_0.get_sequence().iterator_k_()
...
function Anon_7a4d06e0_next_k_() as Dynamic
...
function Anon_7a4d06e0_hasNext_k_() as Boolean
    return m.ensureItemIterator_k_()
end function

function Anon_7a4d06e0_ensureItemIterator_k_() as Boolean
...
function Anon_7a4d06e0_get_iterator_k_() as Object
    return m.iterator
end function

function Anon_7a4d06e0_get_itemIterator_k_() as Dynamic
    return m.itemIterator
end function

sub Anon_7a4d06e0_set_itemIterator_IteratorN_k_(value as Dynamic)
    m.itemIterator = value
end sub

function Anon_4b9ebaf6_create_TakingSequence_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_4b9ebaf6"
    this.__proto = ["Anon_4b9ebaf6", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.next_k_ = Anon_4b9ebaf6_next_k_
    this.hasNext_k_ = Anon_4b9ebaf6_hasNext_k_
    this.get_left = Anon_4b9ebaf6_get_left_k_
    this.set_left = Anon_4b9ebaf6_set_left_I_k_
    this.get_iterator = Anon_4b9ebaf6_get_iterator_k_
    this.left = this_0.get_count()
    this.iterator = this_0.get_sequence().iterator_k_()
    return this
end function

function Anon_4b9ebaf6_next_k_() as Dynamic
...
function Anon_4b9ebaf6_hasNext_k_() as Boolean
    return (m.get_left() > 0) and m.get_iterator().hasNext_k_()
end function

function Anon_4b9ebaf6_get_left_k_() as Integer
    return m.left
end function

sub Anon_4b9ebaf6_set_left_I_k_(value as Integer)
    m.left = value
end sub

function Anon_4b9ebaf6_get_iterator_k_() as Object
    return m.iterator
end function

function Anon_1fd5207b_create_TakingWhileSequence_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_1fd5207b"
    this.__proto = ["Anon_1fd5207b", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.calcNext_k_ = Anon_1fd5207b_calcNext_k_
    this.next_k_ = Anon_1fd5207b_next_k_
    this.hasNext_k_ = Anon_1fd5207b_hasNext_k_
    this.get_iterator = Anon_1fd5207b_get_iterator_k_
    this.get_nextState = Anon_1fd5207b_get_nextState_k_
    this.set_nextState = Anon_1fd5207b_set_nextState_I_k_
    this.get_nextItem = Anon_1fd5207b_get_nextItem_k_
    this.set_nextItem = Anon_1fd5207b_set_nextItem_AnyN_k_
    this.iterator = this_0.get_sequence().iterator_k_()
    this.nextState = -1
    this.nextItem = invalid
    this.this_0 = this_0
...
function Anon_1fd5207b_next_k_() as Dynamic
    if m.get_nextState() = -1 then
        m.calcNext_k_()
    end if
    if m.get_nextState() = 0 then
...
function Anon_1fd5207b_hasNext_k_() as Boolean
    if m.get_nextState() = -1 then
        m.calcNext_k_()
    end if
    return m.get_nextState() = 1
...
function Anon_1fd5207b_get_iterator_k_() as Object
    return m.iterator
end function

function Anon_1fd5207b_get_nextState_k_() as Integer
    return m.nextState
end function

sub Anon_1fd5207b_set_nextState_I_k_(value as Integer)
    m.nextState = value
end sub

function Anon_1fd5207b_get_nextItem_k_() as Dynamic
    return m.nextItem
end function

sub Anon_1fd5207b_set_nextItem_AnyN_k_(value as Dynamic)
    m.nextItem = value
end sub

function Anon_7cf7e5b5_create_DroppingSequence_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_7cf7e5b5"
    this.__proto = ["Anon_7cf7e5b5", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.drop_k_ = Anon_7cf7e5b5_drop_k_
    this.next_k_ = Anon_7cf7e5b5_next_k_
    this.hasNext_k_ = Anon_7cf7e5b5_hasNext_k_
    this.get_iterator = Anon_7cf7e5b5_get_iterator_k_
    this.get_left = Anon_7cf7e5b5_get_left_k_
    this.set_left = Anon_7cf7e5b5_set_left_I_k_
    this.iterator = this_0.get_sequence().iterator_k_()
    this.left = this_0.get_count()
    return this
end function

sub Anon_7cf7e5b5_drop_k_()
...
function Anon_7cf7e5b5_next_k_() as Dynamic
    m.drop_k_()
    return m.get_iterator().next_k_()
end function

function Anon_7cf7e5b5_hasNext_k_() as Boolean
    m.drop_k_()
    return m.get_iterator().hasNext_k_()
end function

function Anon_7cf7e5b5_get_iterator_k_() as Object
    return m.iterator
end function

function Anon_7cf7e5b5_get_left_k_() as Integer
    return m.left
end function

sub Anon_7cf7e5b5_set_left_I_k_(value as Integer)
    m.left = value
end sub

function Anon_481b13f_create_DroppingWhileSequence_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_481b13f"
    this.__proto = ["Anon_481b13f", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.drop_k_ = Anon_481b13f_drop_k_
    this.next_k_ = Anon_481b13f_next_k_
    this.hasNext_k_ = Anon_481b13f_hasNext_k_
    this.get_iterator = Anon_481b13f_get_iterator_k_
    this.get_dropState = Anon_481b13f_get_dropState_k_
    this.set_dropState = Anon_481b13f_set_dropState_I_k_
    this.get_nextItem = Anon_481b13f_get_nextItem_k_
    this.set_nextItem = Anon_481b13f_set_nextItem_AnyN_k_
    this.iterator = this_0.get_sequence().iterator_k_()
    this.dropState = -1
    this.nextItem = invalid
    this.this_0 = this_0
...
function Anon_481b13f_next_k_() as Dynamic
...
function Anon_481b13f_hasNext_k_() as Boolean
    if m.get_dropState() = -1 then
        m.drop_k_()
    end if
...
function Anon_481b13f_get_iterator_k_() as Object
    return m.iterator
end function

function Anon_481b13f_get_dropState_k_() as Integer
    return m.dropState
end function

sub Anon_481b13f_set_dropState_I_k_(value as Integer)
    m.dropState = value
end sub

function Anon_481b13f_get_nextItem_k_() as Dynamic
    return m.nextItem
end function

sub Anon_481b13f_set_nextItem_AnyN_k_(value as Dynamic)
    m.nextItem = value
end sub

function Anon_5786d4d1_create_SubSequence_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_5786d4d1"
    this.__proto = ["Anon_5786d4d1", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.drop_k_ = Anon_5786d4d1_drop_k_
    this.hasNext_k_ = Anon_5786d4d1_hasNext_k_
    this.next_k_ = Anon_5786d4d1_next_k_
    this.get_iterator = Anon_5786d4d1_get_iterator_k_
    this.get_position = Anon_5786d4d1_get_position_k_
    this.set_position = Anon_5786d4d1_set_position_I_k_
    this.iterator = this_0.get_sequence().iterator_k_()
    this.position = 0
    this.this_0 = this_0
    return this
...
function Anon_5786d4d1_hasNext_k_() as Boolean
    m.drop_k_()
    return (m.get_position() < m.this_0.get_endIndex()) and m.get_iterator().hasNext_k_()
end function

function Anon_5786d4d1_next_k_() as Dynamic
    m.drop_k_()
...
function Anon_5786d4d1_get_iterator_k_() as Object
    return m.iterator
end function

function Anon_5786d4d1_get_position_k_() as Integer
    return m.position
end function

sub Anon_5786d4d1_set_position_I_k_(value as Integer)
    m.position = value
end sub

function Anon_34ae2cf3_create_DistinctSequence_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_34ae2cf3"
    this.__proto = ["Anon_34ae2cf3", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.calcNext_k_ = Anon_34ae2cf3_calcNext_k_
    this.hasNext_k_ = Anon_34ae2cf3_hasNext_k_
    this.next_k_ = Anon_34ae2cf3_next_k_
    this.get_sourceIterator = Anon_34ae2cf3_get_sourceIterator_k_
    this.get_observed = Anon_34ae2cf3_get_observed_k_
    this.get_nextValue = Anon_34ae2cf3_get_nextValue_k_
    this.set_nextValue = Anon_34ae2cf3_set_nextValue_AnyN_k_
    this.get_nextState = Anon_34ae2cf3_get_nextState_k_
    this.set_nextState = Anon_34ae2cf3_set_nextState_I_k_
...
function Anon_34ae2cf3_hasNext_k_() as Boolean
    if m.get_nextState() = -1 then
        m.calcNext_k_()
    end if
    return m.get_nextState() = 1
...
function Anon_34ae2cf3_next_k_() as Dynamic
    if m.get_nextState() = -1 then
        m.calcNext_k_()
    end if
    if m.get_nextState() = 0 then
...
function Anon_34ae2cf3_get_sourceIterator_k_() as Object
    return m.sourceIterator
end function

function Anon_34ae2cf3_get_observed_k_() as Object
    return m.observed
end function

function Anon_34ae2cf3_get_nextValue_k_() as Dynamic
    return m.nextValue
end function

sub Anon_34ae2cf3_set_nextValue_AnyN_k_(value as Dynamic)
    m.nextValue = value
end sub

function Anon_34ae2cf3_get_nextState_k_() as Integer
    return m.nextState
end function

sub Anon_34ae2cf3_set_nextState_I_k_(value as Integer)
    m.nextState = value
end sub

function Anon_4fd43fa_create_MergingSequence_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_4fd43fa"
    this.__proto = ["Anon_4fd43fa", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.hasNext_k_ = Anon_4fd43fa_hasNext_k_
    this.next_k_ = Anon_4fd43fa_next_k_
    this.get_iterator1 = Anon_4fd43fa_get_iterator1_k_
    this.get_iterator2 = Anon_4fd43fa_get_iterator2_k_
...
function Anon_4fd43fa_hasNext_k_() as Boolean
    return m.get_iterator1().hasNext_k_() and m.get_iterator2().hasNext_k_()
end function

function Anon_4fd43fa_next_k_() as Dynamic
    return m.this_0.get_transform().invoke(m.get_iterator1().next_k_(), m.get_iterator2().next_k_())
end function

function Anon_4fd43fa_get_iterator1_k_() as Object
    return m.iterator1
end function

function Anon_4fd43fa_get_iterator2_k_() as Object
    return m.iterator2
end function
