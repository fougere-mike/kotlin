...
function UShort_and_UShort_k_(other as Object) as Object
    return UShort_create_S_k_(and_rI_I_k_(m, other))
end function

function UShort_or_UShort_k_(other as Object) as Object
    return UShort_create_S_k_(or_rI_I_k_(m, other))
end function

function UShort_xor_UShort_k_(other as Object) as Object
    return UShort_create_S_k_(xor_rI_I_k_(m, other))
end function

function UShort_inv_k_() as Object
    return UShort_create_S_k_(inv_rI_k_(m))
end function
...
function UShort_toInt_k_() as Integer
    return and_rI_I_k_(m.get_data(), 65535)
end function

function UShort_toLong_k_() as LongInteger
    return and_rJ_J_k_(m.get_data(), 65535&)
end function
...
function UShort_toUInt_k_() as Object
    return UInt_create_I_k_(and_rI_I_k_(m.get_data(), 65535))
end function

function UShort_toULong_k_() as Object
    return ULong_create_J_k_(and_rJ_J_k_(m.get_data(), 65535&))
end function
...
function UShort_Companion_getInstance() as Object
    if m.UShort_Companion_instance = invalid then
        m.UShort_Companion_instance = UShort_Companion_create_k_()
    end if
