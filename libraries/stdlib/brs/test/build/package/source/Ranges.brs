...
function LongRange_hashCode_k_() as Integer
    ...
    if m.isEmpty_k_() then
        ...
        __when_tmp1 = ((31 * xor_rJ_J_k_(m.get_first(), ushr_rJ_I_k_(m.get_first(), 32))) + xor_rJ_J_k_(m.get_last(), ushr_rJ_I_k_(m.get_last(), 32)))
    end if
    return __when_tmp1
...
function LongProgression_hashCode_k_() as Integer
    ...
    if m.isEmpty_k_() then
        ...
        __when_tmp7 = ((31 * ((31 * xor_rJ_J_k_(m.get_first(), ushr_rJ_I_k_(m.get_first(), 32))) + xor_rJ_J_k_(m.get_last(), ushr_rJ_I_k_(m.get_last(), 32)))) + xor_rJ_J_k_(m.get_step(), ushr_rJ_I_k_(m.get_step(), 32)))
    end if
    return __when_tmp7
