...
function UByte_compareTo_UByte_k_(other as Object) as Integer
    return compareTo_rI_I_k_(m, other)
end function
...
function UByte_plus_UByte_k_(other as Object) as Object
    return m.toUInt_k_() + other.toUInt_k_()
end function
...
function UByte_and_UByte_k_(other as Object) as Object
    return UByte_create_B_k_(and_rI_I_k_(m, other))
end function

function UByte_or_UByte_k_(other as Object) as Object
    return UByte_create_B_k_(or_rI_I_k_(m, other))
end function

function UByte_xor_UByte_k_(other as Object) as Object
    return UByte_create_B_k_(xor_rI_I_k_(m, other))
end function

function UByte_inv_k_() as Object
    return UByte_create_B_k_(inv_rI_k_(m))
end function
...
function UByte_toShort_k_() as Integer
    return and_rI_I_k_(m.get_data(), 255)
end function
...
function UByte_toLong_k_() as LongInteger
    return and_rJ_J_k_(m.get_data(), 255&)
end function
...
function UByte_toUShort_k_() as Object
    return UShort_create_S_k_(and_rI_I_k_(m.get_data(), 255))
end function

function UByte_toUInt_k_() as Object
    return UInt_create_I_k_(and_rI_I_k_(m.get_data(), 255))
end function

function UByte_toULong_k_() as Object
    return ULong_create_J_k_(and_rJ_J_k_(m.get_data(), 255&))
end function
...
function UByte_Companion_getInstance() as Object
    if m.UByte_Companion_instance = invalid then
        m.UByte_Companion_instance = UByte_Companion_create_k_()
    end if
