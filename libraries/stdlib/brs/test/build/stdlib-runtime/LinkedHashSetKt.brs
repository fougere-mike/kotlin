function LinkedHashSet_create_k_() as Object
    ...
    this.__get_map = LinkedHashSet___get_map_k_
    this.__get_size = LinkedHashSet___get_size_k_
...
function LinkedHashSet_create_Collection_k_(elements as Object) as Object
    ...
    this.__get_map = LinkedHashSet___get_map_k_
    this.__get_size = LinkedHashSet___get_size_k_
    this.map = LinkedHashMap_create_I_k_(elements.__get_size())
...
function LinkedHashSet_containsAll_Collection_k_(elements as Object) as Boolean
    __iter_193 = elements.iterator_k_()
    while __iter_193.hasNext_k_()
        element = __iter_193.next_k_()
...
function LinkedHashSet_iterator_k_() as Object
    return LinkedHashSet_SetIterator_create_MutableIterator_k_(m.__get_map().__get_keys().iterator_k_())
end function
...
function LinkedHashSet_addAll_Collection_k_(elements as Object) as Boolean
    modified = false
    __iter_194 = elements.iterator_k_()
    while __iter_194.hasNext_k_()
        element = __iter_194.next_k_()
...
function LinkedHashSet_removeAll_Collection_k_(elements as Object) as Boolean
    modified = false
    __iter_195 = elements.iterator_k_()
    while __iter_195.hasNext_k_()
        element = __iter_195.next_k_()
...
function LinkedHashSet_equals_AnyN_k_(other as Dynamic) as Boolean
    ...
    while true
        this = tmp0
        if __kotlin_isInstanceOf(this, "Collection") and this.isEmpty_k_() then
            tmp_ret_0 = true
                        __ret_done_2 = true
            exit while

        end if
        __iter_196 = this.iterator_k_()
        while __iter_196.hasNext_k_()
            element = __iter_196.next_k_()
            tmp0_1 = element
            tmp_ret_1 = invalid

            while true
                it = tmp0_1
                tmp_ret_1 = contains_rIterable_AnyN_k_(m, it)
                __ret_done_2 = true
                exit while

            end while
            if not tmp_ret_1 then
                tmp_ret_0 = false
                                __ret_done_2 = true
                exit while
...
function LinkedHashSet_hashCode_k_() as Integer
    result = 0
    __iter_197 = m.iterator_k_()
    while __iter_197.hasNext_k_()
        element = __iter_197.next_k_()
...
function LinkedHashSet___get_map_k_() as Object
    return m.map
end function

function LinkedHashSet___get_size_k_() as Integer
...
function LinkedHashSet_SetIterator_create_MutableIterator_k_(keyIterator as Object) as Object
    ...
    this.__get_keyIterator = LinkedHashSet_SetIterator___get_keyIterator_k_
...
function LinkedHashSet_SetIterator___get_keyIterator_k_() as Object
