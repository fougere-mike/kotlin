...
function ULong_shl_I_k_(bitCount as Integer) as Object
    return ULong_create_J_k_(shl_rJ_I_k_(m.get_data(), bitCount))
end function

function ULong_shr_I_k_(bitCount as Integer) as Object
    return ULong_create_J_k_(ushr_rJ_I_k_(m.get_data(), bitCount))
end function

function ULong_and_ULong_k_(other as Object) as Object
    return ULong_create_J_k_(and_rJ_J_k_(m.get_data(), other.get_data()))
end function

function ULong_or_ULong_k_(other as Object) as Object
    return ULong_create_J_k_(or_rJ_J_k_(m.get_data(), other.get_data()))
end function

function ULong_xor_ULong_k_(other as Object) as Object
    return ULong_create_J_k_(xor_rJ_J_k_(m.get_data(), other.get_data()))
end function

function ULong_inv_k_() as Object
    return ULong_create_J_k_(inv_rJ_k_(m.get_data()))
end function
...
function ULong_Companion_getInstance() as Object
    if m.ULong_Companion_instance = invalid then
        m.ULong_Companion_instance = ULong_Companion_create_k_()
    end if
