function CharCategory_create(__name as String, __ordinal as Integer, value as Integer, code as String) as Object
    this = {}
...
sub CharCategory_initEntries()
    ...
    m.CharCategory_UNASSIGNED = CharCategory_create("UNASSIGNED", 0, 0, "Cn")
    m.CharCategory_UPPERCASE_LETTER = CharCategory_create("UPPERCASE_LETTER", 1, 1, "Lu")
    m.CharCategory_LOWERCASE_LETTER = CharCategory_create("LOWERCASE_LETTER", 2, 2, "Ll")
    m.CharCategory_TITLECASE_LETTER = CharCategory_create("TITLECASE_LETTER", 3, 3, "Lt")
    m.CharCategory_MODIFIER_LETTER = CharCategory_create("MODIFIER_LETTER", 4, 4, "Lm")
    m.CharCategory_OTHER_LETTER = CharCategory_create("OTHER_LETTER", 5, 5, "Lo")
    m.CharCategory_NON_SPACING_MARK = CharCategory_create("NON_SPACING_MARK", 6, 6, "Mn")
    m.CharCategory_ENCLOSING_MARK = CharCategory_create("ENCLOSING_MARK", 7, 7, "Me")
    m.CharCategory_COMBINING_SPACING_MARK = CharCategory_create("COMBINING_SPACING_MARK", 8, 8, "Mc")
    m.CharCategory_DECIMAL_DIGIT_NUMBER = CharCategory_create("DECIMAL_DIGIT_NUMBER", 9, 9, "Nd")
    m.CharCategory_LETTER_NUMBER = CharCategory_create("LETTER_NUMBER", 10, 10, "Nl")
    m.CharCategory_OTHER_NUMBER = CharCategory_create("OTHER_NUMBER", 11, 11, "No")
    m.CharCategory_SPACE_SEPARATOR = CharCategory_create("SPACE_SEPARATOR", 12, 12, "Zs")
    m.CharCategory_LINE_SEPARATOR = CharCategory_create("LINE_SEPARATOR", 13, 13, "Zl")
    m.CharCategory_PARAGRAPH_SEPARATOR = CharCategory_create("PARAGRAPH_SEPARATOR", 14, 14, "Zp")
    m.CharCategory_CONTROL = CharCategory_create("CONTROL", 15, 15, "Cc")
    m.CharCategory_FORMAT = CharCategory_create("FORMAT", 16, 16, "Cf")
    m.CharCategory_PRIVATE_USE = CharCategory_create("PRIVATE_USE", 17, 18, "Co")
    m.CharCategory_SURROGATE = CharCategory_create("SURROGATE", 18, 19, "Cs")
    m.CharCategory_DASH_PUNCTUATION = CharCategory_create("DASH_PUNCTUATION", 19, 20, "Pd")
    m.CharCategory_START_PUNCTUATION = CharCategory_create("START_PUNCTUATION", 20, 21, "Ps")
    m.CharCategory_END_PUNCTUATION = CharCategory_create("END_PUNCTUATION", 21, 22, "Pe")
    m.CharCategory_CONNECTOR_PUNCTUATION = CharCategory_create("CONNECTOR_PUNCTUATION", 22, 23, "Pc")
    m.CharCategory_OTHER_PUNCTUATION = CharCategory_create("OTHER_PUNCTUATION", 23, 24, "Po")
    m.CharCategory_MATH_SYMBOL = CharCategory_create("MATH_SYMBOL", 24, 25, "Sm")
    m.CharCategory_CURRENCY_SYMBOL = CharCategory_create("CURRENCY_SYMBOL", 25, 26, "Sc")
    m.CharCategory_MODIFIER_SYMBOL = CharCategory_create("MODIFIER_SYMBOL", 26, 27, "Sk")
    m.CharCategory_OTHER_SYMBOL = CharCategory_create("OTHER_SYMBOL", 27, 28, "So")
    m.CharCategory_INITIAL_QUOTE_PUNCTUATION = CharCategory_create("INITIAL_QUOTE_PUNCTUATION", 28, 29, "Pi")
    m.CharCategory_FINAL_QUOTE_PUNCTUATION = CharCategory_create("FINAL_QUOTE_PUNCTUATION", 29, 30, "Pf")
end sub
