function CharCategory_create_I_Str_k_(__name as String, __ordinal as Integer, value as Integer, code as String) as Object
    this = {}
    ...
    this.value = value
    this.code = code
    this.contains_C_k_ = CharCategory_contains_C_k_
    this.values_k_ = CharCategory_values_k_
    this.valueOf_Str_k_ = CharCategory_valueOf_Str_k_
    this.get_value = CharCategory_get_value_k_
    this.get_code = CharCategory_get_code_k_
    this.get_entries = CharCategory_get_entries_k_
    return this
end function
...
sub CharCategory_initEntries()
    ...
    m.CharCategory_UNASSIGNED = CharCategory_create_I_Str_k_("UNASSIGNED", 0, 0, "Cn")
    m.CharCategory_UPPERCASE_LETTER = CharCategory_create_I_Str_k_("UPPERCASE_LETTER", 1, 1, "Lu")
    m.CharCategory_LOWERCASE_LETTER = CharCategory_create_I_Str_k_("LOWERCASE_LETTER", 2, 2, "Ll")
    m.CharCategory_TITLECASE_LETTER = CharCategory_create_I_Str_k_("TITLECASE_LETTER", 3, 3, "Lt")
    m.CharCategory_MODIFIER_LETTER = CharCategory_create_I_Str_k_("MODIFIER_LETTER", 4, 4, "Lm")
    m.CharCategory_OTHER_LETTER = CharCategory_create_I_Str_k_("OTHER_LETTER", 5, 5, "Lo")
    m.CharCategory_NON_SPACING_MARK = CharCategory_create_I_Str_k_("NON_SPACING_MARK", 6, 6, "Mn")
    m.CharCategory_ENCLOSING_MARK = CharCategory_create_I_Str_k_("ENCLOSING_MARK", 7, 7, "Me")
    m.CharCategory_COMBINING_SPACING_MARK = CharCategory_create_I_Str_k_("COMBINING_SPACING_MARK", 8, 8, "Mc")
    m.CharCategory_DECIMAL_DIGIT_NUMBER = CharCategory_create_I_Str_k_("DECIMAL_DIGIT_NUMBER", 9, 9, "Nd")
    m.CharCategory_LETTER_NUMBER = CharCategory_create_I_Str_k_("LETTER_NUMBER", 10, 10, "Nl")
    m.CharCategory_OTHER_NUMBER = CharCategory_create_I_Str_k_("OTHER_NUMBER", 11, 11, "No")
    m.CharCategory_SPACE_SEPARATOR = CharCategory_create_I_Str_k_("SPACE_SEPARATOR", 12, 12, "Zs")
    m.CharCategory_LINE_SEPARATOR = CharCategory_create_I_Str_k_("LINE_SEPARATOR", 13, 13, "Zl")
    m.CharCategory_PARAGRAPH_SEPARATOR = CharCategory_create_I_Str_k_("PARAGRAPH_SEPARATOR", 14, 14, "Zp")
    m.CharCategory_CONTROL = CharCategory_create_I_Str_k_("CONTROL", 15, 15, "Cc")
    m.CharCategory_FORMAT = CharCategory_create_I_Str_k_("FORMAT", 16, 16, "Cf")
    m.CharCategory_PRIVATE_USE = CharCategory_create_I_Str_k_("PRIVATE_USE", 17, 18, "Co")
    m.CharCategory_SURROGATE = CharCategory_create_I_Str_k_("SURROGATE", 18, 19, "Cs")
    m.CharCategory_DASH_PUNCTUATION = CharCategory_create_I_Str_k_("DASH_PUNCTUATION", 19, 20, "Pd")
    m.CharCategory_START_PUNCTUATION = CharCategory_create_I_Str_k_("START_PUNCTUATION", 20, 21, "Ps")
    m.CharCategory_END_PUNCTUATION = CharCategory_create_I_Str_k_("END_PUNCTUATION", 21, 22, "Pe")
    m.CharCategory_CONNECTOR_PUNCTUATION = CharCategory_create_I_Str_k_("CONNECTOR_PUNCTUATION", 22, 23, "Pc")
    m.CharCategory_OTHER_PUNCTUATION = CharCategory_create_I_Str_k_("OTHER_PUNCTUATION", 23, 24, "Po")
    m.CharCategory_MATH_SYMBOL = CharCategory_create_I_Str_k_("MATH_SYMBOL", 24, 25, "Sm")
    m.CharCategory_CURRENCY_SYMBOL = CharCategory_create_I_Str_k_("CURRENCY_SYMBOL", 25, 26, "Sc")
    m.CharCategory_MODIFIER_SYMBOL = CharCategory_create_I_Str_k_("MODIFIER_SYMBOL", 26, 27, "Sk")
    m.CharCategory_OTHER_SYMBOL = CharCategory_create_I_Str_k_("OTHER_SYMBOL", 27, 28, "So")
    m.CharCategory_INITIAL_QUOTE_PUNCTUATION = CharCategory_create_I_Str_k_("INITIAL_QUOTE_PUNCTUATION", 28, 29, "Pi")
    m.CharCategory_FINAL_QUOTE_PUNCTUATION = CharCategory_create_I_Str_k_("FINAL_QUOTE_PUNCTUATION", 29, 30, "Pf")
end sub
