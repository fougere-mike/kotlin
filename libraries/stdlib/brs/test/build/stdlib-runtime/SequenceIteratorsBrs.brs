...
function TransformingSequence_iterator_k_() as Object
    return Anon_457eb000_create_TransformingSequence_k_(m)
end function
...
function TransformingIndexedSequence_iterator_k_() as Object
    return Anon_715171a4_create_TransformingIndexedSequence_k_(m)
end function
...
function FilteringSequence_iterator_k_() as Object
    return Anon_28e12c6_create_FilteringSequence_k_(m)
end function
...
function FilteringIndexedSequence_iterator_k_() as Object
    return Anon_3689699d_create_FilteringIndexedSequence_k_(m)
end function
...
function FlatteningSequence_iterator_k_() as Object
    return Anon_77b3fc21_create_FlatteningSequence_k_(m)
end function
...
function TakingSequence_iterator_k_() as Object
    return Anon_37675fc7_create_TakingSequence_k_(m)
end function
...
function TakingWhileSequence_iterator_k_() as Object
    return Anon_46e123d2_create_TakingWhileSequence_k_(m)
end function
...
function DroppingSequence_iterator_k_() as Object
    return Anon_35674b5a_create_DroppingSequence_k_(m)
end function
...
function DroppingWhileSequence_iterator_k_() as Object
    return Anon_29f88f79_create_DroppingWhileSequence_k_(m)
end function
...
function SubSequence_iterator_k_() as Object
    return Anon_f3e36aa_create_SubSequence_k_(m)
end function
...
function DistinctSequence_iterator_k_() as Object
    return Anon_134b192e_create_DistinctSequence_k_(m)
end function
...
function MergingSequence_iterator_k_() as Object
    return Anon_7d5561c3_create_MergingSequence_k_(m)
end function
...
function Anon_457eb000_create_TransformingSequence_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_457eb000"
    this.__proto = ["Anon_457eb000", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.next_k_ = Anon_457eb000_next_k_
    this.hasNext_k_ = Anon_457eb000_hasNext_k_
    this.get_iterator = Anon_457eb000_get_iterator_k_
    this.iterator = this_0.get_sequence().iterator_k_()
    this.this_0 = this_0
    return this
end function

function Anon_457eb000_next_k_() as Dynamic
    return m.this_0.get_transformer().invoke(m.get_iterator().next_k_())
end function

function Anon_457eb000_hasNext_k_() as Boolean
    return m.get_iterator().hasNext_k_()
end function

function Anon_457eb000_get_iterator_k_() as Object
    return m.iterator
end function

function Anon_715171a4_create_TransformingIndexedSequence_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_715171a4"
    this.__proto = ["Anon_715171a4", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.next_k_ = Anon_715171a4_next_k_
    this.hasNext_k_ = Anon_715171a4_hasNext_k_
    this.get_iterator = Anon_715171a4_get_iterator_k_
    this.get_index = Anon_715171a4_get_index_k_
    this.set_index = Anon_715171a4_set_index_I_k_
    this.iterator = this_0.get_sequence().iterator_k_()
    this.index = 0
    this.this_0 = this_0
    return this
...
function Anon_715171a4_next_k_() as Dynamic
...
function Anon_715171a4_hasNext_k_() as Boolean
    return m.get_iterator().hasNext_k_()
end function

function Anon_715171a4_get_iterator_k_() as Object
    return m.iterator
end function

function Anon_715171a4_get_index_k_() as Integer
    return m.index
end function

sub Anon_715171a4_set_index_I_k_(value as Integer)
    m.index = value
end sub

function Anon_28e12c6_create_FilteringSequence_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_28e12c6"
    this.__proto = ["Anon_28e12c6", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.calcNext_k_ = Anon_28e12c6_calcNext_k_
    this.next_k_ = Anon_28e12c6_next_k_
    this.hasNext_k_ = Anon_28e12c6_hasNext_k_
    this.get_iterator = Anon_28e12c6_get_iterator_k_
    this.get_nextState = Anon_28e12c6_get_nextState_k_
    this.set_nextState = Anon_28e12c6_set_nextState_I_k_
    this.get_nextItem = Anon_28e12c6_get_nextItem_k_
    this.set_nextItem = Anon_28e12c6_set_nextItem_AnyN_k_
    this.iterator = this_0.get_sequence().iterator_k_()
    this.nextState = -1
...
function Anon_28e12c6_next_k_() as Dynamic
...
function Anon_28e12c6_hasNext_k_() as Boolean
    if m.get_nextState() = -1 then
        m.calcNext_k_()
    end if
...
function Anon_28e12c6_get_iterator_k_() as Object
    return m.iterator
end function

function Anon_28e12c6_get_nextState_k_() as Integer
    return m.nextState
end function

sub Anon_28e12c6_set_nextState_I_k_(value as Integer)
    m.nextState = value
end sub

function Anon_28e12c6_get_nextItem_k_() as Dynamic
    return m.nextItem
end function

sub Anon_28e12c6_set_nextItem_AnyN_k_(value as Dynamic)
    m.nextItem = value
end sub

function Anon_3689699d_create_FilteringIndexedSequence_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_3689699d"
    this.__proto = ["Anon_3689699d", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.calcNext_k_ = Anon_3689699d_calcNext_k_
    this.next_k_ = Anon_3689699d_next_k_
    this.hasNext_k_ = Anon_3689699d_hasNext_k_
    this.get_iterator = Anon_3689699d_get_iterator_k_
    this.get_index = Anon_3689699d_get_index_k_
    this.set_index = Anon_3689699d_set_index_I_k_
    this.get_nextState = Anon_3689699d_get_nextState_k_
    this.set_nextState = Anon_3689699d_set_nextState_I_k_
    this.get_nextItem = Anon_3689699d_get_nextItem_k_
    this.set_nextItem = Anon_3689699d_set_nextItem_AnyN_k_
    this.iterator = this_0.get_sequence().iterator_k_()
    this.index = 0
    this.nextState = -1
    this.nextItem = invalid
...
function Anon_3689699d_next_k_() as Dynamic
    if m.get_nextState() = -1 then
        m.calcNext_k_()
    end if
    if m.get_nextState() = 0 then
...
function Anon_3689699d_hasNext_k_() as Boolean
    if m.get_nextState() = -1 then
        m.calcNext_k_()
    end if
    return m.get_nextState() = 1
...
function Anon_3689699d_get_iterator_k_() as Object
    return m.iterator
end function

function Anon_3689699d_get_index_k_() as Integer
    return m.index
end function

sub Anon_3689699d_set_index_I_k_(value as Integer)
    m.index = value
end sub

function Anon_3689699d_get_nextState_k_() as Integer
    return m.nextState
end function

sub Anon_3689699d_set_nextState_I_k_(value as Integer)
    m.nextState = value
end sub

function Anon_3689699d_get_nextItem_k_() as Dynamic
    return m.nextItem
end function

sub Anon_3689699d_set_nextItem_AnyN_k_(value as Dynamic)
    m.nextItem = value
end sub

function Anon_77b3fc21_create_FlatteningSequence_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_77b3fc21"
    this.__proto = ["Anon_77b3fc21", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.next_k_ = Anon_77b3fc21_next_k_
    this.hasNext_k_ = Anon_77b3fc21_hasNext_k_
    this.ensureItemIterator_k_ = Anon_77b3fc21_ensureItemIterator_k_
    this.get_iterator = Anon_77b3fc21_get_iterator_k_
    this.get_itemIterator = Anon_77b3fc21_get_itemIterator_k_
    this.set_itemIterator = Anon_77b3fc21_set_itemIterator_IteratorN_k_
    this.iterator = this_0.get_sequence().iterator_k_()
...
function Anon_77b3fc21_next_k_() as Dynamic
...
function Anon_77b3fc21_hasNext_k_() as Boolean
    return m.ensureItemIterator_k_()
end function

function Anon_77b3fc21_ensureItemIterator_k_() as Boolean
...
function Anon_77b3fc21_get_iterator_k_() as Object
    return m.iterator
end function

function Anon_77b3fc21_get_itemIterator_k_() as Dynamic
    return m.itemIterator
end function

sub Anon_77b3fc21_set_itemIterator_IteratorN_k_(value as Dynamic)
    m.itemIterator = value
end sub

function Anon_37675fc7_create_TakingSequence_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_37675fc7"
    this.__proto = ["Anon_37675fc7", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.next_k_ = Anon_37675fc7_next_k_
    this.hasNext_k_ = Anon_37675fc7_hasNext_k_
    this.get_left = Anon_37675fc7_get_left_k_
    this.set_left = Anon_37675fc7_set_left_I_k_
    this.get_iterator = Anon_37675fc7_get_iterator_k_
    this.left = this_0.get_count()
    this.iterator = this_0.get_sequence().iterator_k_()
    return this
end function

function Anon_37675fc7_next_k_() as Dynamic
...
function Anon_37675fc7_hasNext_k_() as Boolean
    return (m.get_left() > 0) and m.get_iterator().hasNext_k_()
end function

function Anon_37675fc7_get_left_k_() as Integer
    return m.left
end function

sub Anon_37675fc7_set_left_I_k_(value as Integer)
    m.left = value
end sub

function Anon_37675fc7_get_iterator_k_() as Object
    return m.iterator
end function

function Anon_46e123d2_create_TakingWhileSequence_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_46e123d2"
    this.__proto = ["Anon_46e123d2", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.calcNext_k_ = Anon_46e123d2_calcNext_k_
    this.next_k_ = Anon_46e123d2_next_k_
    this.hasNext_k_ = Anon_46e123d2_hasNext_k_
    this.get_iterator = Anon_46e123d2_get_iterator_k_
    this.get_nextState = Anon_46e123d2_get_nextState_k_
    this.set_nextState = Anon_46e123d2_set_nextState_I_k_
    this.get_nextItem = Anon_46e123d2_get_nextItem_k_
    this.set_nextItem = Anon_46e123d2_set_nextItem_AnyN_k_
    this.iterator = this_0.get_sequence().iterator_k_()
    this.nextState = -1
    this.nextItem = invalid
    this.this_0 = this_0
...
function Anon_46e123d2_next_k_() as Dynamic
    if m.get_nextState() = -1 then
        m.calcNext_k_()
    end if
    if m.get_nextState() = 0 then
...
function Anon_46e123d2_hasNext_k_() as Boolean
    if m.get_nextState() = -1 then
        m.calcNext_k_()
    end if
    return m.get_nextState() = 1
...
function Anon_46e123d2_get_iterator_k_() as Object
    return m.iterator
end function

function Anon_46e123d2_get_nextState_k_() as Integer
    return m.nextState
end function

sub Anon_46e123d2_set_nextState_I_k_(value as Integer)
    m.nextState = value
end sub

function Anon_46e123d2_get_nextItem_k_() as Dynamic
    return m.nextItem
end function

sub Anon_46e123d2_set_nextItem_AnyN_k_(value as Dynamic)
    m.nextItem = value
end sub

function Anon_35674b5a_create_DroppingSequence_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_35674b5a"
    this.__proto = ["Anon_35674b5a", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.drop_k_ = Anon_35674b5a_drop_k_
    this.next_k_ = Anon_35674b5a_next_k_
    this.hasNext_k_ = Anon_35674b5a_hasNext_k_
    this.get_iterator = Anon_35674b5a_get_iterator_k_
    this.get_left = Anon_35674b5a_get_left_k_
    this.set_left = Anon_35674b5a_set_left_I_k_
    this.iterator = this_0.get_sequence().iterator_k_()
    this.left = this_0.get_count()
    return this
end function

sub Anon_35674b5a_drop_k_()
...
function Anon_35674b5a_next_k_() as Dynamic
    m.drop_k_()
    return m.get_iterator().next_k_()
end function

function Anon_35674b5a_hasNext_k_() as Boolean
    m.drop_k_()
    return m.get_iterator().hasNext_k_()
end function

function Anon_35674b5a_get_iterator_k_() as Object
    return m.iterator
end function

function Anon_35674b5a_get_left_k_() as Integer
    return m.left
end function

sub Anon_35674b5a_set_left_I_k_(value as Integer)
    m.left = value
end sub

function Anon_29f88f79_create_DroppingWhileSequence_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_29f88f79"
    this.__proto = ["Anon_29f88f79", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.drop_k_ = Anon_29f88f79_drop_k_
    this.next_k_ = Anon_29f88f79_next_k_
    this.hasNext_k_ = Anon_29f88f79_hasNext_k_
    this.get_iterator = Anon_29f88f79_get_iterator_k_
    this.get_dropState = Anon_29f88f79_get_dropState_k_
    this.set_dropState = Anon_29f88f79_set_dropState_I_k_
    this.get_nextItem = Anon_29f88f79_get_nextItem_k_
    this.set_nextItem = Anon_29f88f79_set_nextItem_AnyN_k_
    this.iterator = this_0.get_sequence().iterator_k_()
    this.dropState = -1
    this.nextItem = invalid
    this.this_0 = this_0
...
function Anon_29f88f79_next_k_() as Dynamic
...
function Anon_29f88f79_hasNext_k_() as Boolean
    if m.get_dropState() = -1 then
        m.drop_k_()
    end if
...
function Anon_29f88f79_get_iterator_k_() as Object
    return m.iterator
end function

function Anon_29f88f79_get_dropState_k_() as Integer
    return m.dropState
end function

sub Anon_29f88f79_set_dropState_I_k_(value as Integer)
    m.dropState = value
end sub

function Anon_29f88f79_get_nextItem_k_() as Dynamic
    return m.nextItem
end function

sub Anon_29f88f79_set_nextItem_AnyN_k_(value as Dynamic)
    m.nextItem = value
end sub

function Anon_f3e36aa_create_SubSequence_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_f3e36aa"
    this.__proto = ["Anon_f3e36aa", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.drop_k_ = Anon_f3e36aa_drop_k_
    this.hasNext_k_ = Anon_f3e36aa_hasNext_k_
    this.next_k_ = Anon_f3e36aa_next_k_
    this.get_iterator = Anon_f3e36aa_get_iterator_k_
    this.get_position = Anon_f3e36aa_get_position_k_
    this.set_position = Anon_f3e36aa_set_position_I_k_
    this.iterator = this_0.get_sequence().iterator_k_()
    this.position = 0
    this.this_0 = this_0
    return this
...
function Anon_f3e36aa_hasNext_k_() as Boolean
    m.drop_k_()
    return (m.get_position() < m.this_0.get_endIndex()) and m.get_iterator().hasNext_k_()
end function

function Anon_f3e36aa_next_k_() as Dynamic
    m.drop_k_()
...
function Anon_f3e36aa_get_iterator_k_() as Object
    return m.iterator
end function

function Anon_f3e36aa_get_position_k_() as Integer
    return m.position
end function

sub Anon_f3e36aa_set_position_I_k_(value as Integer)
    m.position = value
end sub

function Anon_134b192e_create_DistinctSequence_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_134b192e"
    this.__proto = ["Anon_134b192e", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.calcNext_k_ = Anon_134b192e_calcNext_k_
    this.hasNext_k_ = Anon_134b192e_hasNext_k_
    this.next_k_ = Anon_134b192e_next_k_
    this.get_sourceIterator = Anon_134b192e_get_sourceIterator_k_
    this.get_observed = Anon_134b192e_get_observed_k_
    this.get_nextValue = Anon_134b192e_get_nextValue_k_
    this.set_nextValue = Anon_134b192e_set_nextValue_AnyN_k_
    this.get_nextState = Anon_134b192e_get_nextState_k_
    this.set_nextState = Anon_134b192e_set_nextState_I_k_
...
function Anon_134b192e_get_sourceIterator_k_() as Object
    return m.sourceIterator
end function

function Anon_134b192e_get_observed_k_() as Object
    return m.observed
end function

function Anon_134b192e_get_nextValue_k_() as Dynamic
    return m.nextValue
end function

sub Anon_134b192e_set_nextValue_AnyN_k_(value as Dynamic)
    m.nextValue = value
end sub

function Anon_134b192e_get_nextState_k_() as Integer
    return m.nextState
end function

sub Anon_134b192e_set_nextState_I_k_(value as Integer)
    m.nextState = value
end sub

function Anon_7d5561c3_create_MergingSequence_k_(this_0 as Object) as Object
    this = {}
    ...
    this.get_iterator1 = Anon_7d5561c3_get_iterator1_k_
    this.get_iterator2 = Anon_7d5561c3_get_iterator2_k_
...
function Anon_7d5561c3_get_iterator1_k_() as Object
    return m.iterator1
end function

function Anon_7d5561c3_get_iterator2_k_() as Object
    return m.iterator2
end function
