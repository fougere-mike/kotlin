function __get_PI_k_() as Double
    return 3.141592653589793#
end function

function __get_E_k_() as Double
...
function __get_absoluteValue_rD_k_(m as Double) as Double
    return abs_D_k_(m)
end function

function __get_sign_rD_k_(m as Double) as Double
    return sign_D_k_(m)
end function
...
function __get_ulp_rD_k_(m as Double) as Double
...
function __get_absoluteValue_rF_k_(m as Float) as Float
    return abs_F_k_(m)
end function

function __get_sign_rF_k_(m as Float) as Float
    return sign_F_k_(m)
end function
...
function __get_absoluteValue_rI_k_(m as Integer) as Integer
    return abs_I_k_(m)
end function

function __get_sign_rI_k_(m as Integer) as Integer
...
function __get_absoluteValue_rJ_k_(m as LongInteger) as LongInteger
    return abs_J_k_(m)
end function

function __get_sign_rJ_k_(m as LongInteger) as Integer
