...
function Regex_splitToSequence_CharSequence_I_k_(input as Object, limit = 0) as Object
    ...
    return Sequence_Function0Iterator_k_({__this: m, input: input, limit: limit, invoke: function() as Object
        return Anon_3627e490_create_Regex_CharSequence_I_k_(m, m.input, m.limit)
    end function})
end function
...
function Regex_createMatchResult_Str_Arr_I_k_(input as String, matchArray as Object, matchIndex as Integer) as Object
    return Anon_717b5b6e_create_I_Arr_Str_Regex_k_(matchIndex, matchArray, input, m)
end function
...
function Anon_3627e490_create_Regex_CharSequence_I_k_(this_0 as Object, _input as Object, _limit as Integer) as Object
    this = {}
    this.__type = "Anon_3627e490"
    this.__proto = ["Anon_3627e490", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.hasNext_k_ = Anon_3627e490_hasNext_k_
    this.next_k_ = Anon_3627e490_next_k_
    this.get_match = Anon_3627e490_get_match_k_
    this.set_match = Anon_3627e490_set_match_MatchResultN_k_
    this.get_firstMatch = Anon_3627e490_get_firstMatch_k_
    this.get_nextStart = Anon_3627e490_get_nextStart_k_
    this.set_nextStart = Anon_3627e490_set_nextStart_I_k_
    this.get_splitCount = Anon_3627e490_get_splitCount_k_
    this.set_splitCount = Anon_3627e490_set_splitCount_I_k_
    this.get_emitted = Anon_3627e490_get_emitted_k_
    this.set_emitted = Anon_3627e490_set_emitted_Z_k_
...
function Anon_3627e490_hasNext_k_() as Boolean
...
function Anon_3627e490_next_k_() as String
...
function Anon_3627e490_get_match_k_() as Dynamic
    return m.match
end function

sub Anon_3627e490_set_match_MatchResultN_k_(value as Dynamic)
    m.match = value
end sub

function Anon_3627e490_get_firstMatch_k_() as Dynamic
    return m.firstMatch
end function

function Anon_3627e490_get_nextStart_k_() as Integer
    return m.nextStart
end function

sub Anon_3627e490_set_nextStart_I_k_(value as Integer)
    m.nextStart = value
end sub

function Anon_3627e490_get_splitCount_k_() as Integer
    return m.splitCount
end function

sub Anon_3627e490_set_splitCount_I_k_(value as Integer)
    m.splitCount = value
end sub

function Anon_3627e490_get_emitted_k_() as Boolean
    return m.emitted
end function

sub Anon_3627e490_set_emitted_Z_k_(value as Boolean)
    m.emitted = value
end sub

function Anon_11478a2b_create_Anon_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_11478a2b"
    this.__proto = ["Anon_11478a2b", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.hasNext_k_ = Anon_11478a2b_hasNext_k_
    this.next_k_ = Anon_11478a2b_next_k_
    this.get_index = Anon_11478a2b_get_index_k_
    this.set_index = Anon_11478a2b_set_index_I_k_
    this.index = 0
    this.this_0 = this_0
    return this
end function

function Anon_11478a2b_hasNext_k_() as Boolean
    return m.get_index() < m.this_0.get_size()
end function

function Anon_11478a2b_next_k_() as Dynamic
    if not m.hasNext_k_() then
        throw NoSuchElementException_create_k_()
    end if
...
function Anon_11478a2b_get_index_k_() as Integer
    return m.index
end function

sub Anon_11478a2b_set_index_I_k_(value as Integer)
    m.index = value
end sub

function Anon_fe7ec2d_create_Arr_k_(_matchArray as Object) as Object
    this = {}
    this.__type = "Anon_fe7ec2d"
    this.__proto = ["Anon_fe7ec2d", "MatchGroupCollection", "Collection", "Iterable"]
    this.__id = __kotlin_nextObjectId()
    this.iterator_k_ = Anon_fe7ec2d_iterator_k_
    this.get_I_k_ = Anon_fe7ec2d_get_I_k_
    this.contains_MatchGroupN_k_ = Anon_fe7ec2d_contains_MatchGroupN_k_
    this.containsAll_CollectionMatchGroupN_k_ = Anon_fe7ec2d_containsAll_CollectionMatchGroupN_k_
    this.isEmpty_k_ = Anon_fe7ec2d_isEmpty_k_
    this.get_size = Anon_fe7ec2d_get_size_k_
    this._matchArray = _matchArray
    return this
end function

function Anon_fe7ec2d_iterator_k_() as Object
    return Anon_11478a2b_create_Anon_k_(m)
end function

function Anon_fe7ec2d_get_I_k_(index as Integer) as Dynamic
...
function Anon_fe7ec2d_contains_MatchGroupN_k_(element as Dynamic) as Boolean
...
function Anon_fe7ec2d_containsAll_CollectionMatchGroupN_k_(elements as Object) as Boolean
...
function Anon_fe7ec2d_isEmpty_k_() as Boolean
    return m.get_size() = 0
end function

function Anon_fe7ec2d_get_size_k_() as Integer
    return m._matchArray.count()
end function

function Anon_bfe47c8_create_Anon_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_bfe47c8"
    this.__proto = ["Anon_bfe47c8", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.hasNext_k_ = Anon_bfe47c8_hasNext_k_
    this.next_k_ = Anon_bfe47c8_next_k_
    this.get_index = Anon_bfe47c8_get_index_k_
    this.set_index = Anon_bfe47c8_set_index_I_k_
    this.index = 0
    this.this_0 = this_0
    return this
end function

function Anon_bfe47c8_hasNext_k_() as Boolean
    return m.get_index() < m.this_0.get_size()
end function

function Anon_bfe47c8_next_k_() as String
    if not m.hasNext_k_() then
        throw NoSuchElementException_create_k_()
    end if
...
function Anon_bfe47c8_get_index_k_() as Integer
    return m.index
end function

sub Anon_bfe47c8_set_index_I_k_(value as Integer)
    m.index = value
end sub

function Anon_412179f9_create_I_Anon_k_(_index as Integer, this_0 as Object) as Object
    this = {}
    this.__type = "Anon_412179f9"
    this.__proto = ["Anon_412179f9", "ListIterator", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.hasNext_k_ = Anon_412179f9_hasNext_k_
    this.hasPrevious_k_ = Anon_412179f9_hasPrevious_k_
    this.next_k_ = Anon_412179f9_next_k_
    this.nextIndex_k_ = Anon_412179f9_nextIndex_k_
    this.previous_k_ = Anon_412179f9_previous_k_
    this.previousIndex_k_ = Anon_412179f9_previousIndex_k_
    this.get_currentIndex = Anon_412179f9_get_currentIndex_k_
    this.set_currentIndex = Anon_412179f9_set_currentIndex_I_k_
    this.currentIndex = _index
    this.this_0 = this_0
    return this
end function

function Anon_412179f9_hasNext_k_() as Boolean
    return m.get_currentIndex() < m.this_0.get_size()
end function

function Anon_412179f9_hasPrevious_k_() as Boolean
    return m.get_currentIndex() > 0
end function

function Anon_412179f9_next_k_() as String
    if not m.hasNext_k_() then
        throw NoSuchElementException_create_k_()
    end if
...
function Anon_412179f9_nextIndex_k_() as Integer
    return m.get_currentIndex()
end function

function Anon_412179f9_previous_k_() as String
...
function Anon_412179f9_previousIndex_k_() as Integer
    return m.get_currentIndex() - 1
end function

function Anon_412179f9_get_currentIndex_k_() as Integer
    return m.currentIndex
end function

sub Anon_412179f9_set_currentIndex_I_k_(value as Integer)
    m.currentIndex = value
end sub

function Anon_2d47725a_create_Anon_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_2d47725a"
    this.__proto = ["Anon_2d47725a", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.hasNext_k_ = Anon_2d47725a_hasNext_k_
    this.next_k_ = Anon_2d47725a_next_k_
    this.get_index = Anon_2d47725a_get_index_k_
    this.set_index = Anon_2d47725a_set_index_I_k_
    this.index = 0
    this.this_0 = this_0
    return this
end function

function Anon_2d47725a_hasNext_k_() as Boolean
    return m.get_index() < m.this_0.get_size()
end function

function Anon_2d47725a_next_k_() as String
    if not m.hasNext_k_() then
        throw NoSuchElementException_create_k_()
    end if
...
function Anon_2d47725a_get_index_k_() as Integer
    return m.index
end function

sub Anon_2d47725a_set_index_I_k_(value as Integer)
    m.index = value
end sub

function Anon_17977d1_create_I_Anon_k_(_index as Integer, this_0 as Object) as Object
    this = {}
    this.__type = "Anon_17977d1"
    this.__proto = ["Anon_17977d1", "ListIterator", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.hasNext_k_ = Anon_17977d1_hasNext_k_
    this.hasPrevious_k_ = Anon_17977d1_hasPrevious_k_
    this.next_k_ = Anon_17977d1_next_k_
    this.nextIndex_k_ = Anon_17977d1_nextIndex_k_
    this.previous_k_ = Anon_17977d1_previous_k_
    this.previousIndex_k_ = Anon_17977d1_previousIndex_k_
    this.get_currentIndex = Anon_17977d1_get_currentIndex_k_
    this.set_currentIndex = Anon_17977d1_set_currentIndex_I_k_
    this.currentIndex = _index
    this.this_0 = this_0
    return this
end function

function Anon_17977d1_hasNext_k_() as Boolean
    return m.get_currentIndex() < m.this_0.get_size()
end function

function Anon_17977d1_hasPrevious_k_() as Boolean
    return m.get_currentIndex() > 0
end function

function Anon_17977d1_next_k_() as String
    if not m.hasNext_k_() then
        throw NoSuchElementException_create_k_()
    end if
...
function Anon_17977d1_nextIndex_k_() as Integer
    return m.get_currentIndex()
end function

function Anon_17977d1_previous_k_() as String
    if not m.hasPrevious_k_() then
        throw NoSuchElementException_create_k_()
    end if
    return m.this_0.get_I_k_(m.get_currentIndex())
...
function Anon_17977d1_previousIndex_k_() as Integer
    return m.get_currentIndex() - 1
end function

function Anon_17977d1_get_currentIndex_k_() as Integer
    return m.currentIndex
end function

sub Anon_17977d1_set_currentIndex_I_k_(value as Integer)
    m.currentIndex = value
end sub

function Anon_54bd714e_create_Anon_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_54bd714e"
    this.__proto = ["Anon_54bd714e", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.hasNext_k_ = Anon_54bd714e_hasNext_k_
    this.next_k_ = Anon_54bd714e_next_k_
    this.get_index = Anon_54bd714e_get_index_k_
    this.set_index = Anon_54bd714e_set_index_I_k_
    this.index = 0
    this.this_0 = this_0
    return this
end function

function Anon_54bd714e_hasNext_k_() as Boolean
    return m.get_index() < m.this_0.get_size()
end function

function Anon_54bd714e_next_k_() as String
    if not m.hasNext_k_() then
        throw NoSuchElementException_create_k_()
    end if
...
function Anon_54bd714e_get_index_k_() as Integer
    return m.index
end function

sub Anon_54bd714e_set_index_I_k_(value as Integer)
    m.index = value
end sub

function Anon_6fdf0b8a_create_I_Anon_k_(_index as Integer, this_0 as Object) as Object
    this = {}
    this.__type = "Anon_6fdf0b8a"
    this.__proto = ["Anon_6fdf0b8a", "ListIterator", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.hasNext_k_ = Anon_6fdf0b8a_hasNext_k_
    this.hasPrevious_k_ = Anon_6fdf0b8a_hasPrevious_k_
    this.next_k_ = Anon_6fdf0b8a_next_k_
    this.nextIndex_k_ = Anon_6fdf0b8a_nextIndex_k_
    this.previous_k_ = Anon_6fdf0b8a_previous_k_
    this.previousIndex_k_ = Anon_6fdf0b8a_previousIndex_k_
    this.get_currentIndex = Anon_6fdf0b8a_get_currentIndex_k_
    this.set_currentIndex = Anon_6fdf0b8a_set_currentIndex_I_k_
    this.currentIndex = _index
    this.this_0 = this_0
    return this
end function

function Anon_6fdf0b8a_hasNext_k_() as Boolean
    return m.get_currentIndex() < m.this_0.get_size()
end function

function Anon_6fdf0b8a_hasPrevious_k_() as Boolean
    return m.get_currentIndex() > 0
end function

function Anon_6fdf0b8a_next_k_() as String
    if not m.hasNext_k_() then
        throw NoSuchElementException_create_k_()
    end if
...
function Anon_6fdf0b8a_nextIndex_k_() as Integer
    return m.get_currentIndex()
end function

function Anon_6fdf0b8a_previous_k_() as String
    if not m.hasPrevious_k_() then
        throw NoSuchElementException_create_k_()
    end if
    return m.this_0.get_I_k_(m.get_currentIndex())
...
function Anon_6fdf0b8a_previousIndex_k_() as Integer
    return m.get_currentIndex() - 1
end function

function Anon_6fdf0b8a_get_currentIndex_k_() as Integer
    return m.currentIndex
end function

sub Anon_6fdf0b8a_set_currentIndex_I_k_(value as Integer)
    m.currentIndex = value
end sub

function Anon_79058b73_create_I_Arr_I_k_(_nestedSubSize as Integer, _matchArray as Object, _actualFromIndex as Integer) as Object
    this = {}
    this.__type = "Anon_79058b73"
    this.__proto = ["Anon_79058b73", "List", "Collection", "Iterable"]
    this.__id = __kotlin_nextObjectId()
    this.get_I_k_ = Anon_79058b73_get_I_k_
    this.indexOf_Str_k_ = Anon_79058b73_indexOf_Str_k_
    this.lastIndexOf_Str_k_ = Anon_79058b73_lastIndexOf_Str_k_
    this.isEmpty_k_ = Anon_79058b73_isEmpty_k_
    this.contains_Str_k_ = Anon_79058b73_contains_Str_k_
    this.containsAll_CollectionStr_k_ = Anon_79058b73_containsAll_CollectionStr_k_
    this.iterator_k_ = Anon_79058b73_iterator_k_
    this.listIterator_k_ = Anon_79058b73_listIterator_k_
    this.listIterator_I_k_ = Anon_79058b73_listIterator_I_k_
    this.subList_I_I_k_ = Anon_79058b73_subList_I_I_k_
    this.get_size = Anon_79058b73_get_size_k_
...
function Anon_79058b73_get_I_k_(index as Integer) as String
...
function Anon_79058b73_indexOf_Str_k_(element as String) as Integer
    progression = until_rI_I_k_(0, m.get_size())
    inductionVariable = progression.get_first()
    last = progression.get_last()
    if inductionVariable <= last then
...
function Anon_79058b73_lastIndexOf_Str_k_(element as String) as Integer
...
function Anon_79058b73_isEmpty_k_() as Boolean
    return m.get_size() = 0
end function

function Anon_79058b73_contains_Str_k_(element as String) as Boolean
    return m.indexOf_Str_k_(element) >= 0
end function

function Anon_79058b73_containsAll_CollectionStr_k_(elements as Object) as Boolean
...
function Anon_79058b73_iterator_k_() as Object
    return Anon_54bd714e_create_Anon_k_(m)
end function

function Anon_79058b73_listIterator_k_() as Object
    return m.listIterator_I_k_(0)
end function

function Anon_79058b73_listIterator_I_k_(index as Integer) as Object
    if (index < 0) or (index > m.get_size()) then
        throw IndexOutOfBoundsException_create_k_()
    end if
    return Anon_6fdf0b8a_create_I_Anon_k_(index, m)
end function

function Anon_79058b73_subList_I_I_k_(fromIndex as Integer, toIndex as Integer) as Object
...
function Anon_79058b73_get_size_k_() as Integer
    return m.size
end function

function Anon_38b32451_create_I_Arr_I_k_(_subSize as Integer, _matchArray as Object, _outerFromIndex as Integer) as Object
    this = {}
    this.__type = "Anon_38b32451"
    this.__proto = ["Anon_38b32451", "List", "Collection", "Iterable"]
    this.__id = __kotlin_nextObjectId()
    this.get_I_k_ = Anon_38b32451_get_I_k_
    this.indexOf_Str_k_ = Anon_38b32451_indexOf_Str_k_
    this.lastIndexOf_Str_k_ = Anon_38b32451_lastIndexOf_Str_k_
    this.isEmpty_k_ = Anon_38b32451_isEmpty_k_
    this.contains_Str_k_ = Anon_38b32451_contains_Str_k_
    this.containsAll_CollectionStr_k_ = Anon_38b32451_containsAll_CollectionStr_k_
    this.iterator_k_ = Anon_38b32451_iterator_k_
    this.listIterator_k_ = Anon_38b32451_listIterator_k_
    this.listIterator_I_k_ = Anon_38b32451_listIterator_I_k_
    this.subList_I_I_k_ = Anon_38b32451_subList_I_I_k_
    this.get_size = Anon_38b32451_get_size_k_
    this.size = _subSize
    this._matchArray = _matchArray
...
function Anon_38b32451_get_I_k_(index as Integer) as String
    if (index < 0) or (index >= m.get_size()) then
        throw IndexOutOfBoundsException_create_k_()
    end if
...
function Anon_38b32451_indexOf_Str_k_(element as String) as Integer
    progression = until_rI_I_k_(0, m.get_size())
    inductionVariable = progression.get_first()
    last = progression.get_last()
    if inductionVariable <= last then
...
function Anon_38b32451_lastIndexOf_Str_k_(element as String) as Integer
    inductionVariable = m.get_size() - 1
    if 0 <= inductionVariable then
                i = inductionVariable
        inductionVariable = (inductionVariable + -1)
...
function Anon_38b32451_isEmpty_k_() as Boolean
    return m.get_size() = 0
end function

function Anon_38b32451_contains_Str_k_(element as String) as Boolean
    return m.indexOf_Str_k_(element) >= 0
end function

function Anon_38b32451_containsAll_CollectionStr_k_(elements as Object) as Boolean
...
function Anon_38b32451_iterator_k_() as Object
    return Anon_2d47725a_create_Anon_k_(m)
end function

function Anon_38b32451_listIterator_k_() as Object
    return m.listIterator_I_k_(0)
end function

function Anon_38b32451_listIterator_I_k_(index as Integer) as Object
    if (index < 0) or (index > m.get_size()) then
        throw IndexOutOfBoundsException_create_k_()
    end if
    return Anon_17977d1_create_I_Anon_k_(index, m)
end function

function Anon_38b32451_subList_I_I_k_(fromIndex as Integer, toIndex as Integer) as Object
    if ((fromIndex < 0) or (toIndex > m.get_size())) or (fromIndex > toIndex) then
        throw IndexOutOfBoundsException_create_k_()
    end if
    ...
    return Anon_79058b73_create_I_Arr_I_k_(nestedSubSize, m._matchArray, actualFromIndex)
end function

function Anon_38b32451_get_size_k_() as Integer
    return m.size
end function

function Anon_5480d7b5_create_Arr_k_(_matchArray as Object) as Object
    this = {}
    this.__type = "Anon_5480d7b5"
    this.__proto = ["Anon_5480d7b5", "List", "Collection", "Iterable"]
    this.__id = __kotlin_nextObjectId()
    this.get_I_k_ = Anon_5480d7b5_get_I_k_
    this.indexOf_Str_k_ = Anon_5480d7b5_indexOf_Str_k_
    this.lastIndexOf_Str_k_ = Anon_5480d7b5_lastIndexOf_Str_k_
    this.isEmpty_k_ = Anon_5480d7b5_isEmpty_k_
    this.contains_Str_k_ = Anon_5480d7b5_contains_Str_k_
    this.containsAll_CollectionStr_k_ = Anon_5480d7b5_containsAll_CollectionStr_k_
    this.iterator_k_ = Anon_5480d7b5_iterator_k_
    this.listIterator_k_ = Anon_5480d7b5_listIterator_k_
    this.listIterator_I_k_ = Anon_5480d7b5_listIterator_I_k_
    this.subList_I_I_k_ = Anon_5480d7b5_subList_I_I_k_
    this.get_size = Anon_5480d7b5_get_size_k_
    this._matchArray = _matchArray
    return this
end function

function Anon_5480d7b5_get_I_k_(index as Integer) as String
...
function Anon_5480d7b5_indexOf_Str_k_(element as String) as Integer
    progression = until_rI_I_k_(0, m.get_size())
    inductionVariable = progression.get_first()
    last = progression.get_last()
    if inductionVariable <= last then
...
function Anon_5480d7b5_lastIndexOf_Str_k_(element as String) as Integer
    inductionVariable = m.get_size() - 1
    if 0 <= inductionVariable then
                i = inductionVariable
        inductionVariable = (inductionVariable + -1)
...
function Anon_5480d7b5_isEmpty_k_() as Boolean
    return m.get_size() = 0
end function

function Anon_5480d7b5_contains_Str_k_(element as String) as Boolean
    return m.indexOf_Str_k_(element) >= 0
end function

function Anon_5480d7b5_containsAll_CollectionStr_k_(elements as Object) as Boolean
...
function Anon_5480d7b5_iterator_k_() as Object
    return Anon_bfe47c8_create_Anon_k_(m)
end function

function Anon_5480d7b5_listIterator_k_() as Object
    return m.listIterator_I_k_(0)
end function

function Anon_5480d7b5_listIterator_I_k_(index as Integer) as Object
    if (index < 0) or (index > m.get_size()) then
        throw IndexOutOfBoundsException_create_k_()
    end if
    return Anon_412179f9_create_I_Anon_k_(index, m)
end function

function Anon_5480d7b5_subList_I_I_k_(fromIndex as Integer, toIndex as Integer) as Object
    if ((fromIndex < 0) or (toIndex > m.get_size())) or (fromIndex > toIndex) then
        throw IndexOutOfBoundsException_create_k_()
    end if
    outerFromIndex = fromIndex
    subSize = toIndex - fromIndex
    return Anon_38b32451_create_I_Arr_I_k_(subSize, m._matchArray, outerFromIndex)
end function

function Anon_5480d7b5_get_size_k_() as Integer
    return m._matchArray.count()
end function

function Anon_717b5b6e_create_I_Arr_Str_Regex_k_(_matchIndex as Integer, _matchArray as Object, _input as String, this_0 as Object) as Object
    this = {}
    this.__type = "Anon_717b5b6e"
    this.__proto = ["Anon_717b5b6e", "MatchResult"]
    this.__id = __kotlin_nextObjectId()
    this.next_k_ = Anon_717b5b6e_next_k_
    this.get_range = Anon_717b5b6e_get_range_k_
    this.get_value = Anon_717b5b6e_get_value_k_
    this.get_groups = Anon_717b5b6e_get_groups_k_
    this.get_groupValues_ = Anon_717b5b6e_get_groupValues__k_
    this.set_groupValues_ = Anon_717b5b6e_set_groupValues__ListStrN_k_
    this.get_groupValues = Anon_717b5b6e_get_groupValues_k_
    this.range = until_rI_I_k_(_matchIndex, _matchIndex + Len(_matchArray[0]))
    this.value = _matchArray[0]
    this.groups = Anon_fe7ec2d_create_Arr_k_(_matchArray)
...
function Anon_717b5b6e_next_k_() as Dynamic
    __when_tmp3 = invalid
...
function Anon_717b5b6e_get_range_k_() as Object
    return m.range
end function

function Anon_717b5b6e_get_value_k_() as String
    return m.value
end function

function Anon_717b5b6e_get_groups_k_() as Object
    return m.groups
end function

function Anon_717b5b6e_get_groupValues__k_() as Dynamic
    return m.groupValues_
end function

sub Anon_717b5b6e_set_groupValues__ListStrN_k_(value as Dynamic)
    m.groupValues_ = value
end sub

function Anon_717b5b6e_get_groupValues_k_() as Object
    if m.get_groupValues_() = invalid then
        m.set_groupValues_(Anon_5480d7b5_create_Arr_k_(m._matchArray))
    end if
