...
function Lazy_get_value_k_() as Dynamic
end function
...
function LazyThreadSafetyMode_create_k_(__name as String, __ordinal as Integer) as Object
    ...
    this.values_k_ = LazyThreadSafetyMode_values_k_
    this.valueOf_Str_k_ = LazyThreadSafetyMode_valueOf_Str_k_
    this.get_entries = LazyThreadSafetyMode_get_entries_k_
    return this
end function
