...
function buildMapInternal_Function1MutableMapAnyNAnyNV_MapAnyNAnyN_k_(builderAction as Function) as Object
    map = HashMap_create_HashMapAnyNAnyN_k_()
    builderAction.invoke(map)
    return map
end function

function buildMapInternal_I_Function1MutableMapAnyNAnyNV_MapAnyNAnyN_k_(capacity as Integer, builderAction as Function) as Object
