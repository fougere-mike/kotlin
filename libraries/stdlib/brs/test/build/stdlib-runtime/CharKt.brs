function Char_create_k_() as Object
    ...
    this.compareTo_AnyN_k_ = Char_compareTo_AnyN_k_
...
function Char_compareTo_AnyN_k_(other as Object) as Integer
end function
...
function Char_Companion_create_k_() as Object
    ...
    this.hashCode = Any_hashCode_k_
    this.toString = Any_toString_k_
    this.__get_MIN_VALUE = Char_Companion___get_MIN_VALUE_k_
    this.__get_MAX_VALUE = Char_Companion___get_MAX_VALUE_k_
    this.__get_MIN_HIGH_SURROGATE = Char_Companion___get_MIN_HIGH_SURROGATE_k_
    this.__get_MAX_HIGH_SURROGATE = Char_Companion___get_MAX_HIGH_SURROGATE_k_
    this.__get_MIN_LOW_SURROGATE = Char_Companion___get_MIN_LOW_SURROGATE_k_
    this.__get_MAX_LOW_SURROGATE = Char_Companion___get_MAX_LOW_SURROGATE_k_
    this.__get_MIN_SURROGATE = Char_Companion___get_MIN_SURROGATE_k_
    this.__get_MAX_SURROGATE = Char_Companion___get_MAX_SURROGATE_k_
    this.__get_SIZE_BYTES = Char_Companion___get_SIZE_BYTES_k_
    this.__get_SIZE_BITS = Char_Companion___get_SIZE_BITS_k_
    this.MIN_VALUE = ""
    this.MAX_VALUE = "￿"
...
function Char_Companion___get_MIN_VALUE_k_() as Object
    return m.MIN_VALUE
end function

function Char_Companion___get_MAX_VALUE_k_() as Object
    return m.MAX_VALUE
end function

function Char_Companion___get_MIN_HIGH_SURROGATE_k_() as Object
    return m.MIN_HIGH_SURROGATE
end function

function Char_Companion___get_MAX_HIGH_SURROGATE_k_() as Object
    return m.MAX_HIGH_SURROGATE
end function

function Char_Companion___get_MIN_LOW_SURROGATE_k_() as Object
    return m.MIN_LOW_SURROGATE
end function

function Char_Companion___get_MAX_LOW_SURROGATE_k_() as Object
    return m.MAX_LOW_SURROGATE
end function

function Char_Companion___get_MIN_SURROGATE_k_() as Object
    return m.MIN_SURROGATE
end function

function Char_Companion___get_MAX_SURROGATE_k_() as Object
    return m.MAX_SURROGATE
end function

function Char_Companion___get_SIZE_BYTES_k_() as Integer
    return m.SIZE_BYTES
end function

function Char_Companion___get_SIZE_BITS_k_() as Integer
    return m.SIZE_BITS
end function
