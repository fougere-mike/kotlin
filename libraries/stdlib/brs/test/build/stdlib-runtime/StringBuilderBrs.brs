function StringBuilder_create_Str_k_(content as String) as Object
    ...
    this.get_string = StringBuilder_get_string_k_
    this.set_string = StringBuilder_set_string_Str_k_
    this.get_length = StringBuilder_get_length_k_
    this.string = content
    return this
end function
...
function StringBuilder_subSequence_I_I_k_(startIndex as Integer, endIndex as Integer) as Object
    return substring_rStr_I_I_k_(m.get_string(), startIndex, endIndex)
end function
...
function StringBuilder_append_CharSequenceN_k_(value as Dynamic) as Object
    m.set_string(m.get_string() + toString_AnyN_k_(value))
    return m
end function
...
function StringBuilder_reverse_k_() as Object
    ...
    while index >= 0
        __incr_tmp_40 = index
        index = (__incr_tmp_40 - 1)

        low = m.get_string().get_I_k_(__incr_tmp_40)
        if isLowSurrogate_rC_k_(low) and (index >= 0) then
            __incr_tmp_41 = index
            index = (__incr_tmp_41 - 1)

            high = m.get_string().get_I_k_(__incr_tmp_41)
...
function StringBuilder_append_Z_k_(value as Boolean) as Object
    m.set_string(m.get_string() + ((function(value)
...
function StringBuilder_append_CharArray_k_(value as Object) as Object
    m.set_string(m.get_string() + concatToString_rCharArray_k_(value))
    return m
end function
...
function StringBuilder_indexOf_Str_k_(string_ as String) as Integer
    return indexOf_rStr_Str_I_Z_k_(m.get_string(), string_, invalid, invalid)
end function

function StringBuilder_indexOf_Str_I_k_(string_ as String, startIndex as Integer) as Integer
    return indexOf_rStr_Str_I_Z_k_(m.get_string(), string_, startIndex, invalid)
end function

function StringBuilder_lastIndexOf_Str_k_(string_ as String) as Integer
    return lastIndexOf_rStr_Str_I_Z_k_(m.get_string(), string_, invalid, invalid)
end function
...
function StringBuilder_lastIndexOf_Str_I_k_(string_ as String, startIndex as Integer) as Integer
    ...
    return lastIndexOf_rStr_Str_I_Z_k_(m.get_string(), string_, startIndex, invalid)
end function
...
function StringBuilder_insert_I_Z_k_(index as Integer, value as Boolean) as Object
    ...
    m.set_string((substring_rStr_I_I_k_(m.get_string(), 0, index) + ((function(value)
        if value then return "true" else return "false"
    end function)(value))) + substring_rStr_I_k_(m.get_string(), index))
    return m
end function
...
function StringBuilder_insert_I_CharArray_k_(index as Integer, value as Object) as Object
    checkPositionIndex_I_I_k_(index, m.get_length())
    m.set_string((substring_rStr_I_I_k_(m.get_string(), 0, index) + concatToString_rCharArray_k_(value)) + substring_rStr_I_k_(m.get_string(), index))
    return m
end function

function StringBuilder_insert_I_CharSequenceN_k_(index as Integer, value as Dynamic) as Object
    checkPositionIndex_I_I_k_(index, m.get_length())
    m.set_string((substring_rStr_I_I_k_(m.get_string(), 0, index) + toString_AnyN_k_(value)) + substring_rStr_I_k_(m.get_string(), index))
    return m
end function
...
function StringBuilder_insert_I_StrN_k_(index as Integer, value as Dynamic) as Object
    ...
    m.set_string((substring_rStr_I_I_k_(m.get_string(), 0, index) + toInsert) + substring_rStr_I_k_(m.get_string(), index))
    return m
end function
...
sub StringBuilder_setLength_I_k_(newLength as Integer)
    ...
    if newLength <= m.get_length() then
        m.set_string(substring_rStr_I_I_k_(m.get_string(), 0, newLength))
    else if true then
        progression = until_rI_I_k_(m.get_length(), newLength)
...
function StringBuilder_substring_I_k_(startIndex as Integer) as String
    ...
    return substring_rStr_I_k_(m.get_string(), startIndex)
end function
...
function StringBuilder_setRange_I_I_Str_k_(startIndex as Integer, endIndex as Integer, value as String) as Object
    ...
    m.set_string((substring_rStr_I_I_k_(m.get_string(), 0, startIndex) + value) + substring_rStr_I_k_(m.get_string(), endIndex))
    return m
end function
...
function StringBuilder_deleteAt_I_k_(index as Integer) as Object
    checkElementIndex_I_I_k_(index, m.get_length())
    m.set_string(substring_rStr_I_I_k_(m.get_string(), 0, index) + substring_rStr_I_k_(m.get_string(), index + 1))
    return m
end function

function StringBuilder_deleteRange_I_I_k_(startIndex as Integer, endIndex as Integer) as Object
    m.checkReplaceRange_I_I_I_k_(startIndex, endIndex, m.get_length())
    m.set_string(substring_rStr_I_I_k_(m.get_string(), 0, startIndex) + substring_rStr_I_k_(m.get_string(), endIndex))
    return m
end function
...
sub StringBuilder_toCharArray_CharArray_I_I_I_k_(destination as Object, destinationOffset = 0, startIndex = 0, endIndex = m.get_length())
    ...
    if inductionVariable <= last then
        ...
        __incr_tmp_42 = dstIndex
        dstIndex = (__incr_tmp_42 + 1)

        destination.set_I_C_k_(__incr_tmp_42, m.get_string().get_I_k_(index))
...
function StringBuilder_appendRange_CharArray_I_I_k_(value as Object, startIndex as Integer, endIndex as Integer) as Object
    m.set_string(m.get_string() + concatToString_rCharArray_I_I_k_(value, startIndex, endIndex))
    return m
end function
...
function StringBuilder_appendRange_CharSequence_I_I_k_(value as Object, startIndex as Integer, endIndex as Integer) as Object
    ...
    m.set_string(m.get_string() + substring_rStr_I_I_k_(stringCsq, startIndex, endIndex))
    return m
end function
...
function StringBuilder_insertRange_I_CharArray_I_I_k_(index as Integer, value as Object, startIndex as Integer, endIndex as Integer) as Object
    checkPositionIndex_I_I_k_(index, m.get_length())
    m.set_string((substring_rStr_I_I_k_(m.get_string(), 0, index) + concatToString_rCharArray_I_I_k_(value, startIndex, endIndex)) + substring_rStr_I_k_(m.get_string(), index))
    return m
end function
...
function StringBuilder_insertRange_I_CharSequence_I_I_k_(index as Integer, value as Object, startIndex as Integer, endIndex as Integer) as Object
    ...
    stringCsq = toString_AnyN_k_(value)
    checkBoundsIndexes_I_I_I_k_(startIndex, endIndex, Len(stringCsq))
    m.set_string((substring_rStr_I_I_k_(m.get_string(), 0, index) + substring_rStr_I_I_k_(stringCsq, startIndex, endIndex)) + substring_rStr_I_k_(m.get_string(), index))
    return m
end function
...
function StringBuilder_get_string_k_() as String
    return m.string
end function
...
function StringBuilder_get_length_k_() as Integer
