...
function StringBuilder_get_I_C_k_(index as Integer) as Object
    return getOrElse_rStr_I_Function1IC_C_k_(m.string, index, {index: index, this: this, invoke: function(it as Integer) as Object
        throw IndexOutOfBoundsException_create_StrN_IndexOutOfBoundsException_k_(((("index: " + m.index) + ", length: ") + m.this.length) + "}")
    end function})
end function

function StringBuilder_subSequence_I_I_CharSequence_k_(startIndex as Integer, endIndex as Integer) as Object
    return substring_rStr_I_I_Str_k_(m.string, startIndex, endIndex)
end function

function StringBuilder_append_C_StringBuilder_k_(value as Object) as Object
    m.string = (m.string + value)
    return m
end function

function StringBuilder_append_CharSequenceN_StringBuilder_k_(value as Dynamic) as Object
    m.string = (m.string + value.toString())
    return m
end function
...
function StringBuilder_append_CharSequenceN_I_I_StringBuilder_k_(value as Dynamic, startIndex as Integer, endIndex as Integer) as Object
    ...
    return m.appendRange(__when_tmp0, startIndex, endIndex)

end function

function StringBuilder_reverse_StringBuilder_k_() as Object
    reversed = ""
    index = m.string.length - 1
    while index >= 0
        low = m.string[index = (index - 1)]
        if isLowSurrogate_rC_Z_k_(low) and (index >= 0) then
            high = m.string[index = (index - 1)]
...
function StringBuilder_append_CharArray_StringBuilder_k_(value as Object) as Object
    m.string = (m.string + concatToString_rCharArray_Str_k_(value))
    return m
end function
...
function StringBuilder_lastIndexOf_Str_I_I_k_(string_ as String, startIndex as Integer) as Integer
    ...
    return lastIndexOf_rStr_Str_I_Z_I_k_(m.string, string_, startIndex)
end function

function StringBuilder_insert_I_Z_StringBuilder_k_(index as Integer, value as Boolean) as Object
    checkPositionIndex_I_I_k_(index, m.length)
    m.string = ((substring_rStr_I_I_Str_k_(m.string, 0, index) + value) + substring_rStr_I_Str_k_(m.string, index))
    return m
end function

function StringBuilder_insert_I_B_StringBuilder_k_(index as Integer, value as Integer) as Object
    return m.insert(index, Str(value))
end function
...
function StringBuilder_insert_I_CharArray_StringBuilder_k_(index as Integer, value as Object) as Object
    checkPositionIndex_I_I_k_(index, m.length)
    m.string = ((substring_rStr_I_I_Str_k_(m.string, 0, index) + concatToString_rCharArray_Str_k_(value)) + substring_rStr_I_Str_k_(m.string, index))
    return m
end function

function StringBuilder_insert_I_CharSequenceN_StringBuilder_k_(index as Integer, value as Dynamic) as Object
    checkPositionIndex_I_I_k_(index, m.length)
    m.string = ((substring_rStr_I_I_Str_k_(m.string, 0, index) + value.toString()) + substring_rStr_I_Str_k_(m.string, index))
    return m
end function
...
function StringBuilder_insert_I_StrN_StringBuilder_k_(index as Integer, value as Dynamic) as Object
    ...
    m.string = ((substring_rStr_I_I_Str_k_(m.string, 0, index) + toInsert) + substring_rStr_I_Str_k_(m.string, index))
    return m
end function
...
function StringBuilder_substring_I_Str_k_(startIndex as Integer) as String
    checkPositionIndex_I_I_k_(startIndex, m.length)
    return substring_rStr_I_Str_k_(m.string, startIndex)
end function
...
sub StringBuilder_set_I_C_k_(index as Integer, value as Object)
    checkElementIndex_I_I_k_(index, m.length)
    m.string = ((substring_rStr_I_I_Str_k_(m.string, 0, index) + value) + substring_rStr_I_Str_k_(m.string, index + 1))
end sub
...
function StringBuilder_setRange_I_I_Str_StringBuilder_k_(startIndex as Integer, endIndex as Integer, value as String) as Object
    m.checkReplaceRange(startIndex, endIndex, m.length)
    m.string = ((substring_rStr_I_I_Str_k_(m.string, 0, startIndex) + value) + substring_rStr_I_Str_k_(m.string, endIndex))
    return m
end function
...
function StringBuilder_deleteAt_I_StringBuilder_k_(index as Integer) as Object
    checkElementIndex_I_I_k_(index, m.length)
    m.string = (substring_rStr_I_I_Str_k_(m.string, 0, index) + substring_rStr_I_Str_k_(m.string, index + 1))
    return m
end function

function StringBuilder_deleteRange_I_I_StringBuilder_k_(startIndex as Integer, endIndex as Integer) as Object
    m.checkReplaceRange(startIndex, endIndex, m.length)
    m.string = (substring_rStr_I_I_Str_k_(m.string, 0, startIndex) + substring_rStr_I_Str_k_(m.string, endIndex))
    return m
end function

sub StringBuilder_toCharArray_CharArray_I_I_I_k_(destination as Object, destinationOffset = 0, startIndex = 0, endIndex = m.length)
    checkBoundsIndexes_I_I_I_k_(startIndex, endIndex, m.length)
...
function StringBuilder_appendRange_CharArray_I_I_StringBuilder_k_(value as Object, startIndex as Integer, endIndex as Integer) as Object
    m.string = (m.string + concatToString_rCharArray_I_I_Str_k_(value, startIndex, endIndex))
    return m
end function
...
function StringBuilder_appendRange_CharSequence_I_I_StringBuilder_k_(value as Object, startIndex as Integer, endIndex as Integer) as Object
    stringCsq = value.toString()
    checkBoundsIndexes_I_I_I_k_(startIndex, endIndex, stringCsq.length)
    m.string = (m.string + substring_rStr_I_I_Str_k_(stringCsq, startIndex, endIndex))
    return m
end function
...
function StringBuilder_insertRange_I_CharArray_I_I_StringBuilder_k_(index as Integer, value as Object, startIndex as Integer, endIndex as Integer) as Object
    checkPositionIndex_I_I_k_(index, m.length)
    m.string = ((substring_rStr_I_I_Str_k_(m.string, 0, index) + concatToString_rCharArray_I_I_Str_k_(value, startIndex, endIndex)) + substring_rStr_I_Str_k_(m.string, index))
    return m
end function
...
function StringBuilder_insertRange_I_CharSequence_I_I_StringBuilder_k_(index as Integer, value as Object, startIndex as Integer, endIndex as Integer) as Object
    ...
    stringCsq = value.toString()
    checkBoundsIndexes_I_I_I_k_(startIndex, endIndex, stringCsq.length)
    m.string = ((substring_rStr_I_I_Str_k_(m.string, 0, index) + substring_rStr_I_I_Str_k_(stringCsq, startIndex, endIndex)) + substring_rStr_I_Str_k_(m.string, index))
    return m
end function

function StringBuilder_appendLine_StringBuilder_k_() as Object
    return m.append(chr(10))
end function

function StringBuilder_appendLine_CharSequenceN_StringBuilder_k_(value as Dynamic) as Object
    return m.append(value).appendLine()
end function
...
function setRange_rStringBuilder_I_I_Str_StringBuilder_k_(m as Object, startIndex as Integer, endIndex as Integer, value as String) as Object
    return m.setRange(startIndex, endIndex, value)
end function

function deleteAt_rStringBuilder_I_StringBuilder_k_(m as Object, index as Integer) as Object
    return m.deleteAt(index)
end function

function deleteRange_rStringBuilder_I_I_StringBuilder_k_(m as Object, startIndex as Integer, endIndex as Integer) as Object
    return m.deleteRange(startIndex, endIndex)
end function

sub toCharArray_rStringBuilder_CharArray_I_I_I_k_(m as Object, destination as Object, destinationOffset = 0, startIndex = 0, endIndex = m.length)
    return
end sub
...
function appendRange_rStringBuilder_CharArray_I_I_StringBuilder_k_(m as Object, value as Object, startIndex as Integer, endIndex as Integer) as Object
    return m.appendRange(value, startIndex, endIndex)
end function
...
function insertRange_rStringBuilder_I_CharArray_I_I_StringBuilder_k_(m as Object, index as Integer, value as Object, startIndex as Integer, endIndex as Integer) as Object
    return m.insertRange(index, value, startIndex, endIndex)
end function
