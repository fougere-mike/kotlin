...
function sequenceOf_AnyN_k_(element as Dynamic) as Object
    return Anon_2030e97e_create_AnyN_k_(element)
end function
...
function sequenceOf_Iterator_k_(iterator as Object) as Object
    return Anon_31f75da7_create_Iterator_k_(iterator)
end function
...
function Sequence_Function0Iterator_k_(iterator as Object) as Object
    return Anon_55c57bb4_create_Function0Iterator_k_(iterator)
end function
...
function GeneratorSequence_iterator_k_() as Object
    return Anon_6a3ccd91_create_GeneratorSequence_k_(m)
end function
...
function Anon_28e12c6_create_AnyN_k_(_element as Dynamic) as Object
    this = {}
    ...
    this.get_hasNext = Anon_28e12c6_get_hasNext_k_
    this.set_hasNext = Anon_28e12c6_set_hasNext_Z_k_
    this.hasNext = true
...
function Anon_28e12c6_get_hasNext_k_() as Boolean
    return m.hasNext
end function

sub Anon_28e12c6_set_hasNext_Z_k_(value as Boolean)
    m.hasNext = value
end sub

function Anon_2030e97e_create_AnyN_k_(_element as Dynamic) as Object
    this = {}
    this.__type = "Anon_2030e97e"
    this.__proto = ["Anon_2030e97e", "Sequence"]
    this.__id = __kotlin_nextObjectId()
    this.iterator_k_ = Anon_2030e97e_iterator_k_
    this._element = _element
    return this
end function

function Anon_2030e97e_iterator_k_() as Object
    return Anon_28e12c6_create_AnyN_k_(m._element)
end function

function Anon_31f75da7_create_Iterator_k_(_iterator as Object) as Object
    this = {}
    this.__type = "Anon_31f75da7"
    this.__proto = ["Anon_31f75da7", "Sequence"]
    this.__id = __kotlin_nextObjectId()
    this.iterator_k_ = Anon_31f75da7_iterator_k_
    this._iterator = _iterator
    return this
end function

function Anon_31f75da7_iterator_k_() as Object
    return m._iterator
end function

function Anon_55c57bb4_create_Function0Iterator_k_(_iterator as Object) as Object
    this = {}
    this.__type = "Anon_55c57bb4"
    this.__proto = ["Anon_55c57bb4", "Sequence"]
    this.__id = __kotlin_nextObjectId()
    this.iterator_k_ = Anon_55c57bb4_iterator_k_
    this._iterator = _iterator
    return this
end function

function Anon_55c57bb4_iterator_k_() as Object
    return m._iterator.invoke()
end function

function Anon_6a3ccd91_create_GeneratorSequence_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_6a3ccd91"
    this.__proto = ["Anon_6a3ccd91", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.calcNext_k_ = Anon_6a3ccd91_calcNext_k_
    this.hasNext_k_ = Anon_6a3ccd91_hasNext_k_
    this.next_k_ = Anon_6a3ccd91_next_k_
    this.get_nextItem = Anon_6a3ccd91_get_nextItem_k_
    this.set_nextItem = Anon_6a3ccd91_set_nextItem_AnyN_k_
    this.get_nextState = Anon_6a3ccd91_get_nextState_k_
    this.set_nextState = Anon_6a3ccd91_set_nextState_I_k_
...
function Anon_6a3ccd91_hasNext_k_() as Boolean
...
function Anon_6a3ccd91_next_k_() as Object
    if m.get_nextState() < 0 then
        m.calcNext_k_()
    end if
    if m.get_nextState() = 0 then
...
function Anon_6a3ccd91_get_nextItem_k_() as Dynamic
    return m.nextItem
end function

sub Anon_6a3ccd91_set_nextItem_AnyN_k_(value as Dynamic)
    m.nextItem = value
end sub

function Anon_6a3ccd91_get_nextState_k_() as Integer
    return m.nextState
end function

sub Anon_6a3ccd91_set_nextState_I_k_(value as Integer)
    m.nextState = value
end sub
