...
function iterator_rStr_k_(m as String) as Object
    return Anon_76295f69_create_Str_k_(m)
end function

function iterator_rCharArray_k_(m as Object) as Object
    return Anon_717e92d5_create_CharArray_k_(m)
end function

function Anon_76295f69_create_Str_k_(_this_iterator as String) as Object
    this = CharIterator_create_k_()
    this._super = {}
    this._super.hasNext_k_ = this.hasNext_k_
    this._super.nextChar_k_ = this.nextChar_k_
    this.__proto = ["Anon_76295f69", this.__proto]
    this.__type = "Anon_76295f69"
    this.hasNext_k_ = Anon_76295f69_hasNext_k_
    this.nextChar_k_ = Anon_76295f69_nextChar_k_
    this.get_index = Anon_76295f69_get_index_k_
    this.set_index = Anon_76295f69_set_index_I_k_
    this.index = 0
    this._this_iterator = _this_iterator
    return this
end function

function Anon_76295f69_hasNext_k_() as Boolean
    return m.get_index() < Len(m._this_iterator)
end function

function Anon_76295f69_nextChar_k_() as Object
...
function Anon_76295f69_get_index_k_() as Integer
    return m.index
end function

sub Anon_76295f69_set_index_I_k_(value as Integer)
    m.index = value
end sub

function Anon_717e92d5_create_CharArray_k_(_this_iterator as Object) as Object
    this = CharIterator_create_k_()
    this._super = {}
    this._super.hasNext_k_ = this.hasNext_k_
    this._super.nextChar_k_ = this.nextChar_k_
    this.__proto = ["Anon_717e92d5", this.__proto]
    this.__type = "Anon_717e92d5"
    this.hasNext_k_ = Anon_717e92d5_hasNext_k_
    this.nextChar_k_ = Anon_717e92d5_nextChar_k_
    this.get_index = Anon_717e92d5_get_index_k_
    this.set_index = Anon_717e92d5_set_index_I_k_
    this.index = 0
    this._this_iterator = _this_iterator
    return this
end function

function Anon_717e92d5_hasNext_k_() as Boolean
    return m.get_index() < m._this_iterator.get_size()
end function

function Anon_717e92d5_nextChar_k_() as Object
...
function Anon_717e92d5_get_index_k_() as Integer
    return m.index
end function

sub Anon_717e92d5_set_index_I_k_(value as Integer)
    m.index = value
end sub
