function ULong_create_J_k_(data as LongInteger) as Object
    ...
    this.compareTo_AnyN_k_ = ULong_compareTo_AnyN_k_
    ...
    this.__get_data = ULong___get_data_k_
    this.data = data
    return this
end function
...
function ULong_compareTo_AnyN_k_(other as Object) as Integer
    return ulongCompare_J_J_k_(m.__get_data(), other.__get_data())
end function
...
function ULong_plus_ULong_k_(other as Object) as Object
    return ULong_create_J_k_(m.__get_data() + other.__get_data())
end function
...
function ULong_div_UByte_k_(other as Object) as Object
    ...
    return m.div_ULong_k_(tmp_ret_0)
...
function ULong_div_ULong_k_(other as Object) as Object
    return ulongDivide_J_J_k_(m.__get_data(), other.__get_data())
end function
...
function ULong_rem_UByte_k_(other as Object) as Object
    ...
    return m.rem_ULong_k_(tmp_ret_0)
...
function ULong_rem_ULong_k_(other as Object) as Object
    return ulongRemainder_J_J_k_(m.__get_data(), other.__get_data())
end function
...
function ULong_mod_UInt_k_(other as Object) as Object
    ...
    while true
        this = tmp0
        tmp_ret_2 = UInt_create_I_k_(this.__get_data())
        exit while
    end while
    return tmp_ret_2
...
function ULong_inc_k_() as Object
    return ULong_create_J_k_(m.__get_data() + 1&)
end function
...
function ULong_shl_I_k_(bitCount as Integer) as Object
    return ULong_create_J_k_(m.__get_data() * (2 ^ bitCount))
end function

function ULong_shr_I_k_(bitCount as Integer) as Object
    return ULong_create_J_k_(__kotlin_ushr(m.__get_data(), bitCount))
end function

function ULong_and_ULong_k_(other as Object) as Object
    return ULong_create_J_k_(m.__get_data() and other.__get_data())
end function

function ULong_or_ULong_k_(other as Object) as Object
    return ULong_create_J_k_(m.__get_data() or other.__get_data())
end function

function ULong_xor_ULong_k_(other as Object) as Object
    return ULong_create_J_k_((m.__get_data() or other.__get_data()) and not (m.__get_data() and other.__get_data()))
end function

function ULong_inv_k_() as Object
    return ULong_create_J_k_(not m.__get_data())
end function
...
function ULong_toUInt_k_() as Object
    return UInt_create_I_k_(m.__get_data())
end function
...
function ULong_toFloat_k_() as Float
    return ulongToFloat_J_k_(m.__get_data())
end function

function ULong_toDouble_k_() as Double
    return ulongToDouble_J_k_(m.__get_data())
end function

function ULong_toString_k_() as String
    return ulongToString_J_k_(m.__get_data())
end function

function ULong_equals_AnyN_k_(other as Dynamic) as Boolean
    return __kotlin_isInstanceOf(other, "ULong") and (m.__get_data() = other.__get_data())
end function
...
function ULong___get_data_k_() as LongInteger
    return m.data
end function
...
function ULong_Companion_create_k_() as Object
    ...
    this.hashCode = Any_hashCode_k_
    this.toString = Any_toString_k_
    this.__get_MIN_VALUE = ULong_Companion___get_MIN_VALUE_k_
    this.__get_MAX_VALUE = ULong_Companion___get_MAX_VALUE_k_
    this.__get_SIZE_BYTES = ULong_Companion___get_SIZE_BYTES_k_
    this.__get_SIZE_BITS = ULong_Companion___get_SIZE_BITS_k_
...
function ULong_Companion___get_MIN_VALUE_k_() as Object
    return m.MIN_VALUE
end function

function ULong_Companion___get_MAX_VALUE_k_() as Object
    return m.MAX_VALUE
end function

function ULong_Companion___get_SIZE_BYTES_k_() as Integer
    return m.SIZE_BYTES
end function

function ULong_Companion___get_SIZE_BITS_k_() as Integer
    return m.SIZE_BITS
end function
