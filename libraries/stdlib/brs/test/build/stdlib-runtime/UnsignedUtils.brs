function uintCompare_I_I_k_(v1 as Integer, v2 as Integer) as Integer
    return compareTo_rI_I_k_(xor_rI_I_k_(v1, -2147483648), xor_rI_I_k_(v2, -2147483648))
end function

function ulongCompare_J_J_k_(v1 as LongInteger, v2 as LongInteger) as Integer
    return compareTo_rJ_J_k_(xor_rJ_J_k_(v1, -9223372036854775808&), xor_rJ_J_k_(v2, -9223372036854775808&))
end function

function uintDivide_I_I_k_(dividend as Integer, divisor as Integer) as Object
    dividendLong = and_rJ_J_k_(dividend, 4294967295&)
    divisorLong = and_rJ_J_k_(divisor, 4294967295&)
...
function ulongDivide_J_J_k_(dividend as LongInteger, divisor as LongInteger) as Object
    ...
    quotient = shl_rJ_I_k_(ushr_rJ_I_k_(dividend, 1) / divisor, 1)
...
function uintToLong_I_k_(value as Integer) as LongInteger
    return and_rJ_J_k_(value, 4294967295&)
end function
...
function uintToDouble_I_k_(value as Integer) as Double
    return and_rI_I_k_(value, 2147483647) + (shl_rI_I_k_(ushr_rI_I_k_(value, 31), 30) * 2)
end function
...
function ulongToDouble_J_k_(value as LongInteger) as Double
    return (ushr_rJ_I_k_(value, 11) * 2048) + and_rJ_J_k_(value, 2047&)
end function
...
function ulongToString_J_I_k_(value as LongInteger, base as Integer) as String
    ...
    quotient = shl_rJ_I_k_(ushr_rJ_I_k_(value, 1) / base, 1)
