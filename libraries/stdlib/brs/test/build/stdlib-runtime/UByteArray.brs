function UByteArray_create_ByteArray_k_(storage as Object) as Object
    ...
    this.contains_UByte_k_ = UByteArray_contains_UByte_k_
    this.containsAll_CollectionUByte_k_ = UByteArray_containsAll_CollectionUByte_k_
    ...
    this.get_storage = UByteArray_get_storage_k_
    this.get_size = UByteArray_get_size_k_
...
function UByteArray_get_I_k_(index as Integer) as Object
    return toUByte_rB_k_(m.get_storage().get_I_k_(index))
end function
...
function UByteArray_iterator_k_() as Object
    return UByteArray_Iterator_create_ByteArray_k_(m.get_storage())
end function

function UByteArray_contains_UByte_k_(element as Object) as Boolean
    target = element
...
function UByteArray_containsAll_CollectionUByte_k_(elements as Object) as Boolean
    __iter_88 = elements.iterator_k_()
...
function UByteArray_toString_k_() as String
    ...
    if inductionVariable <= last then
        ...
        sb.append_StrN_k_(toUByte_rB_k_(m.get_storage().get_I_k_(i)).toString())
...
function UByteArray_get_storage_k_() as Object
    return m.storage
end function

function UByteArray_get_size_k_() as Integer
...
function UByteArray_Iterator_create_ByteArray_k_(array as Object) as Object
    ...
    this.get_array = UByteArray_Iterator_get_array_k_
    this.get_index = UByteArray_Iterator_get_index_k_
...
function UByteArray_Iterator_next_k_() as Object
    ...
    if m.get_index() < m.get_array().get_size() then
        __incr_tmp_89 = m.get_index()
        m.set_index(__incr_tmp_89 + 1)
        __when_tmp0 = toUByte_rB_k_(m.get_array().get_I_k_(__incr_tmp_89))
    else if true then
...
function UByteArray_Iterator_get_array_k_() as Object
    return m.array
end function

function UByteArray_Iterator_get_index_k_() as Integer
    return m.index
end function
...
function UByteArray_I_Function1IUByte_k_(size as Integer, init as Object) as Object
    return UByteArray_create_ByteArray_k_(ByteArray_create_I_Function1IB_k_(size, {init: init, invoke: function(index as Integer) as Integer
        return m.init.invoke(index)
    end function}))
end function

function ubyteArrayOf_UByteArray_k_(elements as Object) as Object
    return UByteArray_create_ByteArray_k_(ByteArray_create_I_Function1IB_k_(elements.get_size(), {elements: elements, invoke: function(it as Integer) as Integer
