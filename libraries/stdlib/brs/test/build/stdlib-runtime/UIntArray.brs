...
function UIntArray_create_I_UIntArray_k_(size as Integer) as Object
    return UIntArray_create_IntArray_UIntArray_k_(IntArray_create_I_IntArray_k_(size))
end function

function UIntArray_get_I_UInt_k_(index as Integer) as Object
    return toUInt_rI_UInt_k_(m.get_storage().get_I_I_k_(index))
end function
...
function UIntArray_iterator_IteratorUInt_k_() as Object
    return UIntArray_Iterator_create_IntArray_Iterator_k_(m.get_storage())
end function
...
function UIntArray_contains_UInt_Z_k_(element as Object) as Boolean
    ...
    if inductionVariable <= last then
        ...
        if m.get_storage().get_I_I_k_(i) = target then
            return true
        end if
...
function UIntArray_equals_AnyN_Z_k_(other as Dynamic) as Boolean
    ...
    if inductionVariable <= last then
        ...
        if m.get_storage().get_I_I_k_(i) <> other.get_storage().get_I_I_k_(i) then
            return false
        end if
...
function UIntArray_hashCode_I_k_() as Integer
    ...
    if inductionVariable <= last then
        ...
        result = ((31 * result) + m.get_storage().get_I_I_k_(i))
...
function UIntArray_toString_Str_k_() as String
    ...
    sb.append_StrN_StringBuilder_k_("UIntArray([")
    progression = until_rI_I_IntRange_k_(0, m.get_storage().get_size())
    inductionVariable = progression.get_first()
    last = progression.get_last()
    if inductionVariable <= last then
        ...
        sb.append_StrN_StringBuilder_k_(toUInt_rI_UInt_k_(m.get_storage().get_I_I_k_(i)).toString())
...
function UIntArray_I_Function1IUInt_UIntArray_k_(size as Integer, init as Object) as Object
...
function uintArrayOf_UIntArray_UIntArray_k_(elements as Object) as Object
    return UIntArray_create_IntArray_UIntArray_k_(IntArray_create_I_Function1II_IntArray_k_(elements.get_size(), {elements: elements, invoke: function(it as Integer) as Integer
        return m.elements.get_I_UInt_k_(it)
    end function}))
end function
