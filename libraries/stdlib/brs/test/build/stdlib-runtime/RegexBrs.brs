...
function Regex_splitToSequence_CharSequence_I_k_(input as Object, limit = 0) as Object
    ...
    return Sequence_Function0Iterator_k_({this: m, _input: _input, _limit: _limit, this_0: this_0, this: m, this: m, value: value, this: m, this: m, this: m, value: value, this: m, this: m, value: value, this: m, this: m, value: value, this: m, this: m, this: m, input: input, limit: limit, invoke: function() as Object
        return Anon_16748627_create_Regex_CharSequence_I_k_(m.this, m.input, m.limit)
    end function})
end function
...
function Regex_createMatchResult_Str_Arr_I_k_(input as String, matchArray as Object, matchIndex as Integer) as Object
    return Anon_7ae0844_create_I_Arr_Str_Regex_k_(matchIndex, matchArray, input, m)
end function
...
function Anon_16748627_create_Regex_CharSequence_I_k_(this_0 as Object, _input as Object, _limit as Integer) as Object
    this = {}
    this.__type = "Anon_16748627"
    this.__proto = ["Anon_16748627", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.hasNext_k_ = Anon_16748627_hasNext_k_
    this.next_k_ = Anon_16748627_next_k_
    this.get_match = Anon_16748627_get_match_k_
    this.set_match = Anon_16748627_set_match_MatchResultN_k_
    this.get_firstMatch = Anon_16748627_get_firstMatch_k_
    this.get_nextStart = Anon_16748627_get_nextStart_k_
    this.set_nextStart = Anon_16748627_set_nextStart_I_k_
    this.get_splitCount = Anon_16748627_get_splitCount_k_
    this.set_splitCount = Anon_16748627_set_splitCount_I_k_
    this.get_emitted = Anon_16748627_get_emitted_k_
    this.set_emitted = Anon_16748627_set_emitted_Z_k_
...
function Anon_16748627_hasNext_k_() as Boolean
...
function Anon_16748627_next_k_() as String
...
function Anon_16748627_get_match_k_() as Dynamic
    return m.match
end function

sub Anon_16748627_set_match_MatchResultN_k_(value as Dynamic)
    m.match = value
end sub

function Anon_16748627_get_firstMatch_k_() as Dynamic
    return m.firstMatch
end function

function Anon_16748627_get_nextStart_k_() as Integer
    return m.nextStart
end function

sub Anon_16748627_set_nextStart_I_k_(value as Integer)
    m.nextStart = value
end sub

function Anon_16748627_get_splitCount_k_() as Integer
    return m.splitCount
end function

sub Anon_16748627_set_splitCount_I_k_(value as Integer)
    m.splitCount = value
end sub

function Anon_16748627_get_emitted_k_() as Boolean
    return m.emitted
end function

sub Anon_16748627_set_emitted_Z_k_(value as Boolean)
    m.emitted = value
end sub

function Anon_7ba70d9_create_Anon_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_7ba70d9"
    this.__proto = ["Anon_7ba70d9", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.hasNext_k_ = Anon_7ba70d9_hasNext_k_
    this.next_k_ = Anon_7ba70d9_next_k_
    this.get_index = Anon_7ba70d9_get_index_k_
    this.set_index = Anon_7ba70d9_set_index_I_k_
    this.index = 0
    this.this_0 = this_0
    return this
end function

function Anon_7ba70d9_hasNext_k_() as Boolean
    return m.get_index() < m.this_0.get_size()
end function

function Anon_7ba70d9_next_k_() as Dynamic
    if not m.hasNext_k_() then
        throw NoSuchElementException_create_k_()
    end if
...
function Anon_7ba70d9_get_index_k_() as Integer
    return m.index
end function

sub Anon_7ba70d9_set_index_I_k_(value as Integer)
    m.index = value
end sub

function Anon_111b6faf_create_Arr_k_(_matchArray as Object) as Object
    this = {}
    this.__type = "Anon_111b6faf"
    this.__proto = ["Anon_111b6faf", "MatchGroupCollection", "Collection", "Iterable"]
    this.__id = __kotlin_nextObjectId()
    this.iterator_k_ = Anon_111b6faf_iterator_k_
    this.get_I_k_ = Anon_111b6faf_get_I_k_
    this.contains_MatchGroupN_k_ = Anon_111b6faf_contains_MatchGroupN_k_
    this.containsAll_CollectionMatchGroupN_k_ = Anon_111b6faf_containsAll_CollectionMatchGroupN_k_
    this.isEmpty_k_ = Anon_111b6faf_isEmpty_k_
    this.get_size = Anon_111b6faf_get_size_k_
    this._matchArray = _matchArray
    return this
end function

function Anon_111b6faf_iterator_k_() as Object
    return Anon_7ba70d9_create_Anon_k_(m)
end function

function Anon_111b6faf_get_I_k_(index as Integer) as Dynamic
...
function Anon_111b6faf_contains_MatchGroupN_k_(element as Dynamic) as Boolean
...
function Anon_111b6faf_containsAll_CollectionMatchGroupN_k_(elements as Object) as Boolean
...
function Anon_111b6faf_isEmpty_k_() as Boolean
    return m.get_size() = 0
end function

function Anon_111b6faf_get_size_k_() as Integer
    return m._matchArray.count()
end function

function Anon_2d1651cf_create_Anon_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_2d1651cf"
    this.__proto = ["Anon_2d1651cf", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.hasNext_k_ = Anon_2d1651cf_hasNext_k_
    this.next_k_ = Anon_2d1651cf_next_k_
    this.get_index = Anon_2d1651cf_get_index_k_
    this.set_index = Anon_2d1651cf_set_index_I_k_
    this.index = 0
    this.this_0 = this_0
    return this
end function

function Anon_2d1651cf_hasNext_k_() as Boolean
    return m.get_index() < m.this_0.get_size()
end function

function Anon_2d1651cf_next_k_() as String
    if not m.hasNext_k_() then
        throw NoSuchElementException_create_k_()
    end if
...
function Anon_2d1651cf_get_index_k_() as Integer
    return m.index
end function

sub Anon_2d1651cf_set_index_I_k_(value as Integer)
    m.index = value
end sub

function Anon_5b0ed197_create_I_Anon_k_(_index as Integer, this_0 as Object) as Object
    this = {}
    this.__type = "Anon_5b0ed197"
    this.__proto = ["Anon_5b0ed197", "ListIterator", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.hasNext_k_ = Anon_5b0ed197_hasNext_k_
    this.hasPrevious_k_ = Anon_5b0ed197_hasPrevious_k_
    this.next_k_ = Anon_5b0ed197_next_k_
    this.nextIndex_k_ = Anon_5b0ed197_nextIndex_k_
    this.previous_k_ = Anon_5b0ed197_previous_k_
    this.previousIndex_k_ = Anon_5b0ed197_previousIndex_k_
    this.get_currentIndex = Anon_5b0ed197_get_currentIndex_k_
    this.set_currentIndex = Anon_5b0ed197_set_currentIndex_I_k_
    this.currentIndex = _index
    this.this_0 = this_0
    return this
end function

function Anon_5b0ed197_hasNext_k_() as Boolean
    return m.get_currentIndex() < m.this_0.get_size()
end function

function Anon_5b0ed197_hasPrevious_k_() as Boolean
    return m.get_currentIndex() > 0
end function

function Anon_5b0ed197_next_k_() as String
    if not m.hasNext_k_() then
        throw NoSuchElementException_create_k_()
    end if
...
function Anon_5b0ed197_nextIndex_k_() as Integer
    return m.get_currentIndex()
end function

function Anon_5b0ed197_previous_k_() as String
...
function Anon_5b0ed197_previousIndex_k_() as Integer
    return m.get_currentIndex() - 1
end function

function Anon_5b0ed197_get_currentIndex_k_() as Integer
    return m.currentIndex
end function

sub Anon_5b0ed197_set_currentIndex_I_k_(value as Integer)
    m.currentIndex = value
end sub

function Anon_779f4ee6_create_Anon_k_(this_0 as Object) as Object
    this = {}
    this.__type = "Anon_779f4ee6"
    this.__proto = ["Anon_779f4ee6", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.hasNext_k_ = Anon_779f4ee6_hasNext_k_
    this.next_k_ = Anon_779f4ee6_next_k_
    this.get_index = Anon_779f4ee6_get_index_k_
    this.set_index = Anon_779f4ee6_set_index_I_k_
    this.index = 0
    this.this_0 = this_0
    return this
end function

function Anon_779f4ee6_hasNext_k_() as Boolean
    return m.get_index() < m.this_0.get_size()
end function

function Anon_779f4ee6_next_k_() as String
    if not m.hasNext_k_() then
        throw NoSuchElementException_create_k_()
    end if
...
function Anon_779f4ee6_get_index_k_() as Integer
    return m.index
end function

sub Anon_779f4ee6_set_index_I_k_(value as Integer)
    m.index = value
end sub

function Anon_5f536620_create_I_Anon_k_(_index as Integer, this_0 as Object) as Object
    this = {}
    this.__type = "Anon_5f536620"
    this.__proto = ["Anon_5f536620", "ListIterator", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.hasNext_k_ = Anon_5f536620_hasNext_k_
    this.hasPrevious_k_ = Anon_5f536620_hasPrevious_k_
    this.next_k_ = Anon_5f536620_next_k_
    this.nextIndex_k_ = Anon_5f536620_nextIndex_k_
    this.previous_k_ = Anon_5f536620_previous_k_
    this.previousIndex_k_ = Anon_5f536620_previousIndex_k_
    this.get_currentIndex = Anon_5f536620_get_currentIndex_k_
    this.set_currentIndex = Anon_5f536620_set_currentIndex_I_k_
    this.currentIndex = _index
    this.this_0 = this_0
    return this
end function

function Anon_5f536620_hasNext_k_() as Boolean
    return m.get_currentIndex() < m.this_0.get_size()
end function

function Anon_5f536620_hasPrevious_k_() as Boolean
    return m.get_currentIndex() > 0
end function

function Anon_5f536620_next_k_() as String
    if not m.hasNext_k_() then
        throw NoSuchElementException_create_k_()
    end if
...
function Anon_5f536620_nextIndex_k_() as Integer
    return m.get_currentIndex()
end function

function Anon_5f536620_previous_k_() as String
    if not m.hasPrevious_k_() then
        throw NoSuchElementException_create_k_()
    end if
    return m.this_0.get_I_k_(m.get_currentIndex())
...
function Anon_5f536620_previousIndex_k_() as Integer
    return m.get_currentIndex() - 1
end function

function Anon_5f536620_get_currentIndex_k_() as Integer
    return m.currentIndex
end function

sub Anon_5f536620_set_currentIndex_I_k_(value as Integer)
    m.currentIndex = value
end sub

function Anon_333db39a_create_Anon_k_(this_0 as Object) as Object
    this = {}
    ...
    this.get_index = Anon_333db39a_get_index_k_
    this.set_index = Anon_333db39a_set_index_I_k_
    this.index = 0
    this.this_0 = this_0
    return this
end function
...
function Anon_333db39a_get_index_k_() as Integer
    return m.index
end function

sub Anon_333db39a_set_index_I_k_(value as Integer)
    m.index = value
end sub

function Anon_3d50f3c_create_I_Anon_k_(_index as Integer, this_0 as Object) as Object
    this = {}
    this.__type = "Anon_3d50f3c"
    this.__proto = ["Anon_3d50f3c", "ListIterator", "Iterator"]
    this.__id = __kotlin_nextObjectId()
    this.hasNext_k_ = Anon_3d50f3c_hasNext_k_
    this.hasPrevious_k_ = Anon_3d50f3c_hasPrevious_k_
    this.next_k_ = Anon_3d50f3c_next_k_
    this.nextIndex_k_ = Anon_3d50f3c_nextIndex_k_
    this.previous_k_ = Anon_3d50f3c_previous_k_
    this.previousIndex_k_ = Anon_3d50f3c_previousIndex_k_
    this.get_currentIndex = Anon_3d50f3c_get_currentIndex_k_
    this.set_currentIndex = Anon_3d50f3c_set_currentIndex_I_k_
    this.currentIndex = _index
    this.this_0 = this_0
    return this
end function

function Anon_3d50f3c_hasNext_k_() as Boolean
    return m.get_currentIndex() < m.this_0.get_size()
end function

function Anon_3d50f3c_hasPrevious_k_() as Boolean
    return m.get_currentIndex() > 0
end function

function Anon_3d50f3c_next_k_() as String
    if not m.hasNext_k_() then
        throw NoSuchElementException_create_k_()
    end if
...
function Anon_3d50f3c_nextIndex_k_() as Integer
    return m.get_currentIndex()
end function

function Anon_3d50f3c_previous_k_() as String
    if not m.hasPrevious_k_() then
        throw NoSuchElementException_create_k_()
    end if
    return m.this_0.get_I_k_(m.get_currentIndex())
...
function Anon_3d50f3c_previousIndex_k_() as Integer
    return m.get_currentIndex() - 1
end function

function Anon_3d50f3c_get_currentIndex_k_() as Integer
    return m.currentIndex
end function

sub Anon_3d50f3c_set_currentIndex_I_k_(value as Integer)
    m.currentIndex = value
end sub

function Anon_62b85e34_create_I_Arr_I_k_(_nestedSubSize as Integer, _matchArray as Object, _actualFromIndex as Integer) as Object
    this = {}
    this.__type = "Anon_62b85e34"
    this.__proto = ["Anon_62b85e34", "List", "Collection", "Iterable"]
    this.__id = __kotlin_nextObjectId()
    this.get_I_k_ = Anon_62b85e34_get_I_k_
    this.indexOf_Str_k_ = Anon_62b85e34_indexOf_Str_k_
    this.lastIndexOf_Str_k_ = Anon_62b85e34_lastIndexOf_Str_k_
    this.isEmpty_k_ = Anon_62b85e34_isEmpty_k_
    this.contains_Str_k_ = Anon_62b85e34_contains_Str_k_
    this.containsAll_CollectionStr_k_ = Anon_62b85e34_containsAll_CollectionStr_k_
    this.iterator_k_ = Anon_62b85e34_iterator_k_
    this.listIterator_k_ = Anon_62b85e34_listIterator_k_
    this.listIterator_I_k_ = Anon_62b85e34_listIterator_I_k_
    this.subList_I_I_k_ = Anon_62b85e34_subList_I_I_k_
    this.get_size = Anon_62b85e34_get_size_k_
...
function Anon_62b85e34_get_I_k_(index as Integer) as String
...
function Anon_62b85e34_indexOf_Str_k_(element as String) as Integer
    progression = until_rI_I_k_(0, m.get_size())
    inductionVariable = progression.get_first()
    last = progression.get_last()
    if inductionVariable <= last then
...
function Anon_62b85e34_lastIndexOf_Str_k_(element as String) as Integer
...
function Anon_62b85e34_isEmpty_k_() as Boolean
    return m.get_size() = 0
end function

function Anon_62b85e34_contains_Str_k_(element as String) as Boolean
    return m.indexOf_Str_k_(element) >= 0
end function

function Anon_62b85e34_containsAll_CollectionStr_k_(elements as Object) as Boolean
...
function Anon_62b85e34_iterator_k_() as Object
    return Anon_333db39a_create_Anon_k_(m)
end function

function Anon_62b85e34_listIterator_k_() as Object
    return m.listIterator_I_k_(0)
end function

function Anon_62b85e34_listIterator_I_k_(index as Integer) as Object
    if (index < 0) or (index > m.get_size()) then
        throw IndexOutOfBoundsException_create_k_()
    end if
    return Anon_3d50f3c_create_I_Anon_k_(index, m)
end function

function Anon_62b85e34_subList_I_I_k_(fromIndex as Integer, toIndex as Integer) as Object
...
function Anon_62b85e34_get_size_k_() as Integer
    return m.size
end function

function Anon_33a49aca_create_I_Arr_I_k_(_subSize as Integer, _matchArray as Object, _outerFromIndex as Integer) as Object
    this = {}
    this.__type = "Anon_33a49aca"
    this.__proto = ["Anon_33a49aca", "List", "Collection", "Iterable"]
    this.__id = __kotlin_nextObjectId()
    this.get_I_k_ = Anon_33a49aca_get_I_k_
    this.indexOf_Str_k_ = Anon_33a49aca_indexOf_Str_k_
    this.lastIndexOf_Str_k_ = Anon_33a49aca_lastIndexOf_Str_k_
    this.isEmpty_k_ = Anon_33a49aca_isEmpty_k_
    this.contains_Str_k_ = Anon_33a49aca_contains_Str_k_
    this.containsAll_CollectionStr_k_ = Anon_33a49aca_containsAll_CollectionStr_k_
    this.iterator_k_ = Anon_33a49aca_iterator_k_
    this.listIterator_k_ = Anon_33a49aca_listIterator_k_
    this.listIterator_I_k_ = Anon_33a49aca_listIterator_I_k_
    this.subList_I_I_k_ = Anon_33a49aca_subList_I_I_k_
    this.get_size = Anon_33a49aca_get_size_k_
    this.size = _subSize
    this._matchArray = _matchArray
...
function Anon_33a49aca_get_I_k_(index as Integer) as String
    if (index < 0) or (index >= m.get_size()) then
        throw IndexOutOfBoundsException_create_k_()
    end if
...
function Anon_33a49aca_indexOf_Str_k_(element as String) as Integer
    progression = until_rI_I_k_(0, m.get_size())
    inductionVariable = progression.get_first()
    last = progression.get_last()
    if inductionVariable <= last then
...
function Anon_33a49aca_lastIndexOf_Str_k_(element as String) as Integer
    inductionVariable = m.get_size() - 1
    if 0 <= inductionVariable then
                i = inductionVariable
        inductionVariable = (inductionVariable + -1)
...
function Anon_33a49aca_isEmpty_k_() as Boolean
    return m.get_size() = 0
end function

function Anon_33a49aca_contains_Str_k_(element as String) as Boolean
    return m.indexOf_Str_k_(element) >= 0
end function

function Anon_33a49aca_containsAll_CollectionStr_k_(elements as Object) as Boolean
...
function Anon_33a49aca_iterator_k_() as Object
    return Anon_779f4ee6_create_Anon_k_(m)
end function

function Anon_33a49aca_listIterator_k_() as Object
    return m.listIterator_I_k_(0)
end function

function Anon_33a49aca_listIterator_I_k_(index as Integer) as Object
    if (index < 0) or (index > m.get_size()) then
        throw IndexOutOfBoundsException_create_k_()
    end if
    return Anon_5f536620_create_I_Anon_k_(index, m)
end function

function Anon_33a49aca_subList_I_I_k_(fromIndex as Integer, toIndex as Integer) as Object
    if ((fromIndex < 0) or (toIndex > m.get_size())) or (fromIndex > toIndex) then
        throw IndexOutOfBoundsException_create_k_()
    end if
    ...
    return Anon_62b85e34_create_I_Arr_I_k_(nestedSubSize, m._matchArray, actualFromIndex)
end function

function Anon_33a49aca_get_size_k_() as Integer
    return m.size
end function

function Anon_145fe5ce_create_Arr_k_(_matchArray as Object) as Object
    this = {}
    this.__type = "Anon_145fe5ce"
    this.__proto = ["Anon_145fe5ce", "List", "Collection", "Iterable"]
    this.__id = __kotlin_nextObjectId()
    this.get_I_k_ = Anon_145fe5ce_get_I_k_
    this.indexOf_Str_k_ = Anon_145fe5ce_indexOf_Str_k_
    this.lastIndexOf_Str_k_ = Anon_145fe5ce_lastIndexOf_Str_k_
    this.isEmpty_k_ = Anon_145fe5ce_isEmpty_k_
    this.contains_Str_k_ = Anon_145fe5ce_contains_Str_k_
    this.containsAll_CollectionStr_k_ = Anon_145fe5ce_containsAll_CollectionStr_k_
    this.iterator_k_ = Anon_145fe5ce_iterator_k_
    this.listIterator_k_ = Anon_145fe5ce_listIterator_k_
    this.listIterator_I_k_ = Anon_145fe5ce_listIterator_I_k_
    this.subList_I_I_k_ = Anon_145fe5ce_subList_I_I_k_
    this.get_size = Anon_145fe5ce_get_size_k_
    this._matchArray = _matchArray
    return this
end function

function Anon_145fe5ce_get_I_k_(index as Integer) as String
...
function Anon_145fe5ce_indexOf_Str_k_(element as String) as Integer
    progression = until_rI_I_k_(0, m.get_size())
    inductionVariable = progression.get_first()
    last = progression.get_last()
    if inductionVariable <= last then
...
function Anon_145fe5ce_lastIndexOf_Str_k_(element as String) as Integer
    inductionVariable = m.get_size() - 1
    if 0 <= inductionVariable then
                i = inductionVariable
        inductionVariable = (inductionVariable + -1)
...
function Anon_145fe5ce_isEmpty_k_() as Boolean
    return m.get_size() = 0
end function

function Anon_145fe5ce_contains_Str_k_(element as String) as Boolean
    return m.indexOf_Str_k_(element) >= 0
end function

function Anon_145fe5ce_containsAll_CollectionStr_k_(elements as Object) as Boolean
...
function Anon_145fe5ce_iterator_k_() as Object
    return Anon_2d1651cf_create_Anon_k_(m)
end function

function Anon_145fe5ce_listIterator_k_() as Object
    return m.listIterator_I_k_(0)
end function

function Anon_145fe5ce_listIterator_I_k_(index as Integer) as Object
    if (index < 0) or (index > m.get_size()) then
        throw IndexOutOfBoundsException_create_k_()
    end if
    return Anon_5b0ed197_create_I_Anon_k_(index, m)
end function

function Anon_145fe5ce_subList_I_I_k_(fromIndex as Integer, toIndex as Integer) as Object
    if ((fromIndex < 0) or (toIndex > m.get_size())) or (fromIndex > toIndex) then
        throw IndexOutOfBoundsException_create_k_()
    end if
    outerFromIndex = fromIndex
    subSize = toIndex - fromIndex
    return Anon_33a49aca_create_I_Arr_I_k_(subSize, m._matchArray, outerFromIndex)
end function

function Anon_145fe5ce_get_size_k_() as Integer
    return m._matchArray.count()
end function

function Anon_7ae0844_create_I_Arr_Str_Regex_k_(_matchIndex as Integer, _matchArray as Object, _input as String, this_0 as Object) as Object
    this = {}
    this.__type = "Anon_7ae0844"
    this.__proto = ["Anon_7ae0844", "MatchResult"]
    this.__id = __kotlin_nextObjectId()
    this.next_k_ = Anon_7ae0844_next_k_
    this.get_range = Anon_7ae0844_get_range_k_
    this.get_value = Anon_7ae0844_get_value_k_
    this.get_groups = Anon_7ae0844_get_groups_k_
    this.get_groupValues_ = Anon_7ae0844_get_groupValues__k_
    this.set_groupValues_ = Anon_7ae0844_set_groupValues__ListStrN_k_
    this.get_groupValues = Anon_7ae0844_get_groupValues_k_
    this.range = until_rI_I_k_(_matchIndex, _matchIndex + Len(_matchArray[0]))
    this.value = _matchArray[0]
    this.groups = Anon_111b6faf_create_Arr_k_(_matchArray)
...
function Anon_7ae0844_next_k_() as Dynamic
    __when_tmp3 = invalid
...
function Anon_7ae0844_get_range_k_() as Object
    return m.range
end function

function Anon_7ae0844_get_value_k_() as String
    return m.value
end function

function Anon_7ae0844_get_groups_k_() as Object
    return m.groups
end function

function Anon_7ae0844_get_groupValues__k_() as Dynamic
    return m.groupValues_
end function

sub Anon_7ae0844_set_groupValues__ListStrN_k_(value as Dynamic)
    m.groupValues_ = value
end sub

function Anon_7ae0844_get_groupValues_k_() as Object
    if m.get_groupValues_() = invalid then
        m.set_groupValues_(Anon_145fe5ce_create_Arr_k_(m._matchArray))
    end if
