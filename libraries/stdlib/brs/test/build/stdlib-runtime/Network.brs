...
function RoUrlTransfer_Companion_getInstance() as Object
    if m.RoUrlTransfer_Companion_instance = invalid then
        m.RoUrlTransfer_Companion_instance = RoUrlTransfer_Companion_create_k_()
    end if
    return m.RoUrlTransfer_Companion_instance
end function
