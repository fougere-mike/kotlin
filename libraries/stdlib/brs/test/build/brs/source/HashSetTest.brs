sub hashSetTests_rTestRunner_k_(m as Object)
    m.suite_Str_Function1TestRunnerV_k_("HashSet", {invoke: function(m as Object) as Void
        m.test_Str_Function0V_k_("create empty", {invoke: function() as Void
            ...
            assertTrue_Z_StrN_k_(set.isEmpty_k_())
        ...
        m.test_Str_Function0V_k_("create from collection", {invoke: function() as Void
            ...
            assertTrue_Z_StrN_k_(set.contains_AnyN_k_(1))
            assertTrue_Z_StrN_k_(set.contains_AnyN_k_(2))
            assertTrue_Z_StrN_k_(set.contains_AnyN_k_(3))
        end function})
        m.test_Str_Function0V_k_("add elements", {invoke: function() as Void
            set = HashSet_create_k_()
            assertTrue_Z_StrN_k_(set.add_AnyN_k_(1))
            assertTrue_Z_StrN_k_(set.add_AnyN_k_(2))
            assertFalse_Z_StrN_k_(set.add_AnyN_k_(1))
        ...
        m.test_Str_Function0V_k_("contains", {invoke: function() as Void
            ...
            assertTrue_Z_StrN_k_(set.contains_AnyN_k_(2))
            assertFalse_Z_StrN_k_(set.contains_AnyN_k_(5))
        end function})
        m.test_Str_Function0V_k_("remove", {invoke: function() as Void
            set = hashSetOf_Arr_k_([1, 2, 3])
            assertTrue_Z_StrN_k_(set.remove_AnyN_k_(2))
            assertFalse_Z_StrN_k_(set.remove_AnyN_k_(5))
            assertEquals_AnyN_AnyN_StrN_k_(2, set.get_size())
            assertFalse_Z_StrN_k_(set.contains_AnyN_k_(2))
        end function})
        ...
        m.test_Str_Function0V_k_("addAll", {invoke: function() as Void
            ...
            assertTrue_Z_StrN_k_(set.addAll_Collection_k_(listOf_Arr_k_([3, 4, 2])))
        ...
        m.test_Str_Function0V_k_("removeAll", {invoke: function() as Void
            ...
            assertTrue_Z_StrN_k_(set.removeAll_Collection_k_(listOf_Arr_k_([2, 4])))
            assertEquals_AnyN_AnyN_StrN_k_(3, set.get_size())
            assertFalse_Z_StrN_k_(set.contains_AnyN_k_(2))
            assertFalse_Z_StrN_k_(set.contains_AnyN_k_(4))
        end function})
        m.test_Str_Function0V_k_("retainAll", {invoke: function() as Void
            set = hashSetOf_Arr_k_([1, 2, 3, 4, 5])
            assertTrue_Z_StrN_k_(set.retainAll_Collection_k_(listOf_Arr_k_([2, 3, 6])))
            assertEquals_AnyN_AnyN_StrN_k_(2, set.get_size())
            assertTrue_Z_StrN_k_(set.contains_AnyN_k_(2))
            assertTrue_Z_StrN_k_(set.contains_AnyN_k_(3))
        end function})
        m.test_Str_Function0V_k_("containsAll", {invoke: function() as Void
            set = hashSetOf_Arr_k_([1, 2, 3, 4, 5])
            assertTrue_Z_StrN_k_(set.containsAll_Collection_k_(listOf_Arr_k_([1, 3, 5])))
            assertFalse_Z_StrN_k_(set.containsAll_Collection_k_(listOf_Arr_k_([1, 6])))
        end function})
        m.test_Str_Function0V_k_("iteration", {invoke: function() as Void
            ...
            assertTrue_Z_StrN_k_(collected.containsAll_Collection_k_(listOf_Arr_k_([1, 2, 3])))
        end function})
        ...
        m.test_Str_Function0V_k_("toString", {invoke: function() as Void
            set = hashSetOf_Arr_k_([1, 2, 3])
            str = set.toString()
            assertTrue_Z_StrN_k_(startsWith_rStr_Str_Z_k_(str, "["))
            assertTrue_Z_StrN_k_(endsWith_rStr_Str_Z_k_(str, "]"))
        end function})
        m.test_Str_Function0V_k_("string set", {invoke: function() as Void
            set = hashSetOf_Arr_k_(["apple", "banana", "cherry"])
            assertTrue_Z_StrN_k_(set.contains_AnyN_k_("banana"))
            assertFalse_Z_StrN_k_(set.contains_AnyN_k_("durian"))
        end function})
    end function})
end sub
