sub stringExtensionsTests_rTestRunner_k_(m as Object)
    m.suite_Str_Function1TestRunnerV_k_("String Extensions", {invoke: function(m as Object) as Void
        ...
        m.test_Str_Function0V_k_("get char", {invoke: function() as Void
            assertEquals_AnyN_AnyN_StrN_k_("h", "hello".get_I_C_k_(0))
            assertEquals_AnyN_AnyN_StrN_k_("o", "hello".get_I_C_k_(4))
        end function})
        ...
        m.test_Str_Function0V_k_("compareTo", {invoke: function() as Void
            assertTrue_Z_StrN_k_("abc".compareTo_Str_I_k_("xyz") < 0)
            assertTrue_Z_StrN_k_("xyz".compareTo_Str_I_k_("abc") > 0)
            assertEquals_AnyN_AnyN_StrN_k_(0, "abc".compareTo_Str_I_k_("abc"))
        end function})
