sub linkedHashMapTests_rTestRunner_k_(m as Object)
    m.suite_Str_Function1TestRunnerV_k_("LinkedHashMap", {invoke: function(m as Object) as Void
        ...
        m.test_Str_Function0V_k_("constructor with map", {invoke: function() as Void
            ...
            assertEquals_AnyN_AnyN_StrN_k_(3, linked.get_size(), invalid)
        ...
        m.test_Str_Function0V_k_("entry set", {invoke: function() as Void
            ...
            assertEquals_AnyN_AnyN_StrN_k_("one", entries.get_I_k_(0).get_key(), invalid)
            assertEquals_AnyN_AnyN_StrN_k_(1, entries.get_I_k_(0).get_value(), invalid)
        end function})
        m.test_Str_Function0V_k_("putAll", {invoke: function() as Void
            ...
            assertEquals_AnyN_AnyN_StrN_k_(listOf_Arr_k_(["one", "two", "three"]), toList_rIterable_k_(map.get_keys()), invalid)
        end function})
    end function})
end sub
