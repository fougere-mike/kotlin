...
public actual class StringBuilder public actual constructor(content: String) : Appendable, CharSequence {
     ...
     *
     * In Kotlin/BrightScript implementation of StringBuilder the value returned from this method may not indicate the actual size of the backing storage.
     */
    @SinceKotlin("1.3")
     ...
     *
     * In Kotlin/BrightScript implementation of StringBuilder the size of the backing storage is not extended to comply the given [minimumCapacity],
     ...
     */
    @SinceKotlin("1.4")
    public actual fun indexOf(string: String): Int = this.string.indexOf(string)
     ...
     */
    @SinceKotlin("1.4")
    public actual fun indexOf(string: String, startIndex: Int): Int = this.string.indexOf(string, startIndex)
     ...
     */
    @SinceKotlin("1.4")
    public actual fun lastIndexOf(string: String): Int = this.string.lastIndexOf(string)
     ...
     *
     *  Note that in Kotlin/BrightScript [set] operator function has non-constant execution time complexity.
     ...
     *
     * In Kotlin/BrightScript implementation of StringBuilder the size of the backing storage is always equal to the length of the string builder.
     */
    @SinceKotlin("1.4")
