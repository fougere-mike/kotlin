...
internal fun <T> copyToArray(collection: Collection<T>): Array<T> {
    ...
    return collectionToArray(collection) as Array<T>
}
 ...
 */
@SinceKotlin("1.2")
public actual fun <T> MutableList<T>.shuffle(): Unit = shuffle(kotlin.random.Random)
...
// no singleton map implementation in BrightScript, return map as is
...
/**
 * BrightScript map and set implementations do not make use of capacities or load factors.
 */
@PublishedApi
