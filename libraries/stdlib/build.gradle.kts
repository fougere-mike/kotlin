...
kotlin {
    ...
    //
    // IMPORTANT: The BRS configuration is in a separate Groovy script (brs-target.gradle) because:
    ...
    // - This script is only applied when kgpHasBrsSupport=true, so `brs` will always exist
    if (kgpHasBrsSupport) {
