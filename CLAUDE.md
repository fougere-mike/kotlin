...
### Current Gate Numbers (as of the flow concurrent operators, 2026-09-02)
...
| Gate | Count |
|------|-------|
| Golden file tests | 93 |
| FIR diagnostic suite (checkers.brs) | 228 |
| Stdlib device suite | 592 tests / 59 suites |
