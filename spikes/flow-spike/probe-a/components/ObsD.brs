' ObsD — the FRESH late observer for A4: created AFTER ObsB is destroyed.
' Identical to ObsB/ObsC except m.who; the scene never retires this instance
' (retired stays false; ghost branch is dead code here — kept deliberately for
' file symmetry).
